---
title: "Değerleme ve Amortisman Raporu"
page_id: "50684271"
...
breadcrumb:
  ...
  - "Demirbaş"
  - "Raporlar / Demirbaş"
  - "Değerleme ve Amortisman Raporu"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Demirbaş / Raporlar / Demirbaş / Değerleme ve Amortisman Raporu"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPWE2ZGUyNjk4LWU3YTUtNDgyYS04YWMwLTgzMzM4ZjlhMGI0NiZsaW5rPTM0ZTUwZmRiLWY2YTAtNDBkNy05NmYyLWY0MjJjMWFkNGExOCZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=a6de2698-e7a5-482a-8ac0-83338f9a0b46&link=34e50fdb-f6a0-40d7-96f2-f422c1ad4a18&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "degerleme-ve-amortisman-raporu_50684282_50684271.html"
source_version: "2022-11-15T15:16:12.253+03:00"
source_bytes: 197420
fetched_at: "2026-09-13T04:21:34+00:00"
generator: "netsis-scraper 1.0.0"
---
# Değerleme ve Amortisman Raporu

Değerleme ve Amortisman Raporu, içinde bulunulan modüle ait, her türlü hazır raporun alınmasını sağlayan bölümdür. Değerleme ve Amortisman Raporu bölümünde bulunan raporlar, standart denilen, kullanıcıların alanlar üzerinde fazla müdahalede bulunamayacakları hazır raporlardır. Kullanıcılar, hazır raporların mevcut alanlarına müdahale edemeseler bile, bazı kısıt ve sıralama fonksiyonlarını kullanarak raporlarda bir takım değişiklikler yapabilirler. Programda kullanılan hazır raporlara girildiğinde raporun seçenekleri sayfalar halinde ekrana gelir.

Değerleme ve Amortisman Raporu ekranı; Ön Sorgulama, Genel Kısıtlar, Kısıt, Sıralama, Ölçekleme ve Yazıcı Seçenekleri sekmesinden oluşur.

**Ön Sorgulama**

Değerleme ve Amortisman Raporu ekranı Ön Sorgulama sekmesinde yer alan alanlar ve içerdiği bilgiler aşağıdaki şekildedir:

| Değerleme ve Amortisman Raporu Ekranı |  |
| --- | --- |
| Demirbaş Kodu | Değerleme ve Amortisman Raporu almak için Demirbaş Kodu kısıdı verilen alandır. Rehber butonu ![](../../../_assets/088477bb321d1b20c939.jpg) ile, demirbaş kodlarına ulaşılır. |
| Grup Kodu | Değerleme ve Amortisman Raporu almak için Grup Kodu kısıdı verilen alandır. Rehber butonu ![](../../../_assets/088477bb321d1b20c939.jpg) ile, grup kodlarına ulaşılır. |
| İçinde Bulunulan Şirket İçin Rapor Alınsın | Değerleme ve Amortisman Raporu alırken, içinde bulunulan şirket için rapor alınması istendiği zaman kullanılan seçenektir. |
| Şirket Aralığı | Değerleme ve Amortisman Raporu almak için şirket aralığı kısıdı verilen alandır. Rehber butonu ![](../../../_assets/088477bb321d1b20c939.jpg) ile, şirketler arasından seçim yapılır. |
...
| ![](../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Ön Sorgulama, Kısıt sekmelerinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Değerleme ve Amortisman Raporu işleminin yapılması için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki Değerleme ve Amortisman Raporu işleminde kullanılması için saklanır. |
| ![](../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Değerleme ve Amortisman Raporu ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../_assets/685dc72e92799fd2b093.png) Yenile | Değerleme ve Amortisman Raporu ekranı için verilen kısıtların iptal edilerek ekranın yenilenmesi için kullanılan butondur. |

**Genel Kısıtlar**

Genel Kısıtlar sekmesi; her raporun, kendine özgü bir takım kısıt ve seçeneklerinin bulunduğu sekmedir. Genel Kısıtlar sekmesinde verilen kısıtlar ve belirlenen seçenekler, raporun dökümünü etkiler.

Değerleme ve Amortisman Raporu ekranı Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler aşağıdaki şekildedir:

| Değerleme ve Amortisman Raporu Ekranı |  |
| --- | --- |
| Yıl/Ay | Değerleme ve Amortisman Raporu almak için Yıl/Ay bilgisi girilen alandır. |
| Raporlanacak Amortisman | Değerleme ve Amortisman Raporu almak için raporlanacak amortisman kısıdı verilen alandır. Aylık, Dönem veya Yıllık seçenekleri arasından seçim yapılır. |
| Birikmiş Amortisman Farkları Basılsın | Değerleme ve Amortisman Raporu alırken birikmiş amortisman farklarının basılması için kullanılan seçenektir. |
| Satılan Demirbaşlar Basılsın | Değerleme ve Amortisman Raporu alırken satılan demirbaşların basılması için kullanılan seçenektir. |
| İtfa Olan Demirbaşlar Basılsın | Değerleme ve Amortisman Raporu alırken itfa olan demirbaşların basılması için kullanılan seçenektir. |
| Miktar Bilgisi Basılsın | Değerleme ve Amortisman Raporu alırken miktar bilgisi basılması için kullanılan seçenektir. |
| Transfer Edilen Demirbaşlar Gösterilmesin | Değerleme ve Amortisman Raporu alırken transfer edilen demirbaşların gösterilmemesi için kullanılan seçenektir. |
| ![](../../../_assets/21c20c78203acae9cce6.jpg) Rapor | Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. |
| ![](../../../_assets/e3223333470668512f5f.jpg) Oku | Daha önceden saklanan kısıtların aynısının ekrana getirilmesini sağlayan butondur. **Oku** butonu ile sadece "en son saklanan kısıtlar" ekrana getirilir. |
| ![](../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Ön Sorgulama, Kısıt sekmelerinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Değerleme ve Amortisman Raporu işleminin yapılması için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki Değerleme ve Amortisman Raporu işleminde kullanılması için saklanır. |
| ![](../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Değerleme ve Amortisman Raporu ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
...
| Değerleme ve Amortisman Raporu Ekranı |  |
| --- | --- |
| Sahalar | Değerleme ve Amortisman Raporu almak için kısıt verilmesi istenen alanlar yer alır. ![](../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "kısıt verilecek sahalar" kısmına eklenir. |
| Kısıt Verilecek Sahalar | Değerleme ve Amortisman Raporu almak için kısıt verilen sahaların yer aldığı alandır. ![](../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| ![](../../../_assets/4ad6cc61ca2c42a19c85.jpg) | Değerleme ve Amortisman Raporu ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../_assets/685dc72e92799fd2b093.png) | Değerleme ve Amortisman Raporu ekranı için verilen kısıtların iptal edilerek ekranın yenilenmesi için kullanılan butondur. |
...
| Değerleme ve Amortisman Raporu Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| Değerleme ve Amortisman Raporu Ekranı | Yazıcı Seçenekleri |
