---
title: "Banka Hesap Hareketleri Dökümü"
page_id: "22806339"
...
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Finans / Banka / Raporlar / Banka / Banka Hesap Hareketleri Dökümü"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPWJmNzA4Y2RkLThlZWItNDEzNC05NDQ5LTAwMGRmZGZlYzY5YSZsaW5rPWViYWUwM2UwLTVmMzgtNGM2Yy1iOTNiLTU5OGY0ZWJjYWY2ZiZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=bf708cdd-8eeb-4134-9449-000dfdfec69a&link=ebae03e0-5f38-4c6c-b93b-598f4ebcaf6f&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "banka-hesap-hareketleri-dokumu_34223241_22806339.html"
source_version: "2022-12-05T12:09:54.853+03:00"
source_bytes: 1008776
fetched_at: "2026-09-13T04:10:31+00:00"
generator: "netsis-scraper 1.0.0"
---
# Banka Hesap Hareketleri Dökümü

Finans Bölümü'nde, "Raporlar/Banka" menüsünün altında yer alır. Banka Hesap Hareketleri Dökümü, "Banka Hesap Hareketleri" bölümüne kaydedilen, banka hesabı ile ilgili hareketlerin izlendiği bölümdür. Banka Hesap Hareketleri Dökümü; Banka Hesap Ön Sorgulama, Genel Kısıtlar, Kısıt, Sıralama, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Banka Hesap Ön Sorgulama**

![](../../../../_assets/b1bbd9f0c990534cb082.png)

Banka Hesap Ön Sorgulama sekmesinin alanları ve içerdiği bilgiler aşağıdaki şekildedir:

| Banka Hesap Hareketleri Dökümü Ekranı |  |
| --- | --- |
| Ana Kodu Aralığı | Banka ana hesabına ait başlangıç ve bitiş kodlarının ![](../../../../_assets/088477bb321d1b20c939.jpg) rehber butonu yardımı ile seçilerek, banka hesap hareketleri dökümü için kısıt verilmesini sağlayan alandır. |
| Şube Kodu Aralığı | Banka şube koduna ait başlangıç ve bitiş kodlarının ![](../../../../_assets/088477bb321d1b20c939.jpg) rehber butonu yardımı ile seçilerek, banka hesap hareketleri dökümü için kısıt verilmesini sağlayan alandır. |
| Hesap Kodu Aralığı | Banka hesap koduna ait başlangıç ve bitiş kodlarının ![](../../../../_assets/088477bb321d1b20c939.jpg) rehber butonu yardımı ile seçilerek, banka hesap hareketleri dökümü için kısıt verilmesini sağlayan alandır. |
| Başlangıç/Bitiş Hesap Tipi | Banka hesap hareketleri dökümü için hesap tipi kısıdı verilen alandır. Alanın sağ tarafında yer alan aşağı ok butonu ile hesap tipleri arasından seçim yapılır. |
| Banka Hesap No | Banka hesap hareketleri dökümü için hesap numarası kısıdı verilen alandır. |
| IBAN | Banka hesap hareketleri dökümü için IBAN kısıdı verilen alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, banka hesap kodları arasından seçim yapılır. |
| Rapor Kodu | Banka hesap hareketleri dökümü için rapor kodu kısıdı verilen alandır. |
| Döviz Tipi Aralığı | Banka hesap hareketleri dökümü için döviz tip kısıdı verilen alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, döviz tipleri arasından seçim yapılır. |
...
| Proje Kodu Aralığı | Girilen aralıktaki proje koduna sahip olan banka hareketlerinin, proje kodu bazında raporda listelenmesi için kullanılan alandır. |
...
| ![](../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Banka Hesap Ön Sorgulama ve Kısıt sayfalarında verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Banka hesap hareketleri dökümü için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki banka hesap hareket dökümü işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Banka hesap hareketleri dökümü ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../_assets/973111d004995dca0113.jpg) İptal | Banka hesap hareketleri dökümü için verilen kısıtların iptal edildiği butondur. |

**Genel Kısıtlar**

![](../../../../_assets/1236c5e1a6d9449fb9f1.png)

Banka Hesap Hareketleri ekranı Genel Kısıtlar sekmesinin alanları ve içerdiği bilgiler aşağıdaki şekildedir:

| Banka Hesap Hareketleri Dökümü Ekranı |  |
| --- | --- |
| Tarih Aralığı | Girilen tarih aralığındaki banka hareket kayıtlarının raporda listelenmesini sağlayan alandır. |
| Vade Tarihi Aralığı | Girilen vade tarihi aralığındaki banka hareket kayıtlarının raporda listelenmesini sağlayan alandır. |
| Banka Hesap Kırılımında Sayfa Başı | Hareket dökümü birden fazla banka hesabı için alınıyorsa, her banka hesabı hareketinin başka bir sayfadan başlayarak raporlanması için işaretlenmesi gereken seçenektir. Bu seçenek işaretlenmezse, bir banka hesabının hareket dökümü bittiğinde diğer banka hesabının hareketlerine sayfanın kalan yerinden devam edilir. |
| Tarih Kırılımı | Raporu alınan banka hareketinin her bir tarih değişiminde toplam alınmasının istendiği durumlarda işaretlenmesi gereken seçenektir. **Örneğin:** Banka hareket dökümünde ayın 1. veya 2. gününe ait beş adet hareket olduğu varsayıldığında ve bu alan işaretlendiğinde, ayın 1. gününe ait hareketler listelendikten sonra ilgili güne ait toplamlar alınır ve ayın 2. gününe geçilir. Aynı şekilde 2. gününe ait kayıtlar listelendikten sonra toplamlar alınır her iki güne ait genel toplamlar alınarak rapor tamamlanır. |
| TL Değerleri Dökülsün | Dövizli değerler ile birlikte TL Borç, TL Alacak ve TL Bakiye değerlerinin de raporda listelenmesi için kullanılan seçenektir. |
| Sıralama | Banka hesap hareketlerinin sıralaması ile ilgili belirleme yapılan alandır. Kayıt Tarihi ve Vade olmak üzere iki seçenekten oluşur. |
| Verilen Tarih Aralığında Hareketi Olmayanlar Dökülsün | Bu seçenek işaretlendiğinde, verilen tarih aralığında işlem görmeyen banka hesapları da devreden bakiyeleri ile listelenir. İşaretlenmediğinde ise, verilen tarih aralığında hareketi olmayan banka hesapları listelenmez. |
| ![](../../../../_assets/7ba39f9046a578093326.png) Rapor | Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
| ![](../../../../_assets/e3223333470668512f5f.jpg) Oku | Daha önceden saklanan kısıtların aynısının ekrana getirilmesini sağlayan butondur. **Oku** butonu ile sadece "en son saklanan kısıtlar" ekrana getirilir. |
| ![](../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Banka Hesap Ön Sorgulama ve Kısıt sayfalarında verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Banka hesap hareketleri dökümü için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki banka hesap hareket dökümü işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Banka hesap hareketleri dökümü ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
...
![](../../../../_assets/c7c6087f88df978a439b.png)

Kısıt sekmesinin alanları ve içerdiği bilgiler aşağıdaki şekildedir:

| Banka Hesap Hareketleri Dökümü Ekranı |  |
| --- | --- |
| Sahalar | Banka hesap hareket dökümü için kısıt verilmesi istenen alanlar yer alır. Ekle ![](../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "kısıt verilecek sahalar" kısmına eklenir. |
| Kısıt Verilecek Sahalar | Banka hesap hareket dökümü için kısıt verilen sahaların yer aldığı alandır. Çıkar ![](../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
![](../../../../_assets/a7544dc66400d35d1140.png)

Sıralama sekmesinin alanları ve içerdiği bilgiler aşağıdaki şekildedir:

| Banka Hesap Hareketleri Dökümü Ekranı |  |
| --- | --- |
| Sahalar | Banka hesap hareket dökümü alırken sıralanması istenen alanlar yer alır. Ekle ![](../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "sıralama sahaları" kısmına eklenir. |
| Sıralama Sahaları | Banka hesap hareket dökümü alırken sıralama yapılacak sahaların yer aldığı alandır. Çıkar ![](../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
![](../../../../_assets/f61454f8ea630c90b769.png)
...
![](../../../../_assets/5df7c370311acb776684.png)
...
| Banka Hesap Hareketleri Dökümü Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| Banka Hesap Hareketleri Dökümü Ekranı | Yazıcı Seçenekleri |
