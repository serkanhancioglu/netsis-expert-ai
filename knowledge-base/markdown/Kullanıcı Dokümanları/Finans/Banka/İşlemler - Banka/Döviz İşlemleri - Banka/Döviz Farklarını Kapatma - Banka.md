---
title: "Döviz Farklarını Kapatma / Banka"
page_id: "22806293"
...
breadcrumb:
  ...
  - "Banka"
  - "İşlemler / Banka"
  - "Döviz İşlemleri / Banka"
  - "Döviz Farklarını Kapatma / Banka"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Finans / Banka / İşlemler / Banka / Döviz İşlemleri / Banka / Döviz Farklarını Kapatma / Banka"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPTkwYWY1NjkyLTZiNGEtNGM4NS1hODY1LWE1NDg3ZjAzZTQ5ZSZsaW5rPTE2YTViZTZiLTY4N2ItNDZkYS04YzhhLTgwYzkzNjIyOTA5YyZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=90af5692-6b4a-4c85-a865-a5487f03e49e&link=16a5be6b-687b-46da-8c8a-80c93622909c&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "doviz-farklarini-kapatma-banka_22806297_22806293.html"
source_version: "2022-12-05T10:21:08.217+03:00"
source_bytes: 1074876
fetched_at: "2026-09-13T04:10:19+00:00"
generator: "netsis-scraper 1.0.0"
---
# Döviz Farklarını Kapatma / Banka

Finans Bölümü'nde, "İşlemler/Banka" menüsünün altında yer alır. Banka modülünde yer alan Döviz Farklarını Kapatma bölümü, kur farklarının işletilmesini sağlar. İlgili Banka Hesap Kodu ile Banka Hesap Kayıtları arasında kur farkı gelir/gider hesapları çalışır. Döviz işlemleri yapılan banka kayıtlarında, yıl içinde entegre kayıtlardan veya elle girilen banka hareket kayıtlarından oluşan döviz tutarlarının, işlem yapılan günün kurundan hesaplanan TL tutarlarda meydana gelecek tutar farklılıklarını kapatmak için kullanılan bölümdür. Döviz Farklarını Kapatma; Banka Hesap Ön Sorgulama, Genel Kısıtlar, Kısıt, Sıralama, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Banka Hesap Ön Sorgulama**

Kur farkı işletilecek hareketlere ait kısıt verilmesini sağlayan sekmedir.

![](../../../../../_assets/aafae908f7253356e2c9.png)

Döviz Farklarını Kapatma ekranı Banka Hesap Ön Sorgulama sekmesinde yer alan alanlar ve içerdiği bilgiler aşağıdaki şekildedir:

| Döviz Farklarını Kapatma Ekranı |  |
| --- | --- |
| Ana Kodu Aralığı | Döviz farklarını kapatmak için banka ana kod aralığı kısıdı verilen alandır. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) ile, hesaplar arasından seçim yapılır. |
| Şube Kodu Aralığı | Döviz farklarını kapatmak için banka şube kodu aralığı kısıdı verilen alandır. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) ile, hesaplar arasından seçim yapılır. |
| Hesap Kodu Aralığı | Döviz farklarını kapatmak için hesap kodu aralığı kısıdı verilen alandır. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) ile, hesaplar arasından seçim yapılır. |
| Başlangıç/Bitiş Hesap Tipi | Döviz farklarını kapatmak için hesap tipi kısıdı verilen alandır. Alanın sağ tarafında yer alan aşağı ok butonu ile hesap tipleri arasından seçim yapılır. |
| Banka Hesap No | Döviz farklarını kapatmak için banka hesap numarası kısıdı verilen alandır. |
| IBAN | Döviz farklarını kapatmak için IBAN kısıdı verilen alandır. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) ile, banka hesap kodları arasından seçim yapılır. |
| Rapor Kodu | Döviz farklarını kapatmak için rapor kodu kısıdı verilen alandır. |
| Döviz Tipi Aralığı | Döviz farklarını kapatmak için döviz tip kısıdı verilen alandır. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) ile, döviz tipleri arasından seçim yapılır. |
...
Döviz farklarını kapatma ile ilgili tanımlamaların yapıldığı sekmedir.

![](../../../../../_assets/7f5678309343150d90fc.png)

Döviz Farklarını Kapatma ekranı Genel sekmesinde yer alan alanlar ve içerdiği bilgiler aşağıdaki şekildedir:

| Döviz Farklarını Kapatma Ekranı |  |
| --- | --- |
| Başlangıç/Bitiş Tarihi | Banka hesap hareketleri için kur farkı hesaplanacak başlangıç ve bitiş tarih aralığının belirlendiği alandır. |
| Kayıt/Vade | Kur farklarının kapatılması için girilen tarih aralığına kısıt verilmesini sağlayan alandır. Kayıt veya Vade seçenekleri arasından seçim yapılarak tarih aralığına kısıt verilir. |
| Hareket Türü Aralığı | Banka hesap hareketleri için kur farkı hesaplanacak hareket türü aralığının belirlendiği alandır. Alanın sağ tarafında yer alan aşağı ok butonu ile hareket türleri arasından seçim yapılır. |
| Kur Tarihi | Kur farkı hesaplaması yapılacak tarihin girildiği alandır. |
| Referans Kodu | Muhasebe → Kayıt → [Muhasebe Parametreleri](<../../../../Muhasebe/Muhasebe Modülü/Kayıt - Muhasebe/Muhasebe Parametreleri.md>) → Yevmiye → "Fişlerde Referans Kodu Sorulsun" parametresinin işaretlenmesi ile aktif hale gelen alandır. Kur farklarının kapatılması için referans kodu kısıdı verilmesini sağlar. |
| Döviz Çevrim Tipi | Yukarıda belirlenen döviz cinsinin, Döviz Alış, Satış, Efektif Alış, Satış kurlarından hangisinin döviz farklarını kapatmada baz alınacağının seçildiği alandır. Bu alan, Yardımcı Programlar → [Şirket/Şube Parametreleri](<../../../../Muhasebe/Muhasebe Modülü/Ekler - Muhasebe/Ek-1 Enflasyon Muhasebesi/Genel Tanımlar/Yardımcı Programlar-Şirket-Şube Parametreleri.md>) bölümünde yer alan "Döviz Çevrim Tipi" alanındaki seçime göre otomatik olarak ekrana gelir. |
| Sıfır Bakiyeliler Dahil | İşleme sıfır bakiye veren cari hesapların dahil edilmesi istendiğinde işaretlenmesi gereken seçenektir. |
| Sadece Sıfır Bakiyeliler İçin İşlem Yapılsın | Döviz farklarını kapatma işleminin sadece sıfır bakiye veren banka hesapları için yapılması istendiğinde kullanılan seçenektir. |
| Kur Farkı İşlensin | Bu alan işaretlenmediğinde banka hareketlerine kur farkı kaydı aktarılmaz fakat, oluşacak kur farkı raporu izlenebilir. İşaretlendiğinde ise, son döviz bakiyesinin farkları, kapatılacak tarih olan girilen kur tarihindeki kura göre TL tutara çevrilip, TL farkı hesaplanarak, oluşan kur farkları banka hareketlerine ve entegrasyona aktarılır. |
| ![](../../../../../_assets/21c20c78203acae9cce6.jpg) Rapor | Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
| ![](../../../../../_assets/e3223333470668512f5f.jpg) Oku | Daha önceden saklanan kısıtların aynısının ekrana getirilmesini sağlayan butondur. **Oku** butonu ile sadece "en son saklanan kısıtlar" ekrana getirilir. |
| ![](../../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Genel Kısıtlar ve Kısıt sayfalarında verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Döviz farklarını kapatmak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki kur farklarını kapatma işleminde kullanılmak üzere saklanır. |
| ![](../../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Kur farklarını kapatma ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
...
![](../../../../../_assets/da3de570f45a2c1d97f5.png)

Kısıt sekmesinde yer alan alanlar ve içerdiği bilgiler aşağıdaki şekildedir:
...
![](../../../../../_assets/971504d0c562771443b3.png)

Sıralama sekmesinde yer alan alanlar ve içerdiği bilgiler aşağıdaki şekildedir:
...
![](../../../../../_assets/f1de4f19ff6464125b7f.png)
...
![](../../../../../_assets/059a3525ac60fc0cf131.png)

Yazıcı Seçenekleri sekmesinde yer alan alanlar ve içerdiği bilgiler aşağıdaki şekildedir:
...
| Döviz Farklarını Kapatma Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| Döviz Farklarını Kapatma Ekranı | Yazıcı Seçenekleri |
