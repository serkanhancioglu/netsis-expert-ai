---
title: "Toplu Bordro Basımı / Borç Senetleri"
page_id: "24740358"
...
breadcrumb:
  ...
  - "Toplu Bordro Basımı / Borç Senetleri"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Finans / Borç Senetleri / Raporlar / Borç Senetleri / Toplu Bordro Basımı / Borç Senetleri"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPTlhYWEwMGY5LTVmMjAtNGRiOC04NTQ0LTQ2ZDYzYmRiMjk4ZiZsaW5rPTdkYjRjNDY1LTE5N2QtNGNjMy05ZTBhLTg1MmUxMTJlOGIzMiZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=9aaa00f9-5f20-4db8-8544-46d63bdb298f&link=7db4c465-197d-4cc3-9e0a-852e112e8b32&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "toplu-bordro-basimi-borc-senetleri_34218707_24740358.html"
source_version: "2022-12-13T10:48:31.267+03:00"
source_bytes: 546464
fetched_at: "2026-09-13T04:12:28+00:00"
generator: "netsis-scraper 1.0.0"
---
# Toplu Bordro Basımı / Borç Senetleri

Borç Senetleri modülü Toplu Bordro Basımı bölümü, Finans Bölümü'nde, "Raporlar/Borç Senetleri" menüsünün altında yer alır. Borç Senetleri modülü Toplu Bordro Basımı bölümü, kaydedilen alındı/verildi bordrolarının bazı kısıtlar verilerek toplu halde basımının yapıldığı bölümdür. Ön Sorgulama, Genel Kısıtlar, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Ön Sorgulama**

![](../../../../_assets/044e6142b0da400ce7dc.png)

Borç Senetleri modülü Toplu Bordro Basımı bölümü Ön Sorgulama sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:
...
Borç Senetleri modülü Toplu Bordro Basımı bölümü Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:
...
| 1-2-3 Açıklama | Borç Senetleri → Kayıt → [Borç Senetleri Parametreleri](<../Kayıt - Borç Senetleri/Borç Senetleri Parametreleri.md>) → “Bordro Basımında Açıklama Bulunsun” parametresinin işaretlendiği ve "Ön Sorgulama" sekmesinde bulunan “Özel Bordro Basımı” seçeneğinin işaretlenmediği durumlarda aktif olan alandır. Üç adet açıklama sahasına, kullanıcı tarafından istenen bilgilerin bordro ile birlikte basımının yapılması için kullanılır. |
| ![](../../../../_assets/7ba39f9046a578093326.png) | Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
| ![](../../../../_assets/e3223333470668512f5f.jpg) | Daha önceden saklanan kısıtların aynısının ekrana getirilmesini sağlayan butondur. > [!NOTE]<br>> **Oku** butonu ile sadece "en son saklanan kısıtlar" ekrana getirilir. |
| ![](../../../../_assets/53859e19eb2737b88a17.jpg) | Ön Sorgulama ve Genel Kısıt sekmelerinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Toplu bordro basımı için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki bordro basım işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) | Toplu bordro basımı standart yardım bilgisi için kullanılan butondur. |
...
![](../../../../_assets/5b85360b4b7dd1097b8d.png)
