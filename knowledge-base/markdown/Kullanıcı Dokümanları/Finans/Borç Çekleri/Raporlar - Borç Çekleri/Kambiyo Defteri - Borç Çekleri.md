---
title: "Kambiyo Defteri / Borç Çekleri"
page_id: "24740244"
...
breadcrumb:
  ...
  - "Kambiyo Defteri / Borç Çekleri"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Finans / Borç Çekleri / Raporlar / Borç Çekleri / Kambiyo Defteri / Borç Çekleri"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPWExMzYxYTk2LTI4MDgtNDIwOC1hOGVkLWFhYmVjYjE0OTJkYiZsaW5rPThmNGEyOWNiLWMyOTUtNDE1Ny05N2IzLWYzM2MwM2NmZWQwOSZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=a1361a96-2808-4208-a8ed-aabecb1492db&link=8f4a29cb-c295-4157-97b3-f33c03cfed09&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "kambiyo-defteri-borc-cekleri_34219160_24740244.html"
source_version: "2022-12-13T16:23:17.667+03:00"
source_bytes: 489203
...
Borç Çekleri modülü Kambiyo Defteri bölümü, Finans Bölümü'nde Raporlar/Borç Çekleri menüsünün altında yer alır. Borç Çekleri modülü Kambiyo Defteri bölümü, daha önceden kanuni olarak basım zorunluluğu bulunan ancak bu zorunluluğun kalkması ile birlikte, isteğe bağlı olarak basım yapılmasını sağlayan bölümdür. Genel Kısıtlar, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Genel Kısıtlar**

![](../../../../_assets/7f13fa7557cd0107a777.png)

Borç Çekleri modülü Kambiyo Defteri bölümü Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler aşağıdaki şekildedir:

| Kambiyo Defteri Ekranı |  |
| --- | --- |
| Deneme Basımı/Gerçek Basım | "Kambiyo Defteri" basımının zorunlu olduğu dönemde, defterin resmi basımında kullanılan alandır. Kambiyo defteri örnek, kontrol ya deneme için basılacak ise "Deneme Basımı", onaylı kağıtlara resmi basım yapılacak ise "Gerçek Basım" seçeneği işaretlenir. |
| Tarih Aralığı | Kambiyo defteri için tarih aralığı kısıdının girildiği alandır. |
| Devirler Basılsın/Devirler Basılmasın | Kambiyo defterinin resmi basımının zorunlu olduğu dönemde kullanılan alandır. "Devir Basılsın" alanının işaretlenmesi ile kambiyo defterinin yekun (çekim yapılan tarih aralığından bir sonraki döneme devreden giriş tutarı, devreden ciro tutarı başlıkları ile, borç çekleri için devir çıkış tutarı, dönem çıkış tutarı ve devreden çıkış tutarı başlıkları ile) listesinin alınması sağlanır. |
| Muhasebeye Bakılsın/Muhasebeye Bakılmasın | Alındı/Verildi bordro veya senet numaralarının yevmiye madde tarih ve numarasının muhasebeden kontrol edilerek kambiyo defteri liste alma işleminde "Muhasebeye Bakılsın" seçeneğinin işaretlenmesi gerekir. Muhasebe ile karşılaştırma yapılmadan (örneğin; deneme basımları) liste alınması istendiğinde ise, "Muhasebeye Bakılmasın" alanının işaretlenmesi gerekir. |
...
| ![](../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Genel Kısıt ve Kısıt sekmelerinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Kambiyo defteri için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki kambiyo defteri işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Kambiyo defteri için standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../_assets/973111d004995dca0113.jpg) İptal | Kambiyo defteri için verilen kısıtların iptal edildiği butondur. |
...
**![](../../../../_assets/d58c10555e708b8d65ff.png)**
...
![](../../../../_assets/a1898f3abe2e33da353b.png)
...
| Kambiyo Defteri Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| Kambiyo Defteri Ekranı | Yazıcı Seçenekleri |
...
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) | Kambiyo defteri için standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../_assets/973111d004995dca0113.jpg) | Kambiyo defteri için verilen kısıtların iptal edildiği butondur. |
