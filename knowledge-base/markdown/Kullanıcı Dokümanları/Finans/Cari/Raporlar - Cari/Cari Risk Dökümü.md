...
breadcrumb:
  ...
  - "Raporlar / Cari"
  - "Cari Risk Dökümü"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Finans / Cari / Raporlar / Cari / Cari Risk Dökümü"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPWU5MTFhNDc2LTJhZTUtNDRmYi1iODc4LWYwYTZlYWNmOTUzMSZsaW5rPWExZDVkNjlhLTZmN2ItNDc0MS04ZjA4LTI5ZTZhNDhlZmE2YyZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=e911a476-2ae5-44fb-b878-f0a6eacf9531&link=a1d5d69a-6f7b-4741-8f08-29e6a48efa6c&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "cari-risk-dokumu_29989902_22805746.html"
source_version: "2022-11-01T14:14:06.503+03:00"
source_bytes: 219192
fetched_at: "2026-09-13T04:08:45+00:00"
generator: "netsis-scraper 1.0.0"
---
# Cari Risk Dökümü

Finans Bölümü'nde, "Raporlar/Cari " menüsünün altında yer alır. Cari Risk Dökümü, "Cari Risk Uygulaması" ile ilgili kayıtlara ait bilgilerin listelendiği rapordur. Cari Risk Dökümü; Ön Sorgulama, Genel Kısıtlar, Kısıt, Sıralama, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Ön Sorgulama**

Cari Risk Dökümü raporu Ön Sorgulama sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Cari Risk Dökümü Ekranı |  |
| --- | --- |
| Cari Kodu Aralığı | Cariye ait başlangıç ve bitiş kodlarının ![](../../../../_assets/088477bb321d1b20c939.jpg) rehber butonu yardımı ile seçilerek, cari risk dökümü için kısıt verilmesini sağlayan alandır. |
| Tip | Cari risk dökümü için tip kısıdının verildiği alandır. Hepsi, Alıcı, Satıcı, Kefil, Toptancı, Müstahsil ve Diğer olmak üzere yedi tip seçenek bulunur. |
| Grup Kodu | Cari risk dökümü için grup kodu kısıdının verildiği alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile grup kodları arasından seçim yapılabilir. |
| Kod-1/2/3/4/5 | Cari risk dökümü için daha önceden tanımlaması yapılan Kod-1/2/3/4/5 kısıdının verildiği alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile kodlar arasından seçim yapılabilir. |
| İl | Cari risk dökümü için il kısıdının verildiği alandır. |
| İlçe | Cari risk dökümü için ilçe kısıdının verildiği alandır. |
| ![](../../../../_assets/21c20c78203acae9cce6.jpg) Rapor | Cari risk dökümü için verilen kısıtlara göre Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
...
| ![](../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Genel Kısıtlar ve Kısıt sekmelerinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Cari risk dökümü için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki cari risk dökümü işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Cari risk döküm ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../_assets/973111d004995dca0113.jpg) İptal | Cari risk dökümü için verilen kısıtların iptal edildiği butondur. |

**Genel Kısıtlar**

Cari Risk Dökümü raporu Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Cari Risk Dökümü Ekranı |  |
| --- | --- |
| Rapor Baz Tarihi | Risk değerlerinin listelenmesi için girilen başlangıç tarihidir. |
| Risk Grup Kodu Aralığı | Cari risk girişinde belirlenen grup koduna kısıt verilmesi istendiğinde kullanılması gereken alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, risk grup kodları arasından seçim yapılır. |
| Ortak Risk Grupları Kümüle Edilsin | Aynı cari risk grup koduna ait kayıtların, tek satırda kümüle edilmesi istendiğinde işaretlenmesi gereken seçenektir. |
| Risk Oranları Dökülsün | Cari risk girişinde Teminat, Senet, Çek, İrsaliye ve Siparişe tanımlanan risk oranlarının raporda listelenmesi istendiğinde işaretlenmesi gereken seçenektir. |
...
Cari Risk Dökümü raporu Kısıt sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Cari Risk Dökümü Ekranı |  |
| --- | --- |
| Sahalar | Cari risk dökümü için kısıt verilmesi istenen alanlar yer alır. Ekle ![](../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "kısıt verilecek sahalar" kısmına eklenir. |
| Kısıt Verilecek Sahalar | Cari risk dökümü için kısıt verilen sahaların yer aldığı alandır. Çıkar ![](../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
Cari Risk Dökümü raporu Sıralama sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Cari Risk Dökümü Ekranı |  |
| --- | --- |
| Sahalar | Cari risk dökümü için sıralanması istenen alanlar yer alır. Ekle ![](../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "sıralama sahaları" kısmına eklenir. |
| Sıralama Sahaları | Cari risk dökümü için sıralama yapılacak sahaların yer aldığı alandır. Çıkar ![](../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
Cari Risk Dökümü raporu Yazıcı Seçenekleri sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:
