---
title: "Dönem Sonu Ciro Ve İskonto Listesi"
page_id: "22805749"
...
breadcrumb:
  ...
  - "Cari"
  - "Raporlar / Cari"
  - "Dönem Sonu Ciro Ve İskonto Listesi"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Finans / Cari / Raporlar / Cari / Dönem Sonu Ciro Ve İskonto Listesi"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPThhZGFkNDI5LWNiNWItNGU4NC1hNGZmLWE1ZmRmNmI4YmJmMCZsaW5rPWUxODA3M2RlLTczYjYtNDlkNy1iY2YxLTE1NDAyZTkzM2Q1YyZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=8adad429-cb5b-4e84-a4ff-a5fdf6b8bbf0&link=e18073de-73b6-49d7-bcf1-15402e933d5c&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "donem-sonu-ciro-ve-iskonto-listesi_29989983_22805749.html"
source_version: "2022-11-01T14:17:45.240+03:00"
source_bytes: 218535
fetched_at: "2026-09-13T04:08:46+00:00"
generator: "netsis-scraper 1.0.0"
---
# Dönem Sonu Ciro Ve İskonto Listesi

Finans Bölümü'nde, "Raporlar/Cari " menüsünün altında yer alır. Dönem Sonu Ciro Ve İskonto Listesi; "Ciro Primi uygulaması" kullanıldığı durumlarda, bu uygulama ile ilgili Cari Kod, Cari İsim, Koşul Kodu, Miktar/Tutar, Toplam Ciro, Hak edilen İskonto, Kullanılan İskonto ve Kalan İskonto gibi bilgilerin listelendiği rapordur. Dönem Sonu Ciro Ve İskonto Listesi; Ön Sorgulama, Genel Kısıtlar, Kısıt, Sıralama, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Ön Sorgulama**

Dönem Sonu Ciro Ve İskonto Listesi ekranı Ön Sorgulama sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Dönem Sonu Ciro Ve İskonto Listesi Ekranı |  |
| --- | --- |
| Cari Kodu Aralığı | Cariye ait başlangıç ve bitiş kodlarının ![](../../../../_assets/088477bb321d1b20c939.jpg) rehber butonu yardımı ile seçilerek, dönem sonu ciro ve iskonto listesi almak için kısıt verilmesini sağlayan alandır. |
| Tip | Dönem sonu ciro ve iskonto listesi almak için tip kısıdının verildiği alandır. Hepsi, Alıcı, Satıcı, Kefil, Toptancı, Müstahsil ve Diğer olmak üzere yedi tip seçenek bulunur. |
| Grup Kodu | Dönem sonu ciro ve iskonto listesi almak için grup kodu kısıdının verildiği alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile grup kodları arasından seçim yapılabilir. |
| Kod-1/2/3/4/5 | Dönem sonu ciro ve iskonto listesi almak için daha önceden tanımlaması yapılan Kod-1/2/3/4/5 kısıdının verildiği alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile kodlar arasından seçim yapılabilir. |
| İl | Dönem sonu ciro ve iskonto listesi almak için il kısıdının verildiği alandır. |
| İlçe | Dönem sonu ciro ve iskonto listesi almak için ilçe kısıdının verildiği alandır. |
| ![](../../../../_assets/21c20c78203acae9cce6.jpg) Rapor | Dönem sonu ciro ve iskonto listesi almak için verilen kısıtlara göre Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
...
| ![](../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Genel Kısıtlar ve Kısıt sekmelerinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Dönem sonu ciro ve iskonto listesi almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki dönem sonu ciro ve iskonto listesi alma işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Dönem sonu ciro ve iskonto listesi alma ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../_assets/973111d004995dca0113.jpg) İptal | Dönem sonu ciro ve iskonto listesi almak için verilen kısıtların iptal edildiği butondur. |

**Genel Kısıtlar**

Dönem Sonu Ciro Ve İskonto Listesi ekranı Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Dönem Sonu Ciro Ve İskonto Listesi Ekranı |  |
| --- | --- |
| Tarih Aralığı | Raporun alınacağı tarih aralığının belirlendiği alandır. |
| Toplam Ciro Sıfır Olanlar Dökülsün | Toplam ciro değeri sıfır olan kayıtların raporda listelenmesi istendiğinde işaretlenmesi gereken seçenektir. |
...
Dönem Sonu Ciro Ve İskonto Listesi ekranı Kısıt sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Dönem Sonu Ciro Ve İskonto Listesi Ekranı |  |
| --- | --- |
| Sahalar | Dönem sonu ciro ve iskonto listesi almak için kısıt verilmesi istenen alanlar yer alır. Ekle ![](../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "kısıt verilecek sahalar" kısmına eklenir. |
| Kısıt Verilecek Sahalar | Dönem sonu ciro ve iskonto listesi almak için kısıt verilen sahaların yer aldığı alandır. Çıkar ![](../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
Dönem Sonu Ciro Ve İskonto Listesi ekranı Sıralama sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Dönem Sonu Ciro Ve İskonto Listesi Ekranı |  |
| --- | --- |
| Sahalar | Dönem sonu ciro ve iskonto listesi almak için sıralanması istenen alanlar yer alır. Ekle ![](../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "sıralama sahaları" kısmına eklenir. |
| Sıralama Sahaları | Dönem sonu ciro ve iskonto listesi almak için sıralama yapılacak sahaların yer aldığı alandır. Çıkar ![](../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
Dönem Sonu Ciro Ve İskonto Listesi ekranı Yazıcı Seçenekleri sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:
