---
title: "Cari Muhasebe Kod Listesi"
page_id: "22805554"
...
breadcrumb:
  ...
  - "Raporlar / Cari"
  - "Ek Listeler / Cari"
  - "Cari Muhasebe Kod Listesi"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Finans / Cari / Raporlar / Cari / Ek Listeler / Cari / Cari Muhasebe Kod Listesi"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPWIxMzkyZDVlLWViMDYtNDEzMi1iYzNmLWUyMDNlMzc4NzY1NiZsaW5rPTgzOWIzY2RkLTU1YTEtNDZhOC04MzYyLTU0NTA4YzY0NjBkMiZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=b1392d5e-eb06-4132-bc3f-e203e3787656&link=839b3cdd-55a1-46a8-8362-54508c6460d2&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "cari-muhasebe-kod-listesi_22805557_22805554.html"
source_version: "2022-11-17T16:17:31.047+03:00"
source_bytes: 277068
...
Cari Muhasebe Kod Listesi, Finans Bölümü'nde Raporlar/Cari menüsünün altında yer alır. Cari hesapların muhasebe entegrasyonunun sağlanması için, "Cari Hesap Kayıtları" bölümündeki "Muhasebe Kodu" alanına, muhasebe modülünde tanımlanmış olan hesap kodlarının girilmesi gerekir. Cari Muhasebe Kod Listesinde "Cari Hesap Kayıtları" bölümünde tanımlanmış olan cari kodların ve girilen muhasebe kodları raporlanır. Cari Muhasebe Kod Listesi; Ön Sorgulama, Kısıt, Sıralama, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Ön Sorgulama**

Cari Muhasebe Kod Listesi Ön Sorgulama sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Cari Muhasebe Kod Listesi Ekranı |  |
| --- | --- |
| Cari Kodu Aralığı | Cariye ait başlangıç ve bitiş kodlarının ![](../../../../../_assets/088477bb321d1b20c939.jpg) rehber butonu yardımı ile seçilerek, cari muhasebe kod listesi için kısıt verilmesini sağlayan alandır. |
| Tip | Cari muhasebe kod listesi için tip kısıdının verildiği alandır. Hepsi, Alıcı, Satıcı, Kefil, Toptancı, Müstahsil ve Diğer olmak üzere yedi tip seçenek bulunur. |
| Grup Kodu | Cari muhasebe kod listesi için grup kodu kısıdının verildiği alandır. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) ile grup kodları arasından seçim yapılabilir. |
| Kod-1/2/3/4/5 | Cari muhasebe kod listesi için daha önceden tanımlaması yapılan Kod-1/2/3/4/5 kısıdının verildiği alandır. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) ile kodlar arasından seçim yapılabilir. |
| İl | Cari muhasebe kod listesi için il kısıdının verildiği alandır. |
| İlçe | Cari muhasebe kod listesi için ilçe kısıdının verildiği alandır. |
| ![](../../../../../_assets/21c20c78203acae9cce6.jpg) Rapor | Cari muhasebe kod listesi için verilen kısıtlara göre Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. ![](../../../../../_assets/1f5dcc7948e23218f69b.png) |
...
| ![](../../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Genel Kısıtlar ve Kısıt sayfalarında verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Cari muhasebe kod listesi için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki cari muhasebe kod listesi işleminde kullanılmak üzere saklanır. |
| ![](../../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Cari muhasebe kod listesi hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../../_assets/973111d004995dca0113.jpg) İptal | Cari muhasebe kod listesi için verilen kısıtların iptal edildiği butondur. |

**Kısıt**

Cari Muhasebe Kod Listesi Kısıt sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Cari Muhasebe Kod Listesi Ekranı |  |
| --- | --- |
| Sahalar | Cari muhasebe kod listesi için kısıt verilmesi istenen alanlar yer alır. Ekle ![](../../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "kısıt verilecek sahalar" kısmına eklenir. |
| Kısıt Verilecek Sahalar | Cari muhasebe kod listesi için kısıt verilen sahaların yer aldığı alandır. Çıkar ![](../../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
Cari Muhasebe Kod Listesi Sıralama sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Cari Muhasebe Kod Listesi Ekranı |  |
| --- | --- |
| Sahalar | Cari muhasebe kod listesi için sıralanması istenen alanlar yer alır. Ekle ![](../../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "sıralama sahaları" kısmına eklenir. |
| Sıralama Sahaları | Cari muhasebe kod listesi için sıralama yapılacak sahaların yer aldığı alandır. Çıkar ![](../../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
Cari Muhasebe Kod Listesi Yazıcı Seçenekleri sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:
