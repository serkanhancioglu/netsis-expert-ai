...
breadcrumb:
  ...
  - "Dövizli Listeler"
  - "Kur Farkı Listesi"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Finans / Cari / Raporlar / Cari / Ek Listeler / Cari / Dövizli Listeler / Kur Farkı Listesi"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPTJiZWM2OGE4LTcwZjktNDBiNy1iZTU2LTgyZWZjYThiM2EyMiZsaW5rPTRlZTliOWE4LTQ3NDktNGUyMC05ZmY4LTAyMmNkMmJiNWQ5OCZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=2bec68a8-70f9-40b7-be56-82efca8b3a22&link=4ee9b9a8-4749-4e20-9ff8-022cd2bb5d98&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "kur-farki-listesi.html"
source_version: ""
source_bytes: 222047
fetched_at: "2026-09-13T04:08:31+00:00"
generator: "netsis-scraper 1.0.0"
---
# Kur Farkı Listesi

Finans Bölümü'nde Raporlar/Cari menüsünün altında yer alır. Kur Farkı Listesi, dövizli işlemlerden doğan kur farklarının listelenmesini sağlar. Kur Farkı Listesi raporunun kullanılması için, Yardımcı Programlar → Kayıt → Şirket - Şube Parametre Tanımları → “Döviz Uygulaması Var” parametresinin işaretlenmiş olması ve Fatura, Çek, Senet, Kasa ve diğer modüllerden yapılan kayıtların döviz bilgisi ile cari hareketlere aktarılması gerekir. Dövizsiz yapılan kayıtlar bu listede dikkate alınmaz. Kur Farkı Listesi; Ön Sorgulama, Genel Kısıtlar, Kısıt, Sıralama, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Ön Sorgulama**

Kur Farkı Listesi Ön Sorgulama sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Kur Farkı Listesi Ekranı |  |
| --- | --- |
| Cari Kodu Aralığı | Cariye ait başlangıç ve bitiş kodlarının ![](../../../../../../_assets/088477bb321d1b20c939.jpg) rehber butonu yardımı ile seçilerek, kur farkı listesi için kısıt verilmesini sağlayan alandır. |
| Tip | Kur farkı listesi için tip kısıdının verildiği alandır. Hepsi, Alıcı, Satıcı, Kefil, Toptancı, Müstahsil ve Diğer olmak üzere yedi tip seçenek bulunur. |
| Grup Kodu | Kur farkı listesi için grup kodu kısıdının verildiği alandır. Rehber butonu ![](../../../../../../_assets/088477bb321d1b20c939.jpg) ile grup kodları arasından seçim yapılabilir. |
| Kod-1/2/3/4/5 | Kur farkı listesi için daha önceden tanımlaması yapılan Kod-1/2/3/4/5 kısıdının verildiği alandır. Rehber butonu ![](../../../../../../_assets/088477bb321d1b20c939.jpg) ile kodlar arasından seçim yapılabilir. |
| İl | Kur farkı listesi için il kısıdının verildiği alandır. |
| İlçe | Kur farkı listesi için ilçe kısıdının verildiği alandır. |
| ![](../../../../../../_assets/21c20c78203acae9cce6.jpg) Rapor | Kur farkı listesi için verilen kısıtlara göre Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
...
| ![](../../../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Genel Kısıtlar ve Kısıt sayfalarında verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Kur farkı listesi için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki kur farkı listesi işleminde kullanılmak üzere saklanır. |
| ![](../../../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Kur farkı listesi hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../../../_assets/973111d004995dca0113.jpg) İptal | Kur farkı listesi için verilen kısıtların iptal edildiği butondur. |

**Genel Kısıtlar**

Kur Farkı Listesi Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Kur Farkı Listesi Ekranı |  |
| --- | --- |
| Başlangıç Tarihi | Raporda listelenecek bilgiler için girilen başlangıç tarihidir. Cari hareket kayıtlarında bu tarihten sonraki hareketler listeye dahil edilir. |
| Bitiş Tarihi | Raporda listelenecek bilgiler için girilen sınır tarihidir. Cari hareket kayıtlarında bu tarihe kadar olan hareketler listeye dahil edilir, bu tarihten sonraki hareketler dahil edilmez. |
| Vade Baz Tarihi | Kur farkı hesaplaması yapılacak cari hareketler için baz alınacak vade tarihidir. Hareket tarihi yukarıda verilen tarihler arasında olup, vadesi bu alana girilen vadede olan hareketler için kur farkı hesaplanır. |
| Borç/Alacak | Kur farkı hesaplamalarının, cari hesapların borç/alacak hareketlerinden hangisi için yapılacağının belirlendiği alandır. |
| İcmal | Cari hesaplar bazında her bir hareket için ayrı hesaplanan ve listelenen kur farkının, icmal şeklinde tek satırda listelenmesini sağlayan seçenektir. |
| Provizyon | Provizyon seçeneği işaretlendiğinde, vadesi baz tarihinden ileri tarihli olan kayıtlara kur farkı hesaplaması yapılır. İşaretlenmediğinde ise, vadesi baz tarihinden ileri tarihli olan hareket kayıtları için kur farkı tutarı hesaplanmaz. |
| Kur Farkı Olmayanlar Basılsın | Kur farkı olmayan hareketlerin raporda görülmesi istendiğinde işaretlenmesi gereken seçenektir. |
| ![](../../../../../../_assets/21c20c78203acae9cce6.jpg) Rapor | Kur farkı listesi için verilen kısıtlara göre Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
| ![](../../../../../../_assets/e3223333470668512f5f.jpg) Oku | Daha önceden saklanan kısıtların aynısının ekrana getirilmesini sağlayan butondur. **Oku** butonu ile sadece "en son saklanan kısıtlar" ekrana getirilir. |
| ![](../../../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Genel Kısıtlar ve Kısıt sayfalarında verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Kur farkı listesi için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki kur farkı listesi işleminde kullanılmak üzere saklanır. |
| ![](../../../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Kur farkı listesi hakkında standart yardım bilgisi için kullanılan butondur. |
...
Kur Farkı Listesi Kısıt sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Kur Farkı Listesi Ekranı |  |
| --- | --- |
| Sahalar | Kur farkı listesi için kısıt verilmesi istenen alanlar yer alır. Ekle ![](../../../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "kısıt verilecek sahalar" kısmına eklenir. |
| Kısıt Verilecek Sahalar | Kur farkı listesi için kısıt verilen sahaların yer aldığı alandır. Çıkar ![](../../../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
Kur Farkı Listesi Sıralama sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Kur Farkı Listesi Ekranı |  |
| --- | --- |
| Sahalar | Kur farkı listesi için sıralanması istenen alanlar yer alır. Ekle ![](../../../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "sıralama sahaları" kısmına eklenir. |
| Sıralama Sahaları | Kur farkı listesi için sıralama yapılacak sahaların yer aldığı alandır. Çıkar ![](../../../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
Kur Farkı Listesi Yazıcı Seçenekleri sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:
