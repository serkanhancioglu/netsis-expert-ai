...
breadcrumb:
  ...
  - "Ek Listeler / Cari"
  - "Etiket Basımı / Cari"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Finans / Cari / Raporlar / Cari / Ek Listeler / Cari / Etiket Basımı / Cari"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPTVmYTRhODU0LTAxZjMtNGY0OC1hNTYwLTQ1ZmQxNGNhYjgzZiZsaW5rPTMxMWViNmRmLTA2ODgtNDA0Yy05NDhmLTNlOWY4Yjc5ZDU4MSZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=5fa4a854-01f3-4f48-a560-45fd14cab83f&link=311eb6df-0688-404c-948f-3e9f8b79d581&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "etiket-basimi-cari_29988321_22805597.html"
source_version: "2022-11-18T15:21:31.743+03:00"
source_bytes: 223164
fetched_at: "2026-09-13T04:08:27+00:00"
generator: "netsis-scraper 1.0.0"
---
# Etiket Basımı / Cari

Finans Bölümü'nde, "Raporlar/Cari" menüsünün altında yer alır. Etiket Basımı Cari bölümünden, cari hesap kayıtlarında isim, adres, il, ilçe, posta kodu istendiğinde, seçenekli olarak açıklama-1, açıklama-2, telefon, vergi dairesi vb. bilgilerin standart etiketlere aktarılması sağlanır. Hem ekrandan hem de yazıcıdan çıktı alınabilir. Etiket Basımı/Cari; Ön Sorgulama, Genel Kısıtlar, Kısıt, Sıralama, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Ön Sorgulama**

Cari Etiket Basımı Ön sorgulama sekmesinde, etiket basımı yapılması istenen cari hesaplar belirlenir. Herhangi bir kısıtlama verilmediğinde, tüm cari kayıtlar için etiket basımı yapılır.

| Etiket Basımı Ekranı |  |
| --- | --- |
| Cari Kodu Aralığı | Cariye ait başlangıç ve bitiş kodlarının ![](../../../../../_assets/088477bb321d1b20c939.jpg) rehber butonu yardımı ile seçilerek, etiket basımı için kısıt verilmesini sağlayan alandır. |
| Tip | Etiket basımı için tip kısıdının verildiği alandır. Hepsi, Alıcı, Satıcı, Kefil, Toptancı, Müstahsil ve Diğer olmak üzere yedi tip seçenek bulunur. |
| Grup Kodu | Etiket basımı için grup kodu kısıdının verildiği alandır. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) ile grup kodları arasından seçim yapılabilir. |
| Kod-1/2/3/4/5 | Etiket basımı için daha önceden tanımlaması yapılan Kod-1/2/3/4/5 kısıdının verildiği alandır. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) ile kodlar arasından seçim yapılabilir. |
| İl | Etiket basımı için il kısıdının verildiği alandır. |
| İlçe | Etiket basımı için ilçe kısıdının verildiği alandır. |
| ![](../../../../../_assets/21c20c78203acae9cce6.jpg) Rapor | Etiket basımı için verilen kısıtlara göre Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
...
| ![](../../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Genel Kısıtlar ve Kısıt sayfalarında verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Etiket basımı için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki etiket basımı işleminde kullanılmak üzere saklanır. |
| ![](../../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Etiket basımı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../../_assets/973111d004995dca0113.jpg) İptal | Etiket basımı için verilen kısıtların iptal edildiği butondur. |

**Genel Kısıtlar**

Cari Etiket Basımı Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Etiket Basımı Ekranı | Genel Kısıtlar |
| --- | --- |
| Etiket Tipi (35\*77/35\*97) | Etiketin tipinin seçildiği alandır. 1- 35 mm x 77 mm. 2- 35 mm x 97 mm etiket ebatları seçeneklerinden biri seçilir. |
| Başlık | Her etiketin başına basılması istenen bilginin girildiği alandır. Program tarafından, "Sayın" başlığı otomatik şekilde ekrana getirilir. İstendiğinde kullanıcılar tarafından değiştirilebilir. |
| Cari Kodu Basılsın | Cari hesaba ait kodun etikete basılması istendiğinde işaretlenmesi gereken seçenektir. |
| Cari Açıklama 1-2 Basılsın | Cari hesaba ait açıklama 1 ve 2 alanlarının etikete basılması istendiğinde işaretlenmesi gereken seçenektir. |
| Telefon Basılsın | Cari hesaba ait kayıtlı telefon bilgisinin etikete basılması istendiğinde işaretlenmesi gereken seçenektir. |
| Vergi Dairesi Basılsın | Cari hesaba ait kayıtlı vergi dairesi bilgisinin etikete basılması istendiğinde işaretlenmesi gereken seçenektir. |
| Satış Faturası/İrsaliyesi Tarih Aralığı | Etiket basımı için fatura/irsaliye kısıdının verildiği alandır. Bu alana girilen tarih aralığındaki satış faturası yada irsaliyesi olan cari hesaplar için etiket basımı yapılır. |
| Kopya Etiket Sayısı | Bir cari hesaba ait basılacak etiket sayısının belirlendiği alandır. Burada girilen sayı kadar her cari hesaba etiket basılır. İşaretlenen seçenekler doğrultusunda istenirse ilk önce ekrandan (kontrol amaçlı) basım yapabilir, daha sonra yazıcıdan çıktı alınabilir. |
| İçinde Bulunulan Şube Hareketleri Gösterilsin | Etiket basımının sadece içinde bulunulan şube için alınması istendiğinde işaretlenmesi gereken seçenektir. |
| Proje Kodu Kırılımı | "Proje Kodu Takibi" uygulamasının kullanıldığı durumlarda aktif hale gelen alandır. Raporda proje koduna göre kısıt verilmesi ve proje kodu bazında etiket basımı istendiğinde işaretlenmesi gereken seçenektir. |
| Proje Kodu Aralığı | Girilen aralıktaki proje koduna sahip olan cari hareketlerin, proje kodu bazında etiket basımı alınması için kullanılan alandır. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) ile proje kodları arasından seçim yapılır. |
| ![](../../../../../_assets/21c20c78203acae9cce6.jpg) Rapor | Etiket basımı için verilen kısıtlara göre Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
| ![](../../../../../_assets/e3223333470668512f5f.jpg) Oku | Daha önceden saklanan kısıtların aynısının ekrana getirilmesini sağlayan butondur. **Oku** butonu ile sadece "en son saklanan kısıtlar" ekrana getirilir. |
| ![](../../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Genel Kısıtlar ve Kısıt sayfalarında verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Etiket basımı için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki etiket basımı işleminde kullanılmak üzere saklanır. |
| ![](../../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Etiket basımı hakkında standart yardım bilgisi için kullanılan butondur. |
...
Cari Etiket Basımı Kısıt sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Etiket Basımı Ekranı |  |
| --- | --- |
| Sahalar | Etiket basımı için kısıt verilmesi istenen alanlar yer alır. Ekle ![](../../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "kısıt verilecek sahalar" kısmına eklenir. |
| Kısıt Verilecek Sahalar | Etiket basımı için kısıt verilen sahaların yer aldığı alandır. Çıkar ![](../../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
Cari Etiket Basımı Sıralama sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Etiket Basımı Ekranı |  |
| --- | --- |
| Sahalar | Etiket basımı için sıralanması istenen alanlar yer alır. Ekle ![](../../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "sıralama sahaları" kısmına eklenir. |
| Sıralama Sahaları | Etiket basımı için sıralama yapılacak sahaların yer aldığı alandır. Çıkar ![](../../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
Cari Etiket Basımı Yazıcı Seçenekleri sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:
