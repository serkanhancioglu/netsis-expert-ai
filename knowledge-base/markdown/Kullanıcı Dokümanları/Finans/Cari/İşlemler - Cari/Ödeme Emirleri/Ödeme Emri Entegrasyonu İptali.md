---
title: "Ödeme Emri Entegrasyonu İptali"
page_id: "22805249"
...
breadcrumb:
  ...
  - "İşlemler / Cari"
  - "Ödeme Emirleri"
  - "Ödeme Emri Entegrasyonu İptali"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Finans / Cari / İşlemler / Cari / Ödeme Emirleri / Ödeme Emri Entegrasyonu İptali"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPWM0ODNjOWVmLTIyZTMtNDAxMy04YThlLThiMWM4NDcxN2YwZSZsaW5rPTViZjA1M2RkLWI4YWUtNDcxNy1hNzA2LTU1NGQ3MGFiOTliMSZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=c483c9ef-22e3-4013-8a8e-8b1c84717f0e&link=5bf053dd-b8ae-4717-a706-554d70ab99b1&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "odeme-emri-entegrasyonu-iptali_29985758_22805249.html"
source_version: "2022-11-17T10:43:59.980+03:00"
source_bytes: 201779
fetched_at: "2026-09-13T04:08:07+00:00"
generator: "netsis-scraper 1.0.0"
---
# Ödeme Emri Entegrasyonu İptali

Ödeme Emri Entegrasyonu İptali işlemi, Finans Bölümü'nde İşlemler/Cari menüsünün altında yer alır. Ödeme emri entegrasyonunun iptali için kullanılan bölümdür. Ödeme Emri Entegrasyonu İptali; Ön Sorgulama, Genel Kısıtlar, Kısıt, Sıralama, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Ön Sorgulama**

Ödeme Emri Entegrasyonu İptali ekranı Ön sorgulama sekmesindeki bilgiler, ödeme emrinin yapıldığı cari hesap ile ilgili kısıt vermek amacıyla kullanılır.

| Ödeme Emri Entegrasyon İptali Ekranı |  |
| --- | --- |
| Cari Kodu Aralığı | Cariye ait başlangıç ve bitiş kodlarının ![](../../../../../_assets/088477bb321d1b20c939.jpg) rehber butonu yardımı ile seçilerek, ödeme emri entegrasyon iptali için kısıt verilmesini sağlayan alandır. |
| Tip | Ödeme emri entegrasyon iptali için tip kısıdının verildiği alandır. Hepsi, Alıcı, Satıcı, Kefil, Toptancı, Müstahsil ve Diğer olmak üzere yedi tip seçenek bulunur. |
| Grup Kodu | Ödeme emri entegrasyon iptali için grup kodu kısıdının verildiği alandır. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) ile grup kodları arasından seçim yapılabilir. |
| Kod-1/2/3/4/5 | Ödeme emri entegrasyon iptali için daha önceden tanımlaması yapılan Kod-1/2/3/4/5 kısıdının verildiği alandır. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) ile kodlar arasından seçim yapılabilir. |
| İl | Ödeme emri entegrasyon iptali için il kısıdının verildiği alandır. |
| İlçe | Ödeme emri entegrasyon iptali için ilçe kısıdının verildiği alandır. |
| ![](../../../../../_assets/39d77b8716226638d9ce.jpg) Tamam | Ödeme emri entegrasyon iptali için verilen kısıtlara göre Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
...
| ![](../../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Genel Kısıtlar, Kalite Kısıtları ve Kısıt sayfalarında verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Ödeme emri entegrasyon iptali için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki ödeme emri entegrasyon iptal işleminde kullanılmak üzere saklanır. |
| ![](../../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Ödeme emri entegrasyon iptali ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../../_assets/973111d004995dca0113.jpg) İptal | Ödeme emri entegrasyon iptali için verilen kısıtların iptal edildiği butondur. |

**Genel Kısıtlar**

Ödeme Emri Entegrasyonu İptali ekranı Genel Kısıtlar sekmesi, iptal edilmesi istenen ödeme emri entegrasyonlarına ait tarih başlangıç ve bitiş aralığı verilmesi amacıyla kullanılır.

| Ödeme Emri Entegrasyon İptali Ekranı |  |
| --- | --- |
| Başlangıç Tarihi/Bitiş Tarihi | Ödeme emri entegrasyon iptali için başlangıç/bitiş tarih aralığının belirlendiği alanlardır. |
| İçinde Bulunulan Şube Hareketleri Gösterilsin | Ödeme emri entegrasyon iptal işleminin sadece içinde bulunulan şube için yapılması istendiğinde işaretlenmesi gereken seçenektir. |
| Proje Kodu Kırılımı | "Proje Takibi Uygulaması" kullanıldığı durumlarda aktif hale gelen alandır. Ödeme emri entegrasyon iptalinin, "Proje Kodu" bazında kısıt verilerek yapılması istendiğinde işaretlenmesi gereken seçenektir. |
| Proje Kodu Aralığı | Verilen aralıktaki proje koduna ait ödeme emirleri cari hareket kayıtlarından iptal edilir. Bu durumda program, cari ve tarih aralığına uyan ödeme emri entegrasyonuna ait kayıtları iptal eder. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) ile, proje kodları arasından seçim yapılır. Bu bölümden sadece havale tipinde olan ödeme emri entegrasyonları iptal edilir. |
| ![](../../../../../_assets/39d77b8716226638d9ce.jpg) Tamam | Ödeme emri entegrasyon iptali için verilen kısıtlara göre Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
| ![](../../../../../_assets/e3223333470668512f5f.jpg) Oku | Daha önceden saklanan kısıtların aynısının ekrana getirilmesini sağlayan butondur. **Oku** butonu ile sadece "en son saklanan kısıtlar" ekrana getirilir. |
| ![](../../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Genel Kısıtlar, Kalite Kısıtları ve Kısıt sayfalarında verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Ödeme emri entegrasyon iptali için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki ödeme emri entegrasyon iptal işleminde kullanılmak üzere saklanır. |
| ![](../../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Ödeme emri entegrasyon iptali ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
...
Ödeme Emri Entegrasyonu İptali ekranı Kısıt sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Ödeme Emri Entegrasyon İptali Ekranı |  |
| --- | --- |
| Sahalar | Ödeme emri entegrasyon iptali için kısıt verilmesi istenen alanlar yer alır. Ekle ![](../../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "kısıt verilecek sahalar" kısmına eklenir. |
| Kısıt Verilecek Sahalar | Ödeme emri entegrasyon iptali için kısıt verilen sahaların yer aldığı alandır. Çıkar ![](../../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
Ödeme Emri Entegrasyonu İptali ekranı Sıralama sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Ödeme Emri Entegrasyon İptali Ekranı |  |
| --- | --- |
| Sahalar | Ödeme emri entegrasyon iptali için sıralanması istenen alanlar yer alır. Ekle ![](../../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "sıralama sahaları" kısmına eklenir. |
| Sıralama Sahaları | Ödeme emri entegrasyon iptali için sıralama yapılacak sahaların yer aldığı alandır. Çıkar ![](../../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
Ödeme Emri Entegrasyonu İptali ekranı Yazıcı Seçenekleri sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:
