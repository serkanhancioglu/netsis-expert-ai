---
title: "Dövizli Senetler Yeniden Değerleme Listesi"
page_id: "24740166"
...
breadcrumb:
  ...
  - "Dövizli Senetler Yeniden Değerleme Listesi"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Finans / Müşteri Senetleri / Raporlar / Müşteri Senetleri / Dövizli Senetler Yeniden Değerleme Listesi"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPTc4MWVhZGViLTljZDItNDYzMS05MGMwLTZmOWZkZGE3NTcwYiZsaW5rPTIxN2UxMzIwLTI1ZTEtNDc1YS05MmNlLWNlM2JjZGU3N2JmZSZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=781eadeb-9cd2-4631-90c0-6f9fdda7570b&link=217e1320-25e1-475a-92ce-ce3bcde77bfe&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "dovizli-senetler-yeniden-degerleme-listesi_34218186_24740166.html"
source_version: "2022-12-07T13:47:47.767+03:00"
source_bytes: 517355
fetched_at: "2026-09-13T04:12:08+00:00"
generator: "netsis-scraper 1.0.0"
---
# Dövizli Senetler Yeniden Değerleme Listesi

Dövizli Senetler Yeniden Değerleme Listesi, Finans Bölümü'nde, "Raporlar/Müşteri Senetleri" menüsünün altında yer alır. Dövizli Senetler Yeniden Değerleme Listesi, Müşteri Senetleri → Kayıt → [Müşteri Senetleri Parametreleri](<../Kayıt - Müşteri Senetleri/Müşteri Senetleri Parametreleri.md>) → "Döviz Uygulaması Var" parametresi işaretlenerek dövizli senet kayıtları oluşturulduğunda, meydana gelen kur farkı tutarlarının listesini almayı sağlar. Dövizli Senetler Yeniden Değerleme Listesi; Genel Kısıtlar, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Genel Kısıtlar**

![](../../../../_assets/59cd1d11f50bf5382518.png)

Dövizli Senetler Yeniden Değerleme Listesi ekranı Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler aşağıdaki şekildedir:

| Dövizli Senetler Yeniden Değerleme Listesi Ekranı |  |
| --- | --- |
| Yeniden Değerlemede Baz Alınacak Tarih | Kur farkı hesaplamasında baz alınacak tarihin girildiği alandır. Girilen senetlerin döviz tutarları ve yeniden değerleme tarihinde sorgulanan tarihteki kur değerlerine göre tekrar hesaplanarak oluşan tutarlar, daha önce girilen "Senet Tutarı" alanındaki tutar bilgisinden çıkartılarak (artı ya da eksi) kur farkı olarak listelenir. Kur farkı hesaplamalarının yapılması için "Yeniden Değerlendirmede Baz Alınacak Tarih" alanında girilen tarihteki kur değerinin, Döviz Takibi → Kayıt → "[Döviz Kurları Girişi](<../../../Genel/Döviz Takibi/Kayıt - Döviz Takibi/Döviz Kurları Girişi.md>)" bölümüne önceden girilmesi gerekir. Yeniden değerleme tarihinde herhangi bir kur değerinin bulunmaması durumunda, kur farkı hesaplamaları 0 (sıfır) olarak çıkar ve hesaplanmaz. Bu bölümden alınan listelere, portföydeki banka tahsil ve teminata ciro edilen ve henüz ödenmeyen senetler dahil edilmez. Dövizli senetlerin kur farkı kayıtlarının, Müşteri Senetleri → İşlemler → [Dövizli Senetler Kur Farkı Kaydı](<../İşlemler - Müşteri Senetleri/Dövizli Senetler Kur Farkı Kaydı.md>) bölümünden muhasebeye entegre edilmeden önce bu bölümden liste alınması ve gerekli kontrollerin yapılması gerekir. |
...
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Dövizli senetler yeniden değerleme listesi almak için standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../_assets/973111d004995dca0113.jpg) İptal | Dövizli senetler yeniden değerleme listesi almak için verilen kısıtların iptal edildiği butondur. |
...
![](../../../../_assets/315b58fae8012e84ccea.png)
...
![](../../../../_assets/455b7f793432948514f4.png)
