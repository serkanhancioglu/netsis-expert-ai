---
title: "Reeskont Listesi / Müşteri Senetleri"
page_id: "24740179"
...
breadcrumb:
  ...
  - "Finans"
  - "Müşteri Senetleri"
  - "Raporlar / Müşteri Senetleri"
  - "Reeskont Listesi / Müşteri Senetleri"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Finans / Müşteri Senetleri / Raporlar / Müşteri Senetleri / Reeskont Listesi / Müşteri Senetleri"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPWZmZThiOWExLTZmMGUtNGJkNC1iN2NiLTZkOTFjYjZmZGU0OCZsaW5rPTY0NTFkMGE5LTU1M2MtNGE4MS04YjQ5LTI4ZTdiMDE5YTkwMiZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=ffe8b9a1-6f0e-4bd4-b7cb-6d91cb6fde48&link=6451d0a9-553c-4a81-8b49-28e7b019a902&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "reeskont-listesi-musteri-senetleri_34218271_24740179.html"
source_version: "2022-12-07T14:09:23.577+03:00"
source_bytes: 662053
fetched_at: "2026-09-13T04:12:11+00:00"
generator: "netsis-scraper 1.0.0"
---
# Reeskont Listesi / Müşteri Senetleri

Müşteri Senetleri Reeskont Listesi, Finans Bölümü'nde, "Raporlar/Müşteri Senetleri" menüsünün altında yer alır. Müşteri Senetleri Reeskont Listesi, senetlerin (devletin belirlemiş olduğu) aylık ya da yıllık faiz oranına göre, faizden arındırılmış tutarlarının listelendiği bölümdür. Müşteri Senetleri Reeskont Listesi; Genel Kısıtlar, Kısıt, Sıralama, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Genel Kısıtlar**

![](../../../../_assets/5a649a360a4622c19b38.png)

Reeskont Listesi ekranı Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler aşağıdaki şekildedir:

| Reeskont Listesi Ekranı |  |
| --- | --- |
| Senet Numarası Aralığı | Reeskont hesaplaması yapılacak senetler için kısıt verilen alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile ekrana gelen senet rehberine kısıt verilerek senet numarası seçilir. |
| Baz Tarihi | Reeskont hesaplaması yapılacak tarihin girildiği alandır. |
| Geçmişe Yönelik Liste Alınsın | Rapor için girilen baz tarihinin geçmiş bir tarih olması durumunda, girilen tarihe göre reeskont hesaplanması için işaretlenmesi gereken seçenektir. |
| Yer Kodu | Belirli bir yer koduna sahip olan senetlerin listelenmesi için kullanılan seçenektir. Portföy, Ciro, Tahsil, Teminat, İade ve Hepsi seçeneklerinden oluşur. Tüm senetlerin listelenmesi istendiğinde "Hepsi" seçeneğinin işaretlenmesi gerekir. |
| Faiz Oran Döviz Tipi | Oranların program tarafından kayıt altına alınması ve raporlanması için "Döviz Tanımlama" ekranından faiz oranları için döviz tipi tanımlamasının yapılması gerekir. Reeskont listesi almak için, tanımlaması yapılan döviz tipleri arasından seçim yapılır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, döviz tiplerine ulaşılır. Döviz tiplerinin tanımlanması ile ilgili detaylı bilgi için; Döviz Takibi → Kayıt → [Döviz İsimleri Tanımlama](<../../../Genel/Döviz Takibi/Kayıt - Döviz Takibi/Döviz İsimleri Tanımlama.md>) dokümanına bakılabilir. |
| Faiz Oranı | "Döviz Kurları Girişi" bölümünden, her ayın son gününe, açıklanan faiz oranı kur girişi gibi girildiğinde ve faiz oran döviz tipi seçildiğinde, faiz oranının otomatik olarak ekrana getirildiği alandır. İstendiğinde kullanıcı tarafından üzerinde değişiklik yapılabilir. Döviz tipleri bazında kur bilgilerinin girişi ile ilgili detaylı bilgi için; Döviz Takibi → Kayıt → [Döviz Kurları Girişi](<../../../Genel/Döviz Takibi/Kayıt - Döviz Takibi/Döviz Kurları Girişi.md>) dokümanına bakılabilir. |
| Aylık Oran/Yıllık Oran | Faiz oranının aylık ya da yıllık olarak seçiminin yapıldığı alandır. |
| Yıl Günü | "Yıllık Oran" alanı seçildiğinde aktif hale gelen alandır. İstendiğinde kullanıcı tarafından üzerinde değişiklik yapılabilir. |
| Şubeler dahil | Şubelere ait senet bilgilerinin de listede yer alması istendiğinde işaretlenmesi gereken seçenektir. |
| Rapor kodu | Raporda listelenmesi istenen senetlerin belirli bir rapor koduna sahip olması halinde, ilgili rapor kodu için kısıt verilen alandır. |
| Kur Farkı Tutara Eklensin | Reeskont listesi alırken, dövizli senetlerde hesaplanan kur farkı tutarının TL tutarına eklenmesi için kullanılan seçenektir. |
| Sıralama | Rapor için senet sıralamasının seçildiği alandır. Senet Numarası, Vade Tarihi ve Hiçbiri seçeneklerinden oluşur. |
...
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) | Reeskont listesi almak için standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../_assets/973111d004995dca0113.jpg) | Reeskont listesi almak için verilen kısıtların iptal edildiği butondur. |

**Sıralama**

![](../../../../_assets/5e1c619bcf7b22b8d4eb.png)

| Reeskont Listesi Ekranı |  |
| --- | --- |
| Sahalar | Reeskont listesi almak için sıralanması istenen alanlar yer alır. ![](../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "sıralama sahaları" kısmına eklenir. |
| Sıralama Sahaları | Reeskont listesi almak için sıralama yapılacak sahaların yer aldığı alandır. ![](../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
![](../../../../_assets/eba30107851c2f62c36b.png)
...
![](../../../../_assets/01782de1df6b2c060a29.png)
...
| Reeskont Listesi Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| Reeskont Listesi Ekranı | Yazıcı Seçenekleri |
