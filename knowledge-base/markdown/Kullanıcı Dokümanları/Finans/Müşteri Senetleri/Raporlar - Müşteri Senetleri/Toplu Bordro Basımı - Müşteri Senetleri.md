---
title: "Toplu Bordro Basımı / Müşteri Senetleri"
page_id: "24740176"
...
breadcrumb:
  ...
  - "Toplu Bordro Basımı / Müşteri Senetleri"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Finans / Müşteri Senetleri / Raporlar / Müşteri Senetleri / Toplu Bordro Basımı / Müşteri Senetleri"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPTU4NWE1ZjFkLTFjNWItNGVjOS04ZjNkLWQzMWQ4MjNlY2MyNiZsaW5rPWNhZDJlM2YzLWI5MWUtNDMxOC05MGI4LTFjMDEzNjZhNzIwZiZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=585a5f1d-1c5b-4ec9-8f3d-d31d823ecc26&link=cad2e3f3-b91e-4318-90b8-1c01366a720f&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "toplu-bordro-basimi-musteri-senetleri_34218230_24740176.html"
source_version: "2022-12-07T14:07:07.077+03:00"
source_bytes: 544666
fetched_at: "2026-09-13T04:12:10+00:00"
generator: "netsis-scraper 1.0.0"
---
# Toplu Bordro Basımı / Müşteri Senetleri

Müşteri Senetleri Toplu Bordro Basımı, Finans Bölümü'nde, "Raporlar/Müşteri Senetleri" menüsünün altında yer alır. Müşteri Senetleri Toplu Bordro Basımı, kaydedilen alındı/verildi bordrolarının bazı kısıtlar verilerek toplu halde basımının yapıldığı bölümdür. Müşteri Senetleri Toplu Bordro Basımı; Ön Sorgulama, Genel Kısıtlar, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Ön Sorgulama**

![](../../../../_assets/92ad5794ef776a35fdd7.png)

Toplu Bordro Basımı ekranı Ön Sorgulama sekmesinde yer alan alanlar ve içerdiği bilgiler aşağıdaki şekildedir:

| Toplu Bordro Basımı Ekranı |  |
| --- | --- |
| Özel Bordro Basımı | Bordro basımının, hazırlanan dizayna göre basılması için işaretlenen seçenektir. Bu seçeneğin işaretlenmesi ile "Dizayn Sorgulama" ekrana gelir. Bu ekranda alındı/verildi bordroları için hazırlanan dizaynlardan biri seçilerek bordro basımının gerçekleşmesi sağlanır. |
| Bordro Tipi | Basılması istenen bordro tipinin seçildiği alandır. Alanın sağ tarafında yer alan aşağı ok butonu ile seçim yapılır. "Cari Hesap Senet Alındı Kaydı" bölümünden girilen senet bordrolarının basımı yapılacak ise "Alındı Bordrosu", Cari Hesaba, Tahsile veya Teminata çıkılan senet bordrolarının basımı yapılacak ise "Verildi Bordrosu" tipinin seçilmesi gerekir. |
| Bordro Numarası Aralığı | Seçilen bordro tipine göre basımı yapılacak olan bordroların numaralarının girildiği alandır. Bordro numarası aralığı girilmediğinde, seçilen bordro tipine ait tüm bordroların basımı yapılır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, bordro numaraları arasından seçim yapılır. |
| Tarih Aralığı | Toplu bordro basımı için tarih aralığı kısıdı verilen alandır. |
...
| ![](../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Ön Sorgulama ve Genel Kısıt sekmelerinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Toplu bordro basımı için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki bordro basım işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Toplu bordro basımı standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../_assets/973111d004995dca0113.jpg) İptal | Toplu bordro basımı için verilen kısıtların iptal edildiği butondur. |

**Genel Kısıtlar**

![](../../../../_assets/14a649d81f076a0eb5a0.png)

Toplu Bordro Basımı ekranı Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler aşağıdaki şekildedir:

| Toplu Bordro Basımı Ekranı |  |
| --- | --- |
| Kur Farkı Tutara Dahil Edilsin | Toplu bordro basımında, dövizli senetlerde hesaplanan kur farkı tutarının TL tutarına eklenmesi için kullanılan seçenektir. |
| Veren Adı Basılsın | Toplu bordro basımı alırken, senedi veren ismin de basımda yer alması istendiğinde işaretlenmesi gereken seçenektir. |
| 1-2-3 Açıklama | Müşteri Senetleri → Kayıt → [Müşteri Senetleri Parametreleri](<../Kayıt - Müşteri Senetleri/Müşteri Senetleri Parametreleri.md>) → “Bordro Basımında Açıklama Bulunsun” parametresinin işaretlendiği ve "Ön Sorgulama" sekmesinde bulunan “Özel Bordro Basımı” seçeneğinin işaretlenmediği durumlarda aktif olan alandır. Üç adet açıklama sahasına, kullanıcı tarafından istenen bilgilerin bordro ile birlikte basımının yapılması için kullanılır. |
| ![](../../../../_assets/7ba39f9046a578093326.png) Rapor | Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
| ![](../../../../_assets/e3223333470668512f5f.jpg) Oku | Daha önceden saklanan kısıtların aynısının ekrana getirilmesini sağlayan butondur. **Oku** butonu ile sadece "en son saklanan kısıtlar" ekrana getirilir. |
| ![](../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Ön Sorgulama ve Genel Kısıt sekmelerinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Toplu bordro basımı için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki bordro basım işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Toplu bordro basımı standart yardım bilgisi için kullanılan butondur. |
...
![](../../../../_assets/492b88971c1b8cd1100e.png)
...
![](../../../../_assets/9150d93517a957868a9a.png)
...
| Toplu Bordro Basımı Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| Toplu Bordro Basımı Ekranı | Yazıcı Seçenekleri |
...
| ![](../../../../_assets/53859e19eb2737b88a17.jpg) | Ön Sorgulama ve Genel Kısıt sekmelerinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Toplu bordro basımı için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki bordro basım işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) | Toplu bordro basımı standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../_assets/973111d004995dca0113.jpg) | Toplu bordro basımı için verilen kısıtların iptal edildiği butondur. |
