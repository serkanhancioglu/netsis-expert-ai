---
title: "Kullanıcı Bazında Log Analiz Raporu"
page_id: "41169774"
...
breadcrumb:
  ...
  - "Log Modülü"
  - "Raporlar / Log Modülü"
  - "Kullanıcı Bazında Log Analiz Raporu"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Genel / Log Modülü / Raporlar / Log Modülü / Kullanıcı Bazında Log Analiz Raporu"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPTBkNTQ2ZDdkLTFiODgtNDkyYy05Y2U4LTRmM2IzZTEwNGYxNSZsaW5rPWM3ZDk5NWI5LTkyMzQtNDYyYS1hODZmLWIyOThhNzkzYzJlZCZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=0d546d7d-1b88-492c-9ce8-4f3b3e104f15&link=c7d995b9-9234-462a-a86f-b298a793c2ed&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "kullanici-bazinda-log-analiz-raporu_41169790_41169774.html"
source_version: "2022-09-19T08:32:44.807+03:00"
source_bytes: 370510
...
Kullanıcı Bazında Log Analiz Raporu, Genel Bölümü'nde, "Raporlar/Log Modülü" menüsünün altında yer alır. Log Raporu ekranı; Ön Sorgulama, Kısıt, Sıralama, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Ön Sorgulama**

**![](../../../../_assets/9c7c88851eabf6d91501.png)**

Kullanıcı Bazında Log Analiz Raporu Ön Sorgulama sekmesi bilgileri aşağıdaki şekildedir:

| Kullanıcı Bazında Log Analiz Raporu Ekranı |  |
| --- | --- |
| Başlangıç Tarihi | Kullanıcı bazında log analiz raporu için başlangıç tarih kısıdı verilen alandır. Alanın sağ tarafında yer alan aşağı ok butonu ile takvim kullanılarak tarih seçimi yapılabilir. Tarih alanının sağ tarafında yer alan kısım saat belirtmek için kullanılır. |
| Bitiş Tarihi | Kullanıcı bazında log analiz raporu için bitiş tarih kısıdı verilen alandır. Alanın sağ tarafında yer alan aşağı ok butonu ile takvim kullanılarak tarih seçimi yapılabilir. Tarih alanının sağ tarafında yer alan kısım saat belirtmek için kullanılır. |
...
| Tablo Bazında Kırılım | Kullanıcı bazında log analiz raporunun tablo bazında kırılım yapılarak alınması için kullanılan seçenektir. |
...
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) | Kullanıcı bazında log analiz rapor ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../_assets/973111d004995dca0113.jpg) | Kullanıcı bazında log analiz raporu için verilen kısıtların iptal edildiği butondur. |

**Sıralama**

**![](../../../../_assets/c0a4b9d4ed3d7d20b14c.png)**

| Kullanıcı Bazında Log Analiz Raporu Ekranı |  |
| --- | --- |
| Sahalar | Kullanıcı bazında log analiz raporu almak için kısıt verilirken sıralanması istenen alanlar yer alır. ![](../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "sıralama sahaları" kısmına eklenir. |
| Sıralama Sahaları | Kullanıcı bazında log analiz raporu almak için kısıt verilirken sıralama yapılacak sahaların yer aldığı alandır. ![](../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
![](../../../../_assets/b9d4dde214c68609437d.png)
...
**![](../../../../_assets/dd9a2b223e13280acee0.png)**
...
| Kullanıcı Bazında Log Analiz Raporu Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| Kullanıcı Bazında Log Analiz Raporu Ekranı | Yazıcı Seçenekleri |
