...
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Lojistik - Satış / Fatura / Raporlar / Fatura / Masraf Merkezi Raporu"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPTYwZmU1M2M4LWQ2ODMtNDZlMy1hMWJmLWYyNGI1ZmJlZjRjZCZsaW5rPWI3ZDEzMTkyLWRkNjAtNDcxNy1hYmUwLThlNWQ2ODI1NTMxZCZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=60fe53c8-d683-46e3-a1bf-f24b5fbef4cd&link=b7d13192-dd60-4717-abe0-8e5d6825531d&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "masraf-merkezi-raporu_24767931_24767919.html"
source_version: "2022-10-25T13:54:10.107+03:00"
source_bytes: 103650
fetched_at: "2026-09-13T04:03:17+00:00"
generator: "netsis-scraper 1.0.0"
---
# Masraf Merkezi Raporu

Masraf Merkezi Raporu, Fatura → İşlemler → [Masraf Merkezi Tanımlama](<../İşlemler - Fatura/Masraf Merkezi Tanımlama.md>) bölümünden tanımlanan masraf merkezleriyle ilgili liste alınmasını sağlayan rapor seçeneğidir. Masraf Merkezi Raporu ekranı; Genel Kısıtlar, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Genel Kısıtlar**

Masraf Merkezi Raporu ekranı Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Masraf Merkezi Raporu Ekranı |  |
| --- | --- |
| Masraf Kodu | Tanımlanmış masraf kodları arasından ![](../../../../_assets/088477bb321d1b20c939.jpg) rehber butonu yardımıyla tek bir masraf kodu seçilebildiği gibi, alanının boş bırakılması halinde tüm masraf merkezleriyle ilgili rapor alınmasını sağlayan alandır. |
| ![](../../../../_assets/7ba39f9046a578093326.png) Rapor | Masraf merkezi raporu almak için verilen kısıtlara göre Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
...
| ![](../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Ön Sorgulama, Kısıt ve Sıralama sayfalarında verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Masraf merkezi raporu almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki masraf merkezi raporu işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Masraf merkezi raporu ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../_assets/973111d004995dca0113.jpg) İptal | Masraf merkezi raporu almak için verilen kısıtların iptal edildiği butondur. |
...
| Masraf Merkezi Raporu Ekranı | Yazıcı Seçenekleri |
| --- | --- |
...
| Masraf Merkezi Raporu Ekranı | Yazıcı Seçenekleri - Yönlendirme |
