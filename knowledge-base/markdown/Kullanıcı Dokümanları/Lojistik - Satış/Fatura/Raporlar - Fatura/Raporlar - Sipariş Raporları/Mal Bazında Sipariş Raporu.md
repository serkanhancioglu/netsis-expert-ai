---
title: "Mal Bazında Sipariş Raporu"
page_id: "24767559"
...
breadcrumb:
  ...
  - "Mal Bazında Sipariş Raporu"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Lojistik - Satış / Fatura / Raporlar / Fatura / Raporlar / Sipariş Raporları / Mal Bazında Sipariş Raporu"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPTdlNjVkYzQwLWM2ZDgtNGI2NC1iMDZmLWM5MDVjMzUwZWUzMSZsaW5rPWFlNjExMjM1LTI5M2MtNGZmOC05OWY0LWM5NWEyM2ZhOGMzMiZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=7e65dc40-c6d8-4b64-b06f-c905c350ee31&link=ae611235-293c-4ff8-99f4-c95a23fa8c32&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "mal-bazinda-siparis-raporu_24771807_24767559.html"
source_version: "2022-10-25T13:18:33.400+03:00"
source_bytes: 122506
fetched_at: "2026-09-13T04:03:12+00:00"
generator: "netsis-scraper 1.0.0"
---
# Mal Bazında Sipariş Raporu

Mal Bazında Sipariş Raporu, mal bazında, alınan veya verilen tüm siparişlerin dökümlerinin alındığı bölümdür. Mal Bazında Sipariş Raporu ekranı; Genel Kısıtlar, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Genel Kısıtlar**

Mal Bazında Sipariş Raporu ekranı Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Mal Bazında Sipariş Raporu Ekranı |  |
| --- | --- |
| Alınan/Verilen Sipariş | Mal siparişlerinin listelenmesi için "Alınan Sipariş", satıcı siparişlerinin listelenmesi için "Verilen Sipariş" seçeneğinin işaretlenmesi gereken alandır. |
| Stoktan Ayrılan/Bekleyen/Hepsi | Sipariş kayıtları sırasında yapılan işaretlemeye göre; stoktan ayrılan, bekleyen veya tamamı tercihinin yapıldığı alandır. |
...
| Kümüle Döküm | Mal bazında sipariş raporunun kümüle olarak alınması için kullanılan seçenektir. |
| Tipi | Sipariş tipi kısıdının verildiği alandır. Açık, Kapalı ve Hepsi olmak üzere üç seçenekten oluşur. |
| Stok Kodu | Stoka ait başlangıç ve bitiş kodları ![](../../../../../_assets/088477bb321d1b20c939.jpg) rehber butonu yardımıyla seçilerek, mal bazlı rapor alımında siparişlere kısıt verilmesini sağlayan alandır. |
| Özellikler | Siparişe ait özellikler, üç nokta ![](../../../../../_assets/5098b020c5e814c92501.png) butonu ile esnek yapılandırma özellik rehberinden belirlenerek, mal bazında sipariş raporu oluşturmak için kısıt verilmesini sağlar. "İleri seviyede kısıt vermek için burayı kullanabilirsiniz." yazısının üzerine tıklandığında, aşağıdaki ekranda belirtilen alanlar doldurularak detaylı kısıt verilmesi sağlanır. ![](../../../../../_assets/45aa134882ec0f37b2a8.png) |
| ![](../../../../../_assets/7ba39f9046a578093326.png) Rapor | Mal bazında sipariş raporu almak için verilen kısıtlara göre Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
...
| ![](../../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Ön Sorgulama, Kısıt ve Sıralama sayfalarında verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Mal bazında sipariş raporu almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki mal bazlı sipariş raporu işleminde kullanılmak üzere saklanır. |
| ![](../../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Mal bazında sipariş ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../../_assets/973111d004995dca0113.jpg) İptal | Mal bazlı raporu istenen siparişler için verilen kısıtların iptal edildiği butondur. |
...
| Mal Bazında Sipariş Raporu Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| Mal Bazında Sipariş Raporu Ekranı | Yazıcı Seçenekleri |
