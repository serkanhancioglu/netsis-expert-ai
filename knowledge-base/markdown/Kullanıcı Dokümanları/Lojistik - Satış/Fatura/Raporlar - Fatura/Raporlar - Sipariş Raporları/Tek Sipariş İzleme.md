...
breadcrumb:
  ...
  - "Tek Sipariş İzleme"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Lojistik - Satış / Fatura / Raporlar / Fatura / Raporlar / Sipariş Raporları / Tek Sipariş İzleme"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPWRhYTMyMTgyLTllMmQtNDg0Mi1iNDBmLTA1NTk1OWM1MTVmYyZsaW5rPTU1ZThiYzcwLTQ1M2QtNGQzYy04NmIzLTE3YzQwM2NmYzQzNCZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=daa32182-9e2d-4842-b40f-055959c515fc&link=55e8bc70-453d-4d3c-86b3-17c403cfc434&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "tek-siparis-izleme_24767516_24767498.html"
source_version: "2022-10-25T12:27:03.347+03:00"
source_bytes: 121005
fetched_at: "2026-09-13T04:03:11+00:00"
generator: "netsis-scraper 1.0.0"
---
# Tek Sipariş İzleme

Tek Sipariş İzleme, sipariş numarası bazında tek bir müşteri ya da satıcı siparişinin ekrandan izlenmesini sağlayan bölümdür. Tek Sipariş İzleme; Genel Kısıtlar, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Genel Kısıtlar**

Tek Sipariş İzleme ekranı Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Tek Sipariş İzleme Ekranı |  |
| --- | --- |
| Alınan/Verilen Sipariş | Müşteri siparişlerinin listelenmesi için "Alınan Sipariş", satıcı siparişlerinin listelenmesi için "Verilen Sipariş" seçeneğinin işaretlenmesi gereken alandır. |
| Sipariş Numarası | İzlenmesi istenen siparişin, numarasının girildiği alandır. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) yardımıyla sipariş numaraları arasından seçim yapılır. ![](../../../../../_assets/16c9fc77a4e11c96cfee.png) |
| ![](../../../../../_assets/7ba39f9046a578093326.png) Rapor | Sipariş için verilen kısıtlara göre Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
...
| ![](../../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Ön Sorgulama, Kısıt ve Sıralama sayfalarında verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Sipariş izlemek için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki sipariş izleme işleminde kullanılmak üzere saklanır. |
| ![](../../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Sipariş izleme ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../../_assets/973111d004995dca0113.jpg) İptal | İzlenmesi istenen sipariş için verilen kısıtların iptal edildiği butondur. |
...
| Tek Sipariş İzleme Ekranı | Yazıcı Seçenekleri |
| --- | --- |
...
| Tek Sipariş İzleme Ekranı | Yazıcı Seçenekleri - Yönlendirme |
