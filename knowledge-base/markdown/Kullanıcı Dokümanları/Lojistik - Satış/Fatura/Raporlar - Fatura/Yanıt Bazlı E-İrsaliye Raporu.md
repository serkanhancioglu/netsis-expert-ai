---
title: "Yanıt Bazlı E-İrsaliye Raporu"
page_id: "34210360"
...
breadcrumb:
  ...
  - "Fatura"
  - "Raporlar / Fatura"
  - "Yanıt Bazlı E-İrsaliye Raporu"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Lojistik - Satış / Fatura / Raporlar / Fatura / Yanıt Bazlı E-İrsaliye Raporu"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPTE1NTQ5OTBlLTRlMWEtNGU1Yy1hMzUxLTcyNjY5MGEyMWYzZiZsaW5rPTMzMDg5Y2JmLTIxNDMtNDRhMS1hODY3LTYyNjE5MjE2ZDQwZCZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=1554990e-4e1a-4e5c-a351-726690a21f3f&link=33089cbf-2143-44a1-a867-62619216d40d&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "yanit-bazli-e-irsaliye-raporu_34210375_34210360.html"
source_version: "2022-10-25T14:15:29.120+03:00"
source_bytes: 97170
fetched_at: "2026-09-13T04:03:23+00:00"
generator: "netsis-scraper 1.0.0"
---
# Yanıt Bazlı E-İrsaliye Raporu

Yanıt Bazlı E-İrsaliye Raporu ekranı; Kısıt, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Kısıt**

Yanıt Bazlı e-İrsaliye Raporu ekranı Kısıt sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Yanıt Bazlı E-İrsaliye Raporu Ekranı |  |
| --- | --- |
...
| Tarih Aralığı | Yanıt bazlı e-irsaliye raporu almak için başlangıç ve bitiş tarihi verilen alandır. |
| Zarf ID | Yanıt bazlı ticari fatura raporu için Zarf ID girilen alandır. |
| Fatura ID | Yanıt bazlı e-İrsaliye raporu için Fatura ID girilen alandır. |
| Yanıt ID | Yanıt bazlı e-İrsaliye raporu için Yanıt ID girilen alandır. |
| Tipi | Yanıt bazlı e-İrsaliye raporu için fatura tipi girilen alandır. Alanın sağ tarafında yer alan aşağı ok butonu ile seçim yapılır. |
| Durumu | Yanıt bazlı e-İrsaliye raporu için durum bilgisi girilen alandır. Alanın sağ tarafında yer alan aşağı ok butonu ile seçim yapılır. |
| Yanıt ID Raporda Getirilsin | Yanıt bazlı e-İrsaliye raporu için girilen Yanıt ID bilgisinin raporda getirilmesi için kullanılan seçenektir. |
| Sadece Başarılı Durum Kodunda Olmayan Yanıtlar Gelsin | Yanıt bazlı e-İrsaliye raporuna sadece başarılı durum kodunda olmayan yanıtların gelmesi için kullanılan seçenektir. |
| ![](../../../../_assets/7ba39f9046a578093326.png) Rapor | Yanıt bazlı e-irsaliye raporu almak için verilen kısıtlara göre Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
...
| ![](../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Ön Sorgulama, Kısıt ve Sıralama sayfalarında verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Yanıt bazlı e-irsaliye raporu almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki yanıt bazlı e-irsaliye raporu işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Yanıt bazlı e-irsaliye ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../_assets/973111d004995dca0113.jpg) İptal | Yanıt bazlı e-irsaliye raporu için verilen kısıtların iptal edildiği butondur. |
...
| Yanıt Bazlı E-İrsaliye Raporu Ekranı | Yazıcı Seçenekleri-Yönlendirme |
...
| Yanıt Bazlı E-İrsaliye Raporu Ekranı | Yazıcı Seçenekleri |
