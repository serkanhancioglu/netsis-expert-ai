---
title: "Yanıt Bazlı Ticari Fatura Raporu"
page_id: "24768303"
...
breadcrumb:
  ...
  - "Fatura"
  - "Raporlar / Fatura"
  - "Yanıt Bazlı Ticari Fatura Raporu"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Lojistik - Satış / Fatura / Raporlar / Fatura / Yanıt Bazlı Ticari Fatura Raporu"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPWQ0MWE4MWZlLWRmNjYtNGVlMi05Y2U4LTZhZjJiNTg0MzM1NiZsaW5rPTU3NjllZDNkLTQ3OTQtNDJmMy04ZDdhLWRlZmQ4YjhlM2U5ZSZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=d41a81fe-df66-4ee2-9ce8-6af2b5843356&link=5769ed3d-4794-42f3-8d7a-defd8b8e3e9e&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "yanit-bazli-ticari-fatura-raporu_24771833_24768303.html"
source_version: "2022-10-25T14:14:38.967+03:00"
source_bytes: 108507
fetched_at: "2026-09-13T04:03:22+00:00"
generator: "netsis-scraper 1.0.0"
---
# Yanıt Bazlı Ticari Fatura Raporu

Yanıt Bazlı Ticari Fatura Raporu ekranı; Kısıt, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Kısıt**

Yanıt Bazlı Ticari Fatura Raporu ekranı Kısıt sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Yanıt Bazlı Ticari Fatura Raporu Ekranı | Kısıt |
| --- | --- |
| Resmi Belge No | Resmi belgelere ait başlangıç ve bitiş kodlarının ![](../../../../_assets/088477bb321d1b20c939.jpg) rehber butonu yardımı ile seçilerek, yanıt bazlı ticari fatura raporu almak için kısıt verilmesini sağlayan alandır. |
| Tarih Aralığı | Yanıt bazlı ticari fatura raporu almak için başlangıç ve bitiş tarihi verilen alandır. |
| Zarf ID | Yanıt bazlı ticari fatura raporu için Zarf ID girilen alandır. |
| Fatura ID | Yanıt bazlı ticari fatura raporu için Fatura ID girilen alandır. |
| Yanıt ID | Yanıt bazlı ticari fatura raporu için Yanıt ID girilen alandır. |
| Tipi | Yanıt bazlı ticari fatura raporu için fatura tipi girilen alandır. Alanın sağ tarafında yer alan aşağı ok butonu ile seçim yapılır. |
| Durumu | Yanıt bazlı ticari fatura raporu için durum bilgisi girilen alandır. Alanın sağ tarafında yer alan aşağı ok butonu ile seçim yapılır. |
| Yanıt ID Raporda Getirilsin | Yanıt bazlı ticari fatura raporu için girilen Yanıt ID bilgisinin raporda getirilmesi için kullanılan seçenektir. |
| Sadece Başarılı Durum Kodunda Olmayan Yanıtlar Gelsin | Yanıt bazlı ticari fatura raporuna sadece başarılı durum kodunda olmayan yanıtların gelmesi için kullanılan seçenektir. |
| ![](../../../../_assets/7ba39f9046a578093326.png) Rapor | Yanıt bazlı ticari fatura raporu almak için verilen kısıtlara göre Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
...
| ![](../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Ön Sorgulama, Kısıt ve Sıralama sayfalarında verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Yanıt bazlı ticari fatura raporu almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki yanıt bazlı ticari fatura raporu işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Yanıt bazlı ticari fatura ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../_assets/973111d004995dca0113.jpg) İptal | Yanıt bazlı ticari fatura raporu istenen siparişler için verilen kısıtların iptal edildiği butondur. |
...
| Yanıt Bazlı Ticari Fatura Raporu Ekranı | Yazıcı Seçenekleri |
| --- | --- |
...
| Yanıt Bazlı Ticari Fatura Raporu Ekranı | Yazıcı Seçenekleri-Yönlendirme |
