...
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Lojistik - Satış / Stok / Kayıt / Stok / Stok Fiyat İşlemleri / Satış Fiyat Değişikliği"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPWFjZWIxYjk5LWIwNmMtNDc5ZS05Y2NmLWEwMzA1MzQ3YTMwNCZsaW5rPTZiMWE3NTVhLTA2ZTEtNDIxZC04NjVlLTU0Y2UzYThiN2UxYSZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=aceb1b99-b06c-479e-9ccf-a0305347a304&link=6b1a755a-06e1-421d-865e-54ce3a8b7e1a&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "satis-fiyat-degisikligi_29994473_29994463.html"
source_version: "2022-10-25T20:37:43.337+03:00"
source_bytes: 28586
fetched_at: "2026-09-13T04:04:16+00:00"
generator: "netsis-scraper 1.0.0"
---
# Satış Fiyat Değişikliği

Satış Fiyat Değişikliği, Lojistik - Satış Bölümü'nde, "Kayıt/Stok" menüsünün altında yer alır. Satış Fiyat Değişikliği; stoklar için, farklı amaçlı birden fazla alış fiyat listesi tanımlanması amacıyla kullanılan bölümdür. Satış Fiyat Değişikliği; Stok Kısıt Tanımları, Fiyat Seçenekleri ve Fiyat Girişi olmak üzere üç sekmeden oluşur.

**Stok Kısıt Tanımları**

Satış Fiyat Değişikliği ekranı Stok Kısıt Tanımları sekmesi, fiyat listesi hazırlanacak veya mevcut listesinde değişiklik yapılacak stoklar için kısıt verilmesini sağlayan ya da bu stoklar için "Fiyat Girişi" sekmesindeki sıralamanın nasıl yapılacağının belirlenmesi amacıyla kullanılan sekmedir.
...
Stok Kısıt Tanımları sekmesinde girilen kısıtlara uygun stoklar, "Fiyat Girişi" ekranında listelenir.
...
Satış Fiyat Değişikliği ekranı Fiyat Seçenekleri sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Satış Fiyat Değişikliği Ekranı | Fiyat Bilgileri |
| --- | --- |
...
| Satış Fiyat Değişikliği Ekranı | Fiyat Artış Bilgileri |
| Fiyat Artış Oranı | Satış fiyatlarında yapılacak fiyat değişikliği için, artış oranının yüzde olarak girildiği alandır. Eğer var olan listede bir değişiklik yapılacaksa, listedeki fiyat baz alınarak belli oranda artış yapılır. Satış fiyatları hesaplanırken de bu oranda artış yapılır. Bu sekmede bulunan "Fiyat Kodu" alanına kod girilmesi ve girilen fiyat koduna ait tanımlamada fiyat artış oranı belirlenmiş olması halinde, "Fiyat Kodu Tanımlamaları" bölümünde belirlenen artış oranı program tarafından ekrana getirilir. |
...
Fiyat Girişi, fiyat listesi tanımlamak için kullanılan sekmedir. "Stok Kısıt Tanımları" sekmesinde girilen kısıtlara uygun stoklar bu sekmede listelenir.

Satış Fiyat Değişikliği ekranı Fiyat Girişi sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Satış Fiyat Değişikliği Ekranı |  |
| --- | --- |
