---
title: "Detay Kodu Bazında Muhasebe Denetleme"
page_id: "22803857"
...
breadcrumb:
  ...
  - "Ek Listeler"
  - "Denetim Listeleri"
  - "Detay Kodu Bazında Muhasebe Denetleme"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Lojistik - Satış / Stok / Raporlar / Stok / Ek Listeler / Denetim Listeleri / Detay Kodu Bazında Muhasebe Denetleme"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPTI4NTExYzkyLTAyZjQtNGUxZC04MTI3LWUyYTkwMjZkMWVkZiZsaW5rPTU1M2JmZmYyLWNmNjgtNDc0MC1iZmNmLTQ1ZDI5Mjg1ZGRmMyZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=28511c92-02f4-4e1d-8127-e2a9026d1edf&link=553bfff2-cf68-4740-bfcf-45d29285ddf3&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "detay-kodu-bazinda-muhasebe-denetleme_29999806_22803857.html"
source_version: "2022-10-26T15:17:00.817+03:00"
source_bytes: 185891
...
Detay Kodu Bazında Muhasebe Denetleme, Lojistik-Satış Bölümü'nde, "Raporlar/Stok " menüsünün altında yer alır. Detay Kodu Bazında Muhasebe Denetleme, stok detay kodları bazında kümüle olarak verilecek ay kodu ile, stok hareketleri ve muhasebe kayıtlarının karşılaştırılmasını sağlayan bölümdür. Detay kodları bazında muhasebe ile tutan hareketler raporda listelenmez. Tutmayan kayıtlar ise; detay kodu, stok giriş tutarı, muhasebe giriş tutarı, fark, stok çıkış tutarı, muhasebe çıkış tutarı ve fark başlıkları altında listelenir. Detay Kodu Bazında Muhasebe Denetleme; Ön Sorgulama, Genel Kısıtlar, Kısıt, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Ön Sorgulama**

Detay Kodu Bazında Muhasebe Denetleme ekranı Ön Sorgulama sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Detay Kodu Bazında Muhasebe Denetleme Ekranı |  |
| --- | --- |
| Stok Kodu | Detay kodu bazında muhasebe hareketlerini denetlemek için stok kodu kısıdı verilen alandır. Rehber butonu ![](../../../../../../_assets/088477bb321d1b20c939.jpg) ile, stok kodları arasından seçim yapılır. |
| Grup Kodu | Detay kodu bazında muhasebe hareketlerini denetlemek için grup kodu kısıdı verilen alandır. Rehber butonu ![](../../../../../../_assets/088477bb321d1b20c939.jpg) ile grup kodları arasından seçim yapılır. |
| Kod-1/2/3/4/5 | Detay kodu bazında muhasebe hareketlerini denetlemek için önceden tanımlaması yapılan Kod-1/2/3/4/5 kısıdının verildiği alandır. Rehber butonu ![](../../../../../../_assets/088477bb321d1b20c939.jpg) ile kodlar arasından seçim yapılır. |
...
| ![](../../../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Genel Kısıtlar ve Kısıt sayfalarında verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Detay kodu bazında muhasebe hareketlerini denetlemek için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki detay kodu bazında muhasebe hareketlerini denetleme işleminde kullanılmak üzere saklanır. |
| ![](../../../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Detay kodu bazında muhasebe hareketlerini denetleme hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../../../_assets/973111d004995dca0113.jpg) İptal | Detay kodu bazında muhasebe hareketlerini denetlemek için verilen kısıtların iptal edildiği butondur. |

**Genel Kısıtlar**

Detay Kodu Bazında Muhasebe Denetleme ekranı Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Detay Kodu Bazında Muhasebe Denetleme Ekranı |  |
| --- | --- |
| Ay | Rapor alınması istenen ayın girildiği alandır. |
| Şubeler Dahil | Rapora şubelerin dahil edilmesi istendiğinde işaretlenmesi gereken seçenektir. |
| ![](../../../../../../_assets/7ba39f9046a578093326.png) Rapor | Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
| ![](../../../../../../_assets/e3223333470668512f5f.jpg) Oku | Daha önceden saklanan kısıtların aynısının ekrana getirilmesini sağlayan butondur. **Oku** butonu ile sadece "en son saklanan kısıtlar" ekrana getirilir. |
| ![](../../../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Genel Kısıtlar ve Kısıt sayfalarında verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Detay kodu bazında muhasebe hareketlerini denetlemek için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki detay kodu bazında muhasebe hareketlerini denetleme işleminde kullanılmak üzere saklanır. |
| ![](../../../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Detay kodu bazında muhasebe hareketlerini denetleme hakkında standart yardım bilgisi için kullanılan butondur. |
...
| Detay Kodu Bazında Muhasebe Denetleme Ekranı |  |
| --- | --- |
| Sahalar | Detay kodu bazında muhasebe hareketlerini denetlemek için kısıt verilmesi istenen alanlar yer alır. Ekle ![](../../../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "kısıt verilecek sahalar" kısmına eklenir. |
| Kısıt Verilecek Sahalar | Detay kodu bazında muhasebe hareketlerini denetlemek için kısıt verilen sahaların yer aldığı alandır. Çıkar ![](../../../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| Detay Kodu Bazında Muhasebe Denetleme Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| Detay Kodu Bazında Muhasebe Denetleme Ekranı | Yazıcı Seçenekleri |
