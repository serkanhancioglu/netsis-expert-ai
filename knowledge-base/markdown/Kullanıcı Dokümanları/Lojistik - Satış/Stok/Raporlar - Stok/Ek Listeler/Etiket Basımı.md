...
breadcrumb:
  ...
  - "Ek Listeler"
  - "Etiket Basımı"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Lojistik - Satış / Stok / Raporlar / Stok / Ek Listeler / Etiket Basımı"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPThkMjA5NTA5LWRlMTItNDk0NC05MGQyLTljZGZkNzcxYThiZSZsaW5rPWUyOGI2MDlkLTQ0MzktNDM2ZC04NDI5LTMyYzQ3MDUzNTc4MSZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=8d209509-de12-4944-90d2-9cdfd771a8be&link=e28b609d-4439-436d-8429-32c470535781&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "etiket-basimi_29999527_22803871.html"
source_version: "2022-10-26T14:27:31.910+03:00"
source_bytes: 222409
fetched_at: "2026-09-13T04:05:12+00:00"
generator: "netsis-scraper 1.0.0"
---
# Etiket Basımı

Etiket Basımı, Lojistik-Satış Bölümü'nde, "Raporlar/Stok " menüsünün altında yer alır. Etiket Basımı, stoklara ait kod, barkod, ölçü birimi, satış fiyatı ve rapor kodu gibi bilgilerin etikete basılmasını sağlayan bölümdür. Yapılan tercihlere göre hem ekrandan hem de yazıcıdan çıktı alınması sağlanır. Etiket Basımı; Ön Sorgulama, Genel Kısıtlar, Kısıt, Sıralama, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Ön Sorgulama**

Etiket Basımı ekranı Ön Sorgulama sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Etiket Basımı Ekranı |  |
| --- | --- |
| Stok Kodu | Etiket basımı için stok kodu kısıdı verilen alandır. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) ile, stok kodları arasından seçim yapılır. Stok kodu seçilmediğinde, tüm stoklar için etiket basımı yapılır. |
| Grup Kodu | Etiket basımı için grup kodu kısıdı verilen alandır. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) ile grup kodları arasından seçim yapılır. |
| Kod-1/2/3/4/5 | Etiket basımı için önceden tanımlaması yapılan Kod-1/2/3/4/5 kısıdının verildiği alandır. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) ile kodlar arasından seçim yapılır. |
...
Etiket Basımı ekranı Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Etiket Basımı Ekranı |  |
| --- | --- |
| Etiket Tipi (35\*77/35\*97/1\*2/Fiyat(1\*2)) | Etiket tipinin belirlendiği alandır. 1-35 mm x 77 mm, 2-35 mm x 97 mm etiket ebatları parametrelerde tanımlıdır. Seçilen ebatlar baz alınarak basım yapılır. |
| Stok Kodu/Barkod1/Barkod2/Barkod3 | Etiket basımında kod bilgisi olarak basılacak Stok Kodu/Barkod1/Barkod2/Barkod3 seçenekleri arasından tercih yapılan alandır. |
| Ölçü Birimi | Etiket basımında stoka ait ölçü biriminin basımı için kullanılan alandır. |
| Satış Fiyatı | Fiyat bilgisinin basılması halinde, hangi satış fiyatının basılacağı ile ilgili seçim yapılan alandır. |
| Grup Kodu/Kod-1/Kod-2 | Etiket basımı sırasında, stoka ait rapor kodlarından Grup Kodu, kod-1 ya da kod-2 kısıdının verildiği alandır. |
| Kopya Etiket Sayısı | Stoka ait etiket basım miktarının girildiği alandır. |
| Fiyat Basılsın mı? | Stoka ait fiyat bilgisinin basımı için işaretlenmesi gereken seçenektir. |
| Üretici Kodu Basılsın mı? | Stok kartında girilen üretici kodunun stok etiketine basılması için kullanılan seçenektir. |
| ![](../../../../../_assets/7ba39f9046a578093326.png) Rapor | Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
| ![](../../../../../_assets/e3223333470668512f5f.jpg) Oku | Daha önceden saklanan kısıtların aynısının ekrana getirilmesini sağlayan butondur. **Oku** butonu ile sadece "en son saklanan kısıtlar" ekrana getirilir. |
| ![](../../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Genel Kısıtlar ve Kısıt sayfalarında verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Etiket basımı için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki etiket basımı işleminde kullanılmak üzere saklanır. |
| ![](../../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Etiket basımı hakkında standart yardım bilgisi için kullanılan butondur. |
...
| Etiket Basımı Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| Etiket Basımı Ekranı | Yazıcı Seçenekleri |
