---
title: "FIFO Yöntemine Göre Durma Günü Raporu"
page_id: "22803876"
...
breadcrumb:
  ...
  - "Raporlar / Stok"
  - "Ek Listeler"
  - "FIFO Yöntemine Göre Durma Günü Raporu"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Lojistik - Satış / Stok / Raporlar / Stok / Ek Listeler / FIFO Yöntemine Göre Durma Günü Raporu"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPWUxMzlmY2ExLTk5OWUtNDE1Ni05NmRjLWExZmY0NTJjM2JjNSZsaW5rPTUwYjQwZGZiLTUwZmYtNDRlYi1hNzY0LWFkMDM4YTlmMGI0NSZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=e139fca1-999e-4156-96dc-a1ff452c3bc5&link=50b40dfb-50ff-44eb-a764-ad038a9f0b45&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "fifo-yontemine-gore-durma-gunu-raporu_29999392_22803876.html"
source_version: "2022-10-26T14:26:17.620+03:00"
source_bytes: 220428
fetched_at: "2026-09-13T04:05:11+00:00"
generator: "netsis-scraper 1.0.0"
---
# FIFO Yöntemine Göre Durma Günü Raporu

FIFO Yöntemine Göre Durma Günü Raporu, Lojistik-Satış Bölümü'nde, "Raporlar/Stok " menüsünün altında yer alır. FIFO Yöntemine Göre Durma Günü Raporu, ilk giren ilk çıkar mantığına göre stok çıkış miktar ve tarihlerinde, stoktaki durma günlerinin listelenmesini sağlayan rapordur. FIFO Yöntemine Göre Durma Günü Raporu; Ön Sorgulama, Genel Kısıtlar, Kısıt, Sıralama, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

"Ön Sorgulama" sekmesinde belirlenen stok kodlarının, FIFO mantığına göre durma günleri hesaplanır. Bulunan durma günleri, "Ön Sorgulama" sekmesinde yer alan "Durma Günleri Kayıt Edilsin" alanı işaretlendiğinde "Stok Hareket Kayıtları" bölümünde yer alan "Çevrim" alanına aktarılır.

FIFO yöntemine göre durma günü hesaplamasını bir örnek ile açıklamak gerekirse, A malına ait stok hareket kayıtlarının aşağıdaki şekilde olduğu varsayıldığında:

```text
01/01/2001             3 ADET GİRİŞ
```

```text
10/01/2001             5 ADET GİRİŞ
```

```text
01/02/2001             1 ADET ÇIKIŞ
```

```text
02/02/2001             2 ADET ÇIKIŞ
```

```text
05/02/2001             1 ADET ÇIKIŞ
```

Rapor alındığında, A malının çıkış hareketleri için durma günleri aşağıdaki şekilde listelenir.

01/02/2001 1 ADET ÇIKIŞ DURMA GÜNÜ 31

02/02/2001 2 ADET ÇIKIŞ DURMA GÜNÜ 32

05/02/2001 1 ADET ÇIKIŞ DURMA GÜNÜ 26

Program ilk giren ilk çıkar mantığına göre, çıkışları en küçük tarihten düşmeye başlayarak listeler.

**Ön Sorgulama**

FIFO Yöntemine Göre Durma Günü Raporu ekranı Ön Sorgulama sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| FIFO Yöntemine Göre Durma Günü Raporu |  |
| --- | --- |
| Stok Kodu | FIFO yöntemine göre durma günü raporu almak için stok kodu kısıdı verilen alandır. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) ile, stok kodları arasından seçim yapılır. |
| Grup Kodu | FIFO yöntemine göre durma günü raporu almak için grup kodu kısıdı verilen alandır. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) ile grup kodları arasından seçim yapılır. |
| Kod-1/2/3/4/5 | FIFO yöntemine göre durma günü raporu almak için önceden tanımlaması yapılan Kod-1/2/3/4/5 kısıdının verildiği alandır. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) ile kodlar arasından seçim yapılır. |
...
| ![](../../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Genel Kısıtlar ve Kısıt sayfalarında verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. FIFO yöntemine göre durma günü raporu almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki FIFO yöntemine göre durma günü raporu alma işleminde kullanılmak üzere saklanır. |
| ![](../../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | FIFO yöntemine göre durma günü hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../../_assets/973111d004995dca0113.jpg) İptal | FIFO yöntemine göre durma günü raporu almak için verilen kısıtların iptal edildiği butondur. |

**Genel Kısıtlar**

FIFO Yöntemine Göre Durma Günü Raporu ekranı Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| FIFO Yöntemine Göre Durma Günü Raporu |  |
| --- | --- |
| Başlangıç/Bitiş Tarihi | FIFO yöntemine göre durma günü raporu için başlangıç ve bitiş tarih aralığı kısıdının verildiği alandır. |
| Durma Günleri Kaydedilsin | Raporda durma günlerinin kaydedilmesi istendiğinde işaretlenmesi gereken seçenektir. |
| Depolar Arası Transfer Hareketleri Dahil Edilsin | Rapora depolar arası transfer hareketlerinin de dahil edilmesi istendiğinde işaretlenmesi gereken seçenektir. |
| ![](../../../../../_assets/7ba39f9046a578093326.png) Rapor | Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
| ![](../../../../../_assets/e3223333470668512f5f.jpg) Oku | Daha önceden saklanan kısıtların aynısının ekrana getirilmesini sağlayan butondur. **Oku** butonu ile sadece "en son saklanan kısıtlar" ekrana getirilir. |
| ![](../../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Genel Kısıtlar ve Kısıt sayfalarında verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. FIFO yöntemine göre durma günü raporu almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki FIFO yöntemine göre durma günü raporu alma işleminde kullanılmak üzere saklanır. |
| ![](../../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | FIFO yöntemine göre durma günü hakkında standart yardım bilgisi için kullanılan butondur. |
...
| FIFO Yöntemine Göre Durma Günü Raporu |  |
| --- | --- |
| Sahalar | FIFO yöntemine göre durma günü raporu almak için kısıt verilmesi istenen alanlar yer alır. Ekle ![](../../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "kısıt verilecek sahalar" kısmına eklenir. |
| Kısıt Verilecek Sahalar | FIFO yöntemine göre durma günü raporu almak için kısıt verilen sahaların yer aldığı alandır. Çıkar ![](../../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| FIFO Yöntemine Göre Durma Günü Raporu |  |
| --- | --- |
| Sahalar | FIFO yöntemine göre durma günü raporu almak için sıralanması istenen alanlar yer alır. Ekle ![](../../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "sıralama sahaları" kısmına eklenir. |
| Sıralama Sahaları | FIFO yöntemine göre durma günü raporu almak için sıralama yapılacak sahaların yer aldığı alandır. Çıkar ![](../../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| FIFO Yöntemine Göre Durma Günü Raporu | Yazıcı Seçenekleri - Yönlendirme |
...
| FIFO Yöntemine Göre Durma Günü Raporu | Yazıcı Seçenekleri |
