---
title: "Sayım / Bilgisayar Fark Raporu"
page_id: "22803828"
...
breadcrumb:
  ...
  - "Raporlar / Stok"
  - "Ek Listeler"
  - "Sayım / Bilgisayar Fark Raporu"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Lojistik - Satış / Stok / Raporlar / Stok / Ek Listeler / Sayım / Bilgisayar Fark Raporu"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPWFkMTk3MmMwLTFmNGEtNGQ1Ni05OTFiLTlkMGRlMTdiNjlmZCZsaW5rPTY5M2FiYjdjLWI1ODEtNGQyNi1hOGMzLWRiYTdlMTQ4ODkyYiZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=ad1972c0-1f4a-4d56-991b-9d0de17b69fd&link=693abb7c-b581-4d26-a8c3-dba7e148892b&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "sayim-bilgisayar-fark-raporu_29999135_22803828.html"
source_version: "2022-10-26T14:20:04.270+03:00"
source_bytes: 222843
fetched_at: "2026-09-13T04:05:10+00:00"
generator: "netsis-scraper 1.0.0"
---
# Sayım / Bilgisayar Fark Raporu

Sayım/Bilgisayar Fark Raporu, Lojistik-Satış Bölümü'nde, "Raporlar/Stok" menüsünün altında yer alır. Sayım/Bilgisayar Fark Raporu, stok kayıtlarının (lokal depo koduna göre) sayım tarihindeki stok bakiyeleri ile sayım sonuçlarının karşılaştırılmasını sağlayan rapordur. Sayım/Bilgisayar Fark Raporu; Ön Sorgulama, Genel Kısıtlar, Kısıt, Sıralama, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Ön Sorgulama**

Sayım/Bilgisayar Fark Raporu ekranı Ön Sorgulama sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Sayım/Bilgisayar Fark Raporu Ekranı |  |
| --- | --- |
| Stok Kodu | Sayım/Bilgisayar fark raporu almak için stok kodu kısıdı verilen alandır. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) ile, stok kodları arasından seçim yapılır. |
| Grup Kodu | Sayım/Bilgisayar fark raporu almak için grup kodu kısıdı verilen alandır. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) ile grup kodları arasından seçim yapılır. |
...
| Özellikler | Esnek yapılandırma özellik kısıdının verildiği alandır. Alanın sağ tarafında yer alan ![](../../../../../_assets/5098b020c5e814c92501.png) butonu ile, esnek yapılandırma rehberinden seçim yapılır. |
...
| ![](../../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Genel Kısıtlar ve Kısıt sayfalarında verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Sayım/Bilgisayar fark raporu almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki sayım/bilgisayar fark raporu alma işleminde kullanılmak üzere saklanır. |
| ![](../../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Sayım/Bilgisayar fark raporu hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../../_assets/973111d004995dca0113.jpg) İptal | Sayım/Bilgisayar fark raporu almak için verilen kısıtların iptal edildiği butondur. |

**Genel Kısıtlar**

Sayım/Bilgisayar Fark Raporu ekranı Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Sayım/Bilgisayar Fark Raporu Ekranı |  |
| --- | --- |
| Maliyet Tipi | Sayım/Bilgisayar fark raporu için istenen maliyet tipinin seçildiği alandır. 20 çeşit maliyet tipi arasından seçim yapılır. |
| Tarih Aralığı | Stok bakiyesi hesaplanacak stoklar için, hareketlerde kontrol edilecek tarih aralığının girildiği alandır. |
| Depo Kodu Aralığı | Lokal depo kullanan firmalar için, sayım karşılaştırması yapılacak lokal depo kodu aralığının girildiği alandır. |
| Sayım Tarihi | Stok bakiyeleri karşılaştırılacak sayım rakamlarına ait ilgili tarihin girildiği alandır. |
| Cari Kodu | Lokal depolarını cari koda bağlantılı olarak (örneğin satış noktaları bazında) tanımlayan firmalar için kullanılan alandır. |
| Proje Kodu | Proje kodu bazında fark raporu almak için kullanılan alandır. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) ile, proje kodları arasından seçim yapılır. |
| Fark Veren Mallar | Stok bakiyesi ile sayım sonucu tutmayan stokların listelenmesi istendiğinde işaretlenmesi gereken seçenektir. İşaretlenmediğinde, fark veren/vermeyen tüm stoklar listede yer alır. |
| Sayım Yapılmamışlar Dahil | Sayım girişi sırasında sayım bilgisi girilmeyen stokların da listede yer alması istendiğinde işaretlenmesi gereken seçenektir. İşaretlenmediğinde, sayım bilgisi girilmeyen stoklar da listede yer alır. |
| Seri Detay | Raporun seri detaylı olarak alınması için kullanılan seçenektir. |
| Proje Bazında Bakiye Kontrol Edilsin | Proje bazında bakiyenin kontrol edilmesi için kullanılan seçenektir. |
| ![](../../../../../_assets/7ba39f9046a578093326.png) Rapor | Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
| ![](../../../../../_assets/e3223333470668512f5f.jpg) Oku | Daha önceden saklanan kısıtların aynısının ekrana getirilmesini sağlayan butondur. **Oku** butonu ile sadece "en son saklanan kısıtlar" ekrana getirilir. |
| ![](../../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Genel Kısıtlar ve Kısıt sayfalarında verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Sayım/Bilgisayar fark raporu almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki sayım/bilgisayar fark raporu alma işleminde kullanılmak üzere saklanır. |
| ![](../../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Sayım/Bilgisayar fark raporu hakkında standart yardım bilgisi için kullanılan butondur. |
...
| Sayım/Bilgisayar Fark Raporu Ekranı |  |
| --- | --- |
| Sahalar | Sayım/Bilgisayar fark raporu almak için kısıt verilmesi istenen alanlar yer alır. Ekle ![](../../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "kısıt verilecek sahalar" kısmına eklenir. |
| Kısıt Verilecek Sahalar | Sayım/Bilgisayar fark raporu almak için kısıt verilen sahaların yer aldığı alandır. Çıkar ![](../../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| Sayım/Bilgisayar Fark Raporu Ekranı |  |
| --- | --- |
| Sahalar | Sayım/Bilgisayar fark raporu almak için sıralanması istenen alanlar yer alır. Ekle ![](../../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "sıralama sahaları" kısmına eklenir. |
| Sıralama Sahaları | Sayım/Bilgisayar fark raporu almak için sıralama yapılacak sahaların yer aldığı alandır. Çıkar ![](../../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| Sayım/Bilgisayar Fark Raporu Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| Sayım/Bilgisayar Fark Raporu Ekranı | Yazıcı Seçenekleri |
