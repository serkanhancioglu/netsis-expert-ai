---
title: "Tarih Aralığı İcmal Listesi"
page_id: "22803789"
...
breadcrumb:
  ...
  - "Raporlar / Stok"
  - "Ek Listeler"
  - "Tarih Aralığı İcmal Listesi"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Lojistik - Satış / Stok / Raporlar / Stok / Ek Listeler / Tarih Aralığı İcmal Listesi"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPTFmZjU5ZDlkLWUxZDYtNGFjOC05ODQwLTQ1NDMxNTkwMzgxZiZsaW5rPWRhNGZhOWJjLWU2ODctNDgyMi1hNGE2LTM1OGEyNTUyZjAxNiZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=1ff59d9d-e1d6-4ac8-9840-45431590381f&link=da4fa9bc-e687-4822-a4a6-358a2552f016&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "tarih-araligi-icmal-listesi_29998987_22803789.html"
source_version: "2022-10-26T14:07:03.087+03:00"
source_bytes: 218358
fetched_at: "2026-09-13T04:05:07+00:00"
generator: "netsis-scraper 1.0.0"
---
# Tarih Aralığı İcmal Listesi

Tarih Aralığı İcmal Listesi, Lojistik-Satış Bölümü'nde, "Raporlar/Stok" menüsünün altında yer alır. Tarih Aralığı İcmal Listesi, stokların istenen tarih aralığı ve hareket tipinde (örneğin; Devirler, Faturalar, Muhtelif vb.), değişik ölçü birimlerine göre miktar ve tutar bazlı toplamlarının alınmasını sağlayan bölümdür. Her bir stok için tek satırda giriş, çıkış ve bakiye bilgisi verir. Tarih Aralığı İcmal Listesi; Ön Sorgulama, Genel Kısıtlar, Kısıt, Sıralama, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Ön Sorgulama**

Tarih Aralığı İcmal Listesi ekranı Ön Sorgulama sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Tarih Aralığı İcmal Listesi Ekranı |  |
| --- | --- |
| Stok Kodu | İcmal listesi almak için stok kodu kısıdı verilen alandır. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) ile, stok kodları arasından seçim yapılır. |
| Grup Kodu | İcmal listesi almak için grup kodu kısıdı verilen alandır. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) ile grup kodları arasından seçim yapılır. |
| Kod-1/2/3/4/5 | İcmal listesi almak için önceden tanımlaması yapılan Kod-1/2/3/4/5 kısıdının verildiği alandır. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) ile kodlar arasından seçim yapılır. |
...
| ![](../../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Genel Kısıtlar ve Kısıt sayfalarında verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. İcmal listesi almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki icmal listesi alma işleminde kullanılmak üzere saklanır. |
| ![](../../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | İcmal listesi hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../../_assets/973111d004995dca0113.jpg) İptal | İcmal listesi almak için verilen kısıtların iptal edildiği butondur. |

**Genel Kısıtlar**

Tarih Aralığı İcmal Listesi ekranı Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Tarih Aralığı İcmal Listesi Ekranı |  |
| --- | --- |
| Tarih Aralığı | Stoklara ait miktar ve tutar bilgilerinin belirlenen tarih aralığına göre listelenmesini sağlayan alandır. |
| Tip Aralığı | Stoklara ait miktar ve tutar bilgilerinin tespit edilmesi sırasında, sadece belirlenen tipteki hareketlerin dikkate alınması için kullanılan alandır. Alanın sağ tarafında yer alan aşağı ok butonu ile seçenekler arasından tercih yapılır. |
| Ölçü Birimi | Stok kartlarında birden fazla ölçü birimi tanımlanmışsa, lokal depo bakiye listesi için ölçü birimi seçilen alandır. |
| Hareket Görmüş Stoklar | Girilen tarih aralığında, sadece hareket görmüş stokların listeye dahil edilmesi için işaretlenmesi gereken seçenektir. Parametre işaretlenmediğinde, hareket görmemiş stoklar da listeye dahil edilir. |
| Tutar Yazılsın | Miktar bilgisinin dışında, tutarların da raporda yer alması istendiğinde işaretlenmesi gereken seçenektir. |
| Tutarlar Firma Döviz Tipine Göre Basılsın | Girilen tutar bilgisinin, Yardımcı Programlar → Kayıt → [Şirket-Şube Parametre Tanımları](<../../../../Genel/Yardımcı Programlar/Kayıt - Yardımcı Programlar/Şirket - Şube - Parametre Tanımları.md>) bölümünde yer alan "Düzeltme Tipi" alanında işaretlenen döviz tipine göre listelenmesi istendiği durumlarda işaretlenmesi gereken seçenektir. Seçeneğin işaretlenmesi ile, raporda bulunan tutar alanları "TL" olarak değil, "Düzeltme Tipi" alanında belirlenen döviz cinsi üzerinden basılır. Rapor bu şekilde alınmadan önce mutlaka, Stok → İşlemler → [Stok Döviz Çevrim](<../../İşlemler - Stok/Stok Döviz Çevrim.md>) işleminin çalıştırılması gerekir. Aksi halde, tutar alanları 0 (sıfır) olarak listelenir. |
| Eksi Bakiyeliler | Raporda sadece eksi (-) bakiyeli stokların listelenmesi için kullanılan seçenektir. |
| Bakiyesi Sıfırlar Dahil | Girilen tarih aralığında bakiyesi sıfır olan stokların rapora dahil edilmesi için işaretlenmesi gereken seçenektir. Seçenek işaretlenmediğinde, sadece bakiyesi olan stoklar raporda listelenir. |
| Depo Kodu | Depo kodları için aralık belirlenen alandır. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) ile, depo kodları arasından seçim yapılır. Bilgilerin, tüm lokal depolar baz alınarak tespit edilmesi ve listelenmesi istendiğinde alanın boş bırakılması gerekir. |
...
| Tarih Aralığı İcmal Listesi Ekranı |  |
| --- | --- |
| Sahalar | İcmal listesi almak için kısıt verilmesi istenen alanlar yer alır. Ekle ![](../../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "kısıt verilecek sahalar" kısmına eklenir. |
| Kısıt Verilecek Sahalar | İcmal listesi almak için kısıt verilen sahaların yer aldığı alandır. Çıkar ![](../../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| Tarih Aralığı İcmal Listesi Ekranı |  |
| --- | --- |
| Sahalar | İcmal listesi almak için sıralanması istenen alanlar yer alır. Ekle ![](../../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "sıralama sahaları" kısmına eklenir. |
| Sıralama Sahaları | İcmal listesi almak için sıralama yapılacak sahaların yer aldığı alandır. Çıkar ![](../../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| Tarih Aralığı İcmal Listesi Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| Tarih Aralığı İcmal Listesi Ekranı | Yazıcı Seçenekleri |
