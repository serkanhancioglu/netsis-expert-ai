...
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Lojistik - Satış / Stok / Raporlar / Stok / Stok Hareketleri Dökümü"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPTAxY2I4NjM5LWU1ZGQtNDYxZi1hNjhkLTAwOWNjYTA3NDJlMyZsaW5rPTUyOGY5NTQ4LWZkNjMtNDVjZC1hZmE0LWZjZjEzNDUzOGQyMyZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=01cb8639-e5dd-461f-a68d-009cca0742e3&link=528f9548-fd63-45cd-afa4-fcf134538d23&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "stok-hareketleri-dokumu_29998088_22803784.html"
source_version: "2022-10-26T11:24:28.500+03:00"
source_bytes: 471595
fetched_at: "2026-09-13T04:04:57+00:00"
generator: "netsis-scraper 1.0.0"
---
# Stok Hareketleri Dökümü

Stok Hareketleri Dökümü, Lojistik-Satış Bölümü'nde, "Raporlar/Stok " menüsünün altında yer alır. Stok Hareketleri Dökümü, belirlenecek tarih aralığında, istenen ölçü birimine ve lokal depo koduna göre stok hareket dökümlerinin alınmasını sağlayan rapordur. Stok Hareketleri Dökümü; Ön Sorgulama, Genel Kısıtlar, Kısıt, Sıralama, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Ön Sorgulama**

Stok Hareketleri Dökümü ekranı Ön Sorgulama sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Stok Hareketleri Dökümü Ekranı |  |
| --- | --- |
| Stok Kodu | Stok hareket dökümü almak için stok kodu kısıdı verilen alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, stok kodları arasından seçim yapılır. |
| Grup Kodu | Stok hareket dökümü almak için grup kodu kısıdı verilen alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile grup kodları arasından seçim yapılır. |
| Kod-1/2/3/4/5 | Stok hareket dökümü almak için, önceden tanımlaması yapılan Kod-1/2/3/4/5 kısıdının verildiği alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile kodlar arasından seçim yapılır. |
...
| ![](../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Genel Kısıt sekmesinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Stok hareket dökümü almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki stok hareket dökümü alma işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Stok hareket dökümü hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../_assets/973111d004995dca0113.jpg) İptal | Stok hareket dökümü almak için verilen kısıtların iptal edildiği butondur. |

**Genel Kısıtlar**

Stok Hareketleri Dökümü ekranı Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Stok Hareketleri Dökümü Ekranı |  |
| --- | --- |
| Depo Kodu | Belli lokal depo hareketine ait stok hareket dökümü almak için, ilgili lokal depo kodunun girildiği alandır. Depolara ait rapor almak için bu alanın boş bırakılmaması gerekir. Stok → Kayıt → [Stok Parametreleri](<../Kayıt - Stok/Stok Parametreleri.md>) → “Lokal Depo Uygulaması” parametresinin işaretlenmesi ile aktif hale gelir. |
| Tarih Aralığı | Girilen tarih aralığındaki stok hareket kayıtlarının raporda listelenmesini sağlayan alandır. |
| Tip Aralığı | Girilen hareket tip aralığındaki stok hareket kayıtlarının raporda listelenmesini sağlayan alandır. |
| Hariç Tip Aralığı | Raporda listelenmesi istenmeyen tipteki hareketler için başlangıç ve bitiş aralığı verilen alandır. |
| Ölçü Birimi | Stok kartlarında birden fazla ölçü birimi tanımlanmışsa, stok hareket dökümü için ölçü birimi seçilen alandır. |
...
| Tutarlar Firma Döviz Tipine Göre Basılsın | Raporda verilen tutar bilgisinin Yardımcı Programlar → Kayıt → [Şirket - Şube Parametre Tanımları](<../../../Genel/Yardımcı Programlar/Kayıt - Yardımcı Programlar/Şirket - Şube - Parametre Tanımları.md>) bölümünde seçilen döviz tipine göre listelenmesi istendiğinde işaretlenmesi gereken seçenektir. Bu seçenek işaretlendiğinde, raporda bulunan "Tutar" alanları TL üzerinden değil, parametrelerde belirlenen döviz cinsi üzerinden oluşturulur. Rapor alınmadan önce, Stok → İşlemler → [Stok Döviz Çevrim](<../İşlemler - Stok/Stok Döviz Çevrim.md>) işleminin çalıştırılması gerekir. Aksi halde "Tutar" alanları 0 (sıfır) olarak listelenir. |
| Maliyet Fiyatı Baz Alınsın | Raporda listelenen çıkış hareketlerinin, "Maliyet Oluşturma" işlemi ile bulunan maliyet fiyatları yerine hareket sırasında girilen fiyatlar baz alınarak raporlanması istendiğinde işaretlenmesi gereken seçenektir. ![](../../../../_assets/810e5d93baa1bbef8e3e.png) |
| Fiş No Yerine Resmi Belge No Basılsın | Raporda yer alan "Fiş No" alanında, belgede girilen "Resmi Fatura Numarasının" basılması istendiğinde işaretlenmesi gereken seçenektir. |
...
| Proje Kodu Aralığı | Girilen aralıktaki proje koduna sahip olan stok hareketlerinin, proje kodu bazında raporda listelenmesi için kullanılan alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, proje kodları arasından seçim yapılır. |
| ![](../../../../_assets/7ba39f9046a578093326.png) Rapor | Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
| ![](../../../../_assets/e3223333470668512f5f.jpg) Oku | Daha önceden saklanan kısıtların aynısının ekrana getirilmesini sağlayan butondur. **Oku** butonu ile sadece "en son saklanan kısıtlar" ekrana getirilir. |
| ![](../../../../_assets/53859e19eb2737b88a17.jpg)Sakla | Genel Kısıt sekmesinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Stok hareket dökümü almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki stok hareket dökümü alma işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Stok hareket dökümü hakkında standart yardım bilgisi için kullanılan butondur. |
...
| Stok Hareketleri Dökümü Ekranı |  |
| --- | --- |
| Sahalar | Stok hareket dökümü için kısıt verilmesi istenen alanlar yer alır. Ekle ![](../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "kısıt verilecek sahalar" kısmına eklenir. |
| Kısıt Verilecek Sahalar | Stok hareket dökümü için kısıt verilen sahaların yer aldığı alandır. Çıkar ![](../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| Stok hareketleri Dökümü Ekranı |  |
| --- | --- |
| Sahalar | Stok hareket dökümü için sıralanması istenen alanlar yer alır. Ekle ![](../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "sıralama sahaları" kısmına eklenir. |
| Sıralama Sahaları | Stok hareket dökümü için sıralama yapılacak sahaların yer aldığı alandır. Çıkar ![](../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| Stok Hareketleri Dökümü Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| Stok Hareketleri Dökümü Ekranı | Yazıcı Seçenekleri |
