---
title: "İlk Giren İlk Çıkar (FIFO)"
page_id: "22803778"
...
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Lojistik - Satış / Stok / Raporlar / Stok / İlk Giren İlk Çıkar (FIFO)"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPWMwZTU2NjkxLWViOGItNDE1Ni04Zjc1LTY3NjlkZmQ5OGQ3MCZsaW5rPTcyODFiYjNjLTNiZTUtNDdmMC04ZTM1LWE1YWU3N2Y0MWFiOCZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=c0e56691-eb8b-4156-8f75-6769dfd98d70&link=7281bb3c-3be5-47f0-8e35-a5ae77f41ab8&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "ilk-giren-ilk-cikar-fifo_29998668_22803778.html"
source_version: "2022-10-26T12:34:30.393+03:00"
source_bytes: 182916
fetched_at: "2026-09-13T04:05:02+00:00"
generator: "netsis-scraper 1.0.0"
---
# İlk Giren İlk Çıkar (FIFO)

İlk Giren İlk Çıkar (FIFO), Lojistik-Satış Bölümü'nde, "Raporlar/Stok " menüsünün altında yer alır. İlk Giren İlk Çıkar (FIFO), ilk giren ilk çıkar mantığıyla, stok maliyetlerinin ve durma günlerinin istenen tarih aralığında detaylı olarak raporlanmasını sağlayan bölümdür. İlk Giren İlk Çıkar (FIFO); Ön Sorgulama, Genel Kısıtlar, Kısıt, Sıralama, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Ön Sorgulama**

İlk Giren İlk Çıkar (FIFO) ekranı Ön Sorgulama sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| İlk Giren İlk Çıkar (LIFO) Ekranı |  |
| --- | --- |
| Stok Kodu | İlk giren ilk çıkar (LIFO) mantığı ile stok hareket raporu almak için stok kodu kısıdı verilen alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, stok kodları arasından seçim yapılır. |
| Grup Kodu | İlk giren ilk çıkar (LIFO) mantığı ile stok hareket raporu almak için grup kodu kısıdı verilen alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile grup kodları arasından seçim yapılır. |
| Kod-1/2/3/4/5 | İlk giren ilk çıkar (LIFO) mantığı ile stok hareket raporu almak için, önceden tanımlaması yapılan Kod-1/2/3/4/5 kısıdının verildiği alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile kodlar arasından seçim yapılır. |
...
| ![](../../../../_assets/e3223333470668512f5f.jpg) Oku | Daha önceden saklanan kısıtların aynısının ekrana getirilmesini sağlayan butondur. **Oku** butonu ile sadece "en İlk saklanan kısıtlar" ekrana getirilir. |
| ![](../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Genel Kısıtlar ve Kısıt sayfalarında verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. İlk giren ilk çıkar (LIFO) mantığı ile stok hareket raporu almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki stok hareket işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | İlk giren ilk çıkar (LIFO) mantığı ile stok hareket raporu alma hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../_assets/973111d004995dca0113.jpg) İptal | İlk giren ilk çıkar (LIFO) mantığı ile stok hareket raporu almak için verilen kısıtların iptal edildiği butondur. |

**Genel Kısıtlar**

İlk Giren İlk Çıkar (FIFO) ekranı Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| İlk Giren İlk Çıkar (LIFO) Ekranı |  |
| --- | --- |
| Tarih Aralığı | Girilen tarih aralığındaki stok hareketlerinin raporda listelenmesini sağlayan alandır. Girilen tarih aralığının dışında kalan stok hareketleri rapora dahil edilmez. |
| Baz Tarihi | İlk giren ilk çıkar mantığı ile stok hareket raporu alırken baz alınacak tarihin girildiği alandır. |
| Ölçü Birimi | Stok kartında birden fazla ölçü birimi tanımlı stoklar için, raporda bulunan miktar bilgilerinin birinci ölçü birimi dışında farklı bir ölçü birimine göre döküm alınmasını sağlayan alandır. |
| EK Maliyet Dağıtım Uygulaması Kullanılsın | Ek Maliyet Dağıtım Uygulamasının yapılması için kullanılan alandır. |
| ![](../../../../_assets/7ba39f9046a578093326.png) Rapor | Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
| ![](../../../../_assets/e3223333470668512f5f.jpg) Oku | Daha önceden saklanan kısıtların aynısının ekrana getirilmesini sağlayan butondur. **Oku** butonu ile sadece "en İlk saklanan kısıtlar" ekrana getirilir. |
| ![](../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Genel Kısıt sekmesinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. İlk giren ilk çıkar mantığı ile stok hareket raporu almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki İlk giren ilk çıkar mantığı ile stok hareket raporu alma işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | İlk giren ilk çıkar mantığı ile stok hareket raporu hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../_assets/973111d004995dca0113.jpg) İptal | İlk giren ilk çıkar mantığı ile stok hareket raporu almak için verilen kısıtların iptal edildiği butondur. |
...
| İlk Giren İlk Çıkar (LIFO) Ekranı |  |
| --- | --- |
| Sahalar | İlk giren ilk çıkar mantığı ile stok hareket raporu almak için sıralanması istenen alanlar yer alır. Ekle ![](../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "sıralama sahaları" kısmına eklenir. |
| Sıralama Sahaları | İlk giren ilk çıkar mantığı ile stok hareket raporu almak için sıralama yapılacak sahaların yer aldığı alandır. Çıkar ![](../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| İlk Giren İlk Çıkar (LIFO) Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| İlk Giren İlk Çıkar (LIFO) Ekranı | Yazıcı Seçenekleri |
...
| Perfore Satır Sayısı | Yazıcıya gönderilecek raporun kaç satırlık kağıda basılacağının belirlendiği alandır. 33’lük ya da 66’lık olabilir. Rapor yazıcıya dökülürken kaç satırdan İlkra yeni kağıda geçileceği buradaki tanımlamaya göre belirlenir. Standart olarak 66 seçeneği ekrana gelir fakat kullanıcı isterse değişiklik yapabilir. |
| Yazıcı Ayarı Yapılsın | Seçenek işaretlendiğinde, Windows’un “Yazıcı Ayarları” ekrana gelir. Bu ekranda, tanımlı olan yazıcılar arasından seçim yapılır. Rapor ekrandan alındıktan İlkra yazıcıya gönderildiği zaman, tanımlanmış olan yazıcı ayarlarına göre basım yapılır. |
...
| HTML Dosya Adı | Ekran ya da yazıcıdan alınacak raporun diske "Html" formatında bir dosya halinde atılması istendiğinde işaretlenmesi gereken seçenektir. Bu alanda dosyanın hangi dizinde ve hangi isimle oluşturulacağının belirtilmesi gerekir. Bu bölümden Excel, Text veya Html formatında oluşturulacak dosyanın doğru ve eksiksiz oluşturulması için tanımlamalar yapıldıktan İlkra, raporun tamamının yazıcı ya da ekrandan alınması gerekir. |
