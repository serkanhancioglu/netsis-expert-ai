---
title: "Mal Bazında Talep Raporu"
page_id: "22803627"
...
breadcrumb:
  ...
  - "Mal Bazında Talep Raporu"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Lojistik - Satış / Talep - Teklif / Raporlar / Talep-Teklif / Mal Bazında Talep Raporu"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPTI3MzAyN2ZhLTdkMzEtNDVhYS1hYzAwLTUxMGUwOTJkNDE5OSZsaW5rPTllZDY3ZWNkLTIxMWEtNDJlOS04ZWY2LWMyZmZlYmU2ZWQ5MyZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=273027fa-7d31-45aa-ac00-510e092d4199&link=9ed67ecd-211a-42e9-8ef6-c2ffebe6ed93&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "mal-bazinda-talep-raporu_41163554_22803627.html"
source_version: "2022-10-27T11:43:03.767+03:00"
source_bytes: 241596
...
Mal Bazında Talep Raporu, Lojistik - Satış Bölümü'nde, "Raporlar/Talep Teklif" menüsünün altında yer alır. Mal Bazında Talep Raporu, girilen Satınalma ya da Satış Talep kayıtlarının stok detaylı olarak listelenmesini sağlayan rapordur. "Ön Sorgulama" sekmesindeki "Stok Kodu Aralığı" alnına kısıt verilerek, sadece ilgili stokların geçtiği talep kayıtları listelenebilir.

Mal Bazında Talep Raporu ekranı; Ön Sorgulama, Genel Kısıtlar, Kısıt, Sıralama, Ölçekleme ve Yazıcı Seçenekleri sekmesinden oluşur.

**Ön Sorgulama**

Mal Bazında Talep Raporu ekranı Ön Sorgulama sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Mal Bazında Talep Raporu Ekranı |  |
| --- | --- |
| Belge Tipi | Mal bazında talep raporu almak için belge tipi kısıdı verilen alandır. Alanın sağ tarafında yer alan aşağı ok butonu ile, Satınalma Talep veya Satış Talep tipleri arasından seçim yapılır. |
| Tipi | Mal bazında talep raporu almak için talep tipi kısıdının verildiği alandır. Alanın sağ tarafında yer alan aşağı ok butonu ile; Açık, Kapalı, Onaysız veya Hepsi seçenekleri arasından seçim yapılır. |
| Belge No Aralığı | Mal bazında talep raporu almak için başlangıç ve bitiş belge numarası aralığı kısıdı verilen alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, belge numaraları arasından seçim yapılır. |
| Tarih Aralığı | Mal bazında talep raporu almak için başlangıç ve bitiş tarih aralığı kısıdı verilen alandır. |
| Cari Kodu Aralığı | Mal bazında talep raporu almak için başlangıç ve bitiş cari kod aralığı kısıdı verilen alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, cari kodlar arasından seçim yapılır. |
| Kullanıcı Seçim | Mal bazında talep raporu almak için kullanıcı seçim kısıdının verildiği alandır. Alanın sağ tarafında yer alan aşağı ok butonu ile Tüm Kullanıcılar, Grup, Kullanıcı ve Hepsi seçenekleri arasından seçim yapılır. |
...
| ![](../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Ön Sorgulama ve Genel Kısıtlar sekmesinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Mal bazında talep raporu almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki mal bazında talep raporu işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Mal bazında talep raporu almak için standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../_assets/973111d004995dca0113.jpg) İptal | Mal bazında talep raporu almak için verilen kısıtların iptal edildiği butondur. |

**Genel Kısıtlar**

Mal Bazında Talep Raporu ekranı Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Mal Bazında Talep Raporu Ekranı |  |
| --- | --- |
| Şubeler Dahil Mi? | Mal bazında talep raporuna şubelerin dahil edilmesi için kullanılan seçenektir. |
| Döviz Bilgisi Basılsın | Mal bazında talep raporuna döviz bilgisinin basılması için kullanılan seçenektir |
| Fark Verenler Dökülsün | Mal bazında talep raporunda fark verenlerin listelenmesi için kullanılan seçenektir. |
| Sıralama | Mal bazında talep raporu listelenirken baz alınacak sıralamanın seçildiği alandır. Vade Tarihi, Teslim Tarihi ve Net Fiyat olarak üç seçenekten oluşur. |
| ![](../../../../_assets/7ba39f9046a578093326.png) Rapor | Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
| ![](../../../../_assets/e3223333470668512f5f.jpg) Oku | Daha önceden saklanan kısıtların aynısının ekrana getirilmesini sağlayan butondur. **Oku** butonu ile sadece "en son saklanan kısıtlar" ekrana getirilir. |
| ![](../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Ön Sorgulama ve Genel Kısıtlar sekmesinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Mal bazında talep raporu almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki mal bazında talep raporu işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Mal bazında talep raporu almak için standart yardım bilgisi için kullanılan butondur. |
...
| Mal Bazında Talep Raporu Ekranı |  |
| --- | --- |
| Sahalar | Mal bazında talep raporu almak için kısıt verilmesi istenen alanlar yer alır. Ekle ![](../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "kısıt verilecek sahalar" kısmına eklenir. |
| Kısıt Verilecek Sahalar | Mal bazında talep raporu almak için kısıt verilen sahaların yer aldığı alandır. Çıkar ![](../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| Mal Bazında Talep Raporu Ekranı |  |
| --- | --- |
| Sahalar | Mal bazında talep raporu almak için sıralanması istenen alanlar yer alır. Ekle ![](../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "sıralama sahaları" kısmına eklenir. |
| Sıralama Sahaları | Mal bazında talep raporu almak için sıralama yapılacak sahaların yer aldığı alandır. Çıkar ![](../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| Mal Bazında Talep Raporu Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| Mal Bazında Talep Raporu Ekranı | Yazıcı Seçenekleri |
