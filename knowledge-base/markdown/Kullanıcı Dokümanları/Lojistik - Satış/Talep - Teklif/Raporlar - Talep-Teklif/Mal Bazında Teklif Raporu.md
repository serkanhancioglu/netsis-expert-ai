---
title: "Mal Bazında Teklif Raporu"
page_id: "22803629"
...
breadcrumb:
  ...
  - "Mal Bazında Teklif Raporu"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Lojistik - Satış / Talep - Teklif / Raporlar / Talep-Teklif / Mal Bazında Teklif Raporu"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPThlYWU3YzVlLWU3MGEtNDY3YS1hYzQxLTk2ZWEwZTc2NTVhYSZsaW5rPWI4MzIwMGI4LTEwNTMtNGVmYi1iNThmLTE2NGMxYzgyYWEzZiZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=8eae7c5e-e70a-467a-ac41-96ea0e7655aa&link=b83200b8-1053-4efb-b58f-164c1c82aa3f&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "mal-bazinda-teklif-raporu_41163584_22803629.html"
source_version: "2022-10-27T11:44:06.163+03:00"
source_bytes: 247647
fetched_at: "2026-09-13T04:03:47+00:00"
generator: "netsis-scraper 1.0.0"
---
# Mal Bazında Teklif Raporu

Mal Bazında Teklif Raporu, Lojistik - Satış Bölümü'nde, "Raporlar/Talep Teklif" menüsünün altında yer alır.

Mal Bazında Teklif Raporu, girilen Satınalma ya da Satış Teklif kayıtlarının stok detaylı olarak listelenmesini sağlayan rapordur. "Ön Sorgulama" sekmesindeki "Stok Kodu Aralığı" alnına kısıt verilerek, sadece ilgili stokların geçtiği teklif kayıtları listelenebilir.

Mal Bazında Teklif Raporu ekranı; Ön Sorgulama, Genel Kısıtlar, Kısıt, Sıralama, Ölçekleme ve Yazıcı Seçenekleri sekmesinden oluşur.

**Ön Sorgulama**

Mal Bazında Teklif Raporu ekranı Ön Sorgulama sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Mal Bazında Teklif Raporu Ekranı |  |
| --- | --- |
| Belge Tipi | Mal bazında teklif raporu almak için belge tipi kısıdı verilen alandır. Alanın sağ tarafında yer alan aşağı ok butonu ile, Satınalma Talep veya Satış Talep tipleri arasından seçim yapılır. |
| Tipi | Mal bazında teklif raporu almak için talep tipi kısıdının verildiği alandır. Alanın sağ tarafında yer alan aşağı ok butonu ile; Açık, Kapalı, Onaysız veya Hepsi seçenekleri arasından seçim yapılır. |
| Belge No Aralığı | Mal bazında teklif raporu almak için başlangıç ve bitiş belge numarası aralığı kısıdı verilen alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, belge numaraları arasından seçim yapılır. |
| Tarih Aralığı | Mal bazında teklif raporu almak için başlangıç ve bitiş tarih aralığı kısıdı verilen alandır. |
| Cari Kodu Aralığı | Mal bazında teklif raporu almak için başlangıç ve bitiş cari kod aralığı kısıdı verilen alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, cari kodlar arasından seçim yapılır. |
| Kullanıcı Seçim | Mal bazında teklif raporu almak için kullanıcı seçim kısıdının verildiği alandır. Alanın sağ tarafında yer alan aşağı ok butonu ile Tüm Kullanıcılar, Grup, Kullanıcı ve Hepsi seçenekleri arasından seçim yapılır. |
...
| Proje Kodu | Mal bazında teklif raporu almak için proje kodu kısıdı verilen alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, proje kodları arasından seçim yapılır. Proje Uygulaması için Yardımcı Programlar → Kayıt → Şirket-Şube Parametreleri → "Proje Uygulaması Var" parametresinin işaretlenmesi gerekir. |
...
| ![](../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Ön Sorgulama ve Genel Kısıtlar sekmesinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Mal bazında teklif raporu almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki mal bazında teklif raporu işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Mal bazında teklif raporu almak için standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../_assets/973111d004995dca0113.jpg) İptal | Mal bazında teklif raporu almak için verilen kısıtların iptal edildiği butondur. |
...
| Mal Bazında Teklif Raporu Ekranı |  |
| --- | --- |
| Şubeler Dahil Mi? | Mal bazında teklif raporuna şubelerin dahil edilmesi için kullanılan seçenektir. |
| Döviz Bilgisi Basılsın | Mal bazında teklif raporuna döviz bilgisinin basılması için kullanılan seçenektir |
| Fark Verenler Dökülsün | Mal bazında teklif raporunda fark verenlerin listelenmesi için kullanılan seçenektir. |
| Sıralama | Mal bazında teklif raporu listelenirken baz alınacak sıralamanın seçildiği alandır. Vade Tarihi, Teslim Tarihi ve Net Fiyat olarak üç seçenekten oluşur. |
| ![](../../../../_assets/7ba39f9046a578093326.png) Rapor | Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
| ![](../../../../_assets/e3223333470668512f5f.jpg) Oku | Daha önceden saklanan kısıtların aynısının ekrana getirilmesini sağlayan butondur. **Oku** butonu ile sadece "en son saklanan kısıtlar" ekrana getirilir. |
| ![](../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Ön Sorgulama ve Genel Kısıtlar sekmesinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Mal bazında teklif raporu almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki mal bazında teklif raporu işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Mal bazında teklif raporu almak için standart yardım bilgisi için kullanılan butondur. |
...
| Mal Bazında Teklif Raporu Ekranı |  |
| --- | --- |
| Sahalar | Mal bazında teklif raporu almak için kısıt verilmesi istenen alanlar yer alır. Ekle ![](../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "kısıt verilecek sahalar" kısmına eklenir. |
| Kısıt Verilecek Sahalar | Mal bazında teklif raporu almak için kısıt verilen sahaların yer aldığı alandır. Çıkar ![](../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| Mal Bazında Teklif Raporu Ekranı |  |
| --- | --- |
| Sahalar | Mal bazında teklif raporu almak için sıralanması istenen alanlar yer alır. Ekle ![](../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "sıralama sahaları" kısmına eklenir. |
| Sıralama Sahaları | Mal bazında teklif raporu almak için sıralama yapılacak sahaların yer aldığı alandır. Çıkar ![](../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| Mal Bazında Teklif Raporu Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| Mal Bazında Teklif Raporu Ekranı | Yazıcı Seçenekleri |
