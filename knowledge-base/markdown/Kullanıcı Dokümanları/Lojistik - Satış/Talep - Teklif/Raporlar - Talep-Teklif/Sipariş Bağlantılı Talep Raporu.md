---
title: "Sipariş Bağlantılı Talep Raporu"
page_id: "22803620"
...
breadcrumb:
  ...
  - "Sipariş Bağlantılı Talep Raporu"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Lojistik - Satış / Talep - Teklif / Raporlar / Talep-Teklif / Sipariş Bağlantılı Talep Raporu"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPTVmOTIzZDVhLTA2NjEtNDIwOS1hZmNkLTk3ZjQxOTZkZmRjOSZsaW5rPWEwM2M3ODY0LTQzMGEtNDY2Zi1hY2E3LTc4MmFjYzhjY2Q1MiZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=5f923d5a-0661-4209-afcd-97f4196dfdc9&link=a03c7864-430a-466f-aca7-782acc8ccd52&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "siparis-baglantili-talep-raporu_41163648_22803620.html"
source_version: "2022-10-27T11:46:41.740+03:00"
source_bytes: 248351
fetched_at: "2026-09-13T04:03:49+00:00"
generator: "netsis-scraper 1.0.0"
---
# Sipariş Bağlantılı Talep Raporu

Sipariş Bağlantılı Talep Raporu, Lojistik - Satış Bölümü'nde, "Raporlar/Talep Teklif" menüsünün altında yer alır. Sipariş Bağlantılı Talep Raporu, girilen Satınalma ya da Satış Talep kayıtlarının sipariş bağlantıları ile listelenmesini sağlayan rapordur. Rapor; Stok Kodu, Stok İsmi, Talep Eden, Talep No, Talep Tarihi, Cari Kodu, Cari İsmi, Sipariş No, Sipariş Tarihi, Talep Miktarı, Talep Tutarı, Sipariş Miktarı, Sipariş Tutarı, Bakiye Miktarı, Bakiye Tutarı başlıkları ile listelenir.

Sipariş Bağlantılı Talep Raporu ekranı; Ön Sorgulama, Genel Kısıtlar, Kısıt, Sıralama, Ölçekleme ve Yazıcı Seçenekleri sekmesinden oluşur.

**Ön Sorgulama**

Sipariş Bağlantılı Talep Raporu ekranı Ön Sorgulama sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Sipariş Bağlantılı Talep Raporu Ekranı |  |
| --- | --- |
| Belge Tipi | Sipariş bağlantılı talep raporu almak için belge tipi kısıdı verilen alandır. Alanın sağ tarafında yer alan aşağı ok butonu ile, Satınalma Talep veya Satış Talep tipleri arasından seçim yapılır. |
| Tipi | Sipariş bağlantılı talep raporu almak için talep tipi kısıdının verildiği alandır. Alanın sağ tarafında yer alan aşağı ok butonu ile; Açık, Kapalı, Onaysız veya Hepsi seçenekleri arasından seçim yapılır. |
| Belge No Aralığı | Sipariş bağlantılı talep raporu almak için başlangıç ve bitiş belge numarası aralığı kısıdı verilen alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, belge numaraları arasından seçim yapılır. |
| Tarih Aralığı | Sipariş bağlantılı talep raporu almak için başlangıç ve bitiş tarih aralığı kısıdı verilen alandır. |
| Cari Kodu Aralığı | Sipariş bağlantılı talep raporu almak için başlangıç ve bitiş cari kod aralığı kısıdı verilen alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, cari kodlar arasından seçim yapılır. |
| Kullanıcı Seçim | Sipariş bağlantılı talep raporu almak için kullanıcı seçim kısıdının verildiği alandır. Alanın sağ tarafında yer alan aşağı ok butonu ile Tüm Kullanıcılar, Grup, Kullanıcı ve Hepsi seçenekleri arasından seçim yapılır. |
| Kullanıcı No | "Kullanıcı Seçim" alanında "Kullanıcı" seçeneğinin seçilmesi ile aktif hale gelen alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, kullanıcı numaraları arasından seçim yapılarak kısıt verilmesi sağlanır. |
| Grup Kodu | "Kullanıcı Seçim" alanında "Grup" seçeneğinin seçilmesi ile aktif hale gelen alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, grup kodları arasından seçim yapılarak kısıt verilmesi sağlanır. |
| Proje Kodu | Sipariş bağlantılı talep raporu almak için proje kodu kısıdı verilen alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, proje kodları arasından seçim yapılır. Proje Uygulaması için Yardımcı Programlar → Kayıt → [Şirket-Şube Parametreleri](<../../../Muhasebe/Muhasebe Modülü/Ekler - Muhasebe/Ek-1 Enflasyon Muhasebesi/Genel Tanımlar/Yardımcı Programlar-Şirket-Şube Parametreleri.md>) → "Proje Uygulaması Var" parametresinin işaretlenmesi gerekir. |
...
| ![](../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Ön Sorgulama ve Genel Kısıtlar sekmesinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Sipariş bağlantılı talep raporu almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki sipariş bağlantılı talep raporu işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Sipariş bağlantılı talep raporu almak için standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../_assets/973111d004995dca0113.jpg) İptal | Sipariş bağlantılı talep raporu almak için verilen kısıtların iptal edildiği butondur. |

**Genel Kısıtlar**

Sipariş Bağlantılı Talep Raporu Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Sipariş Bağlantılı Talep Raporu Ekranı |  |
| --- | --- |
| Şubeler Dahil Mi? | Sipariş bağlantılı talep raporuna şubelerin dahil edilmesi için kullanılan seçenektir. |
| Döviz Bilgisi Basılsın | Sipariş bağlantılı talep raporuna döviz bilgisinin basılması için kullanılan seçenektir |
| Fark Verenler Dökülsün | Sipariş bağlantılı talep raporunda fark verenlerin listelenmesi için kullanılan seçenektir. |
| Teklif Alınmamış Talepleri Getir | Sipariş bağlantılı talep raporunda teklif alınmamış taleplerin de listelenmesi için kullanılan seçenektir. |
| ![](../../../../_assets/7ba39f9046a578093326.png) Rapor | Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
| ![](../../../../_assets/e3223333470668512f5f.jpg) Oku | Daha önceden saklanan kısıtların aynısının ekrana getirilmesini sağlayan butondur. **Oku** butonu ile sadece "en son saklanan kısıtlar" ekrana getirilir. |
| ![](../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Ön Sorgulama ve Genel Kısıtlar sekmesinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Sipariş bağlantılı talep raporu almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki sipariş bağlantılı talep raporu işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Sipariş bağlantılı talep raporu almak için standart yardım bilgisi için kullanılan butondur. |
...
| Sipariş Bağlantılı Talep Raporu Ekranı |  |
| --- | --- |
| Sahalar | Sipariş bağlantılı talep raporu almak için kısıt verilmesi istenen alanlar yer alır. Ekle ![](../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "kısıt verilecek sahalar" kısmına eklenir. |
| Kısıt Verilecek Sahalar | Sipariş bağlantılı talep raporu almak için kısıt verilen sahaların yer aldığı alandır. Çıkar ![](../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| Sipariş Bağlantılı Talep Raporu Ekranı |  |
| --- | --- |
| Sahalar | Sipariş bağlantılı talep raporu almak için sıralanması istenen alanlar yer alır. ![](../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "sıralama sahaları" kısmına eklenir. |
| Sıralama Sahaları | Sipariş bağlantılı talep raporu almak için sıralama yapılacak sahaların yer aldığı alandır. ![](../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| Sipariş Bağlantılı Talep Raporu Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| Sipariş Bağlantılı Talep Raporu Ekranı | Yazıcı Seçenekleri |
