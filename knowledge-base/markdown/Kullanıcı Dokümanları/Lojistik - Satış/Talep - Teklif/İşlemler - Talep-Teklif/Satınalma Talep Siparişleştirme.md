---
title: "Satınalma Talep Siparişleştirme"
page_id: "22803495"
...
breadcrumb:
  ...
  - "Satınalma Talep Siparişleştirme"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Lojistik - Satış / Talep - Teklif / İşlemler / Talep-Teklif / Satınalma Talep Siparişleştirme"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPTcwZDE1NDM3LWU0NmYtNDYxMy1iZWUzLWM1NGFiYTYwNTVlYiZsaW5rPTkwODAyZTVkLWYzZDUtNGZmYS1iNjBmLTBkNjIzOGQyZmJiMiZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=70d15437-e46f-4613-bee3-c54aba6055eb&link=90802e5d-f3d5-4ffa-b60f-0d6238d2fbb2&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "satinalma-talep-siparislestirme_41163194_22803495.html"
source_version: "2022-10-27T11:20:04.730+03:00"
source_bytes: 61278
...
Satınalma Talep Siparişleştirme, girilen satınalma talep kayıtlarına bağlı "Sipariş" oluşturulması için kullanılan işlemdir. Satınalma Talep Siparişleştirme, Lojistik - Satış Bölümünde, "İşlemler/Talep-Teklif" menüsünün altında yer alır. Satınalma Talep Siparişleştirme; Ön Sorgulama, Kısıt, Sıralama, Ölçekleme, Bilgi Gösterim ve Oluşacak Belge sekmesinden oluşur.

**Ön Sorgulama**

Satınalma Talep Siparişleştirme ekranı Ön Sorgulama sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Satınalma Talep Siparişleştirme Ekranı |  |
| --- | --- |
...
| Sakla | Ön Sorgulama sekmesinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Satınalma talebini sipariş haline getirmek için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki "Satınalma Talep Siparişleştirme" işleminde kullanılmak üzere saklanır. |
| Yardım | Satınalma Talep Siparişleştirme hakkında standart yardım bilgisi için kullanılan butondur. |
| İptal | Sipariş kaydı oluşturulacak talep kayıtları için verilen kısıtların iptal edildiği butondur. |
...
| Satınalma Talep Siparişleştirme Ekranı |  |
| --- | --- |
| Sahalar | Satınalma Talep Siparişleştirme için kısıt verilmesi istenen alanlar yer alır. Ekle butonu ile istenen alanlar "kısıt verilecek sahalar" kısmına eklenir. |
| Kısıt Verilecek Sahalar | Satınalma Talep Siparişleştirme için kısıt verilen sahaların yer aldığı alandır. Çıkar butonu ile istenmeyen alanlar çıkarılır. |
...
| Satınalma Talep Siparişleştirme Ekranı |  |
| --- | --- |
| Sahalar | Satınalma Talep Siparişleştirme için sıralanması istenen alanlar yer alır. Ekle butonu ile istenen alanlar "sıralama sahaları" kısmına eklenir. |
| Sıralama Sahaları | Satınalma Talep Siparişleştirme için sıralama yapılacak sahaların yer aldığı alandır. Çıkar butonu ile istenmeyen alanlar çıkarılır. |
...
| Satınalma Talep Siparişleştirme Ekranı |  |
| --- | --- |
| Tamam | Seçilen talep kaydının sipariş haline getirilmesi için kullanılan butondur. Butona basılması ile gelen ekran onaylanarak işlem gerçekleştirilir. Sipariş haline getirilen kayıtlar, program tarafından otomatik aktarılan Excel tablosunda listelenir. |
| Oku | Daha önceden saklanan kısıtların aynısının ekrana getirilmesini sağlayan butondur. **Oku** butonu ile sadece "en son saklanan kısıtlar" ekrana getirilir. |
| Sakla | Ön Sorgulama sekmesinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Satınalma talebini sipariş haline getirmek için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki "Satınalma Talep Siparişleştirme" işleminde kullanılmak üzere saklanır. |
| Yardım | Satınalma Talep Siparişleştirme hakkında standart yardım bilgisi için kullanılan butondur. |
| İptal | Sipariş kaydı oluşturulacak talep kayıtları için verilen kısıtların iptal edildiği butondur. |
...
Oluşacak Belge sekmesi bilgileri aşağıdaki şekildedir:

| Oluşacak Belge Ekranı |  |
| --- | --- |
...
| Sipariş Cari Kodu | "Satınalma Talep Siparişleştirme" işleminde bu alan kullanılmaz. Çünkü, oluşacak siparişin cari kodu, talepte girilen cari koddan farklı olamaz. |
...
| Proje Kırılımına Göre Sipariş Oluşturulsun | Satınalma talep siparişinin, proje kırılımına göre oluşturulması için kullanılan seçenektir. |
...
| Tamam | Satınalma Talep Siparişleştirme işleminin onaylanmasını sağlayan butondur. Butona basılması ile gelen ekran onaylanarak işlem gerçekleştirilir. Yeni oluşan sipariş kayıtları, program tarafından otomatik aktarılan Excel tablosunda listelenir.<br>Aynı talep kaydı için birden fazla sipariş kaydı oluşturulabilir. Oluşan siparişler, "Satınalma Talep" bölümünden izlenebilir, değişiklik yapılabilir veya iptal edilebilir. |
| Oku | Daha önceden saklanan kısıtların aynısının ekrana getirilmesini sağlayan butondur. **Oku** butonu ile sadece "en son saklanan kısıtlar" ekrana getirilir. |
| Sakla | Ön Sorgulama sekmesinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Satınalma talebini sipariş haline getirmek için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki "Satınalma Talep Siparişleştirme" işleminde kullanılmak üzere saklanır. |
| Yardım | Satınalma Talep Siparişleştirme hakkında standart yardım bilgisi için kullanılan butondur. |
| İptal | Sipariş kaydı oluşturulacak talep kayıtları için verilen kısıtların iptal edildiği butondur. |
