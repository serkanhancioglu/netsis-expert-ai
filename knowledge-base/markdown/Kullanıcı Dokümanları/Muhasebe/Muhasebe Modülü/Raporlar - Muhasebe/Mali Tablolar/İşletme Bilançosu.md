...
breadcrumb:
  ...
  - "Mali Tablolar"
  - "İşletme Bilançosu"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Muhasebe / Muhasebe Modülü / Raporlar / Muhasebe / Mali Tablolar / İşletme Bilançosu"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPTZmMjkwMzlkLWVhNzYtNDI1ZC1hN2RhLTc3MGY4OWMwMjAwOSZsaW5rPWZiMDBmNDVhLTIyZDQtNGE4NS04MTcwLWRlZjlmNzg0MzIxOCZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=6f29039d-ea76-425d-a7da-770f89c02009&link=fb00f45a-22d4-4a85-8170-def9f7843218&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "isletme-bilancosu_41161531_24740792.html"
source_version: "2022-10-17T10:30:27.793+03:00"
source_bytes: 185098
fetched_at: "2026-09-13T04:14:02+00:00"
generator: "netsis-scraper 1.0.0"
---
# İşletme Bilançosu

İşletme Bilançosu; Muhasebe Bölümünde, "Raporlar/Muhasebe Modülü" menüsünün altında yer alır. İşletmelerin sahip oldukları varlıklar ile bu varlıkların sağladığı kaynakların özet olarak gösterildiği mali tablodur.

Mali tablonun “Aktif” kısmında yer alacak "Varlıklar" hesap planındaki; Dönen Varlıklar, Duran Varlıklar grup kodlarına sahip hesap kodlarını, "Pasif" kısmında yer alacak olan "Kaynaklar" ise; Kısa Vadeli Yabancı Kaynaklar, Uzun Vadeli Yabancı Kaynaklar ve Öz Kaynaklar grup kodlarına sahip hesap kodlarını kapsar.

İşletme Bilançosu ekranı; Genel Kısıtlar, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Genel Kısıtlar**

İşletme Bilançosu ekranı Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| İşletme Bilançosu Ekranı |  |
| --- | --- |
| Ay Kodu | Bilançonun alınacağı ay kodunun girildiği alandır. |
| Şubeler Dahil | Bilançoya şubelerin dahil edilmesi için kullanılan seçenektir. |
| Önceki Dönem Şirketi | Önceki dönem şirketine ait kayıtların bilançoda listelenmesi için şirket kodunun girildiği alandır. |
...
| Dipnot Dosyası | Bilançoda dipnot bilgilerinin izlenmesi için dipnot dosyasının olduğu dizinin belirlendiği alandır. Bilanço dipnot dosyası TXT dosya olarak "BIL94.Txt" dosyasında tutulur ve kullanıcı bu dosyaya kendi şirketine ait bilgileri ekleyebilir. |
| Referans Kodu Aralığı | Referans kodu takibinin yapıldığı durumlarda, referans kodu kısıtı girilen alandır. Muhasebe → Kayıt → Muhasebe Parametreleri → "Fişlerde Referans Kodu Sorulsun" parametresinin işaretlenmesi ile aktif hale gelir. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg)ile, hesap kodları arasından seçim yapılarak kısıt verilir. |
| Referans Kodu Maskesi | Referans kodlarına filtre tanımlanarak liste alınmasını sağlayan alandır. **Örneğin;** Ana hesap kodu 1 rakamı ile başlayan hesapların listesi alınacaksa, bu alana %100 değerinin girilmesi gerekir. Maskeleme alanına “\_” tek bir karakter yerine “%” birden fazla bilinmeyen karakter girilebilir. |
| Proje Kırılımı Var | Yardımcı Programlar → Kayıt → [Şirket-Şube Parametreleri](<../../../../Genel/Yardımcı Programlar/Kayıt - Yardımcı Programlar/Şirket - Şube - Parametre Tanımları.md>) → “Proje Uygulaması Var” parametresinin işaretlendiği ve proje takibinin yapıldığı durumlarda, sadece belirlenen proje kodları için bilanço alınması ve proje kodları bazında raporlanması için işaretlenen seçenektir. |
...
| Hareket Görmemiş Hesaplar Basılsın | İşletme bilanço raporuna hareket görmeyen hesapların basılması için kullanılan seçenektir. |
...
| Pasif Hesapları Aktiflerden Sonra Yaz | Bilançoda önce “Aktif" hesaplar, daha sonra bu hesapların altında "Pasif" hesapların listelenmesi için kullanılan seçenektir. Bu seçenek işaretlenmediği zaman bilançodaki aktif ve pasif hesaplar yan yana listelenir. |
| Bilanço Şekli | Grup kodları bazında detaysız olarak bilanço alınması için **"Özet"**, özet bilanço tablosunda yer almayan, kebir bazında tüm hesap kodları dahil edilerek bilanço alınması için **“Ayrıntılı”** seçeneğinin işaretlenmesi gerekir. |
...
| \12. Ayda Kapanış Fişleri Dahil Edilmesin | \12. Ay için işletme bilançosu alınırken rapora kapanış yevmiye fişlerinin dahil edilmemesi için kullanılan seçenektir. |
...
| ![](../../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | "Genel Kısıtlar" sekmesinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Bilanço almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki bilanço alma işleminde kullanılmak üzere saklanır. |
| ![](../../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Bilanço ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../../_assets/973111d004995dca0113.jpg) İptal | Bilanço almak için verilen kısıtların iptal edildiği butondur. |
...
![](../../../../../_assets/27dfc7d0999d899ef96c.png)
...
**![](../../../../../_assets/cf38cdf83a4e059ec96a.png)**
...
| İşletme Bilançosu Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| İşletme Bilançosu Ekranı | Yazıcı Seçenekleri |
...
| ![](../../../../../_assets/4ad6cc61ca2c42a19c85.jpg) | Bilanço ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../../_assets/973111d004995dca0113.jpg) | Bilanço almak için verilen kısıtların iptal edildiği butondur. |
