...
breadcrumb:
  ...
  - "Proje Kümüle Rapor"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Muhasebe / Muhasebe Modülü / Raporlar / Muhasebe / Proje Takip Raporları / Proje Kümüle Rapor"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPWZhMzVjZDVlLWI4MTQtNGRmNi1hNTQwLTU2OTNlN2IxM2UxYSZsaW5rPTJhNGViYWQzLTczZmItNDg5OS1iMjZkLTNjOGRhZDU1NDU3YSZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=fa35cd5e-b814-4df6-a540-5693e7b13e1a&link=2a4ebad3-73fb-4899-b26d-3c8dad55457a&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "proje-kumule-rapor_41161357_24740766.html"
source_version: "2022-10-07T15:18:59.590+03:00"
source_bytes: 204718
fetched_at: "2026-09-13T04:13:57+00:00"
generator: "netsis-scraper 1.0.0"
---
# Proje Kümüle Rapor

Proje Kümüle Rapor, Muhasebe Bölümünde, "Raporlar/Muhasebe Modülü" menüsünün altında yer alır. Proje Kümüle Rapor; Muhasebe → Kayıt → Proje Kodu Girişi → "[Kümüle Rapor Şablon Tanımlama](<../../Kayıt - Muhasebe/Proje Kodu Girişi/Kümüle Rapor Şablon Tanımlama.md>)" bölümünden tanımlanan alanlara göre proje kümüle raporu alınmasını sağlayan bölümdür. Proje Kümüle Rapor; Ön Sorgulama, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Ön Sorgulama**

![](../../../../../_assets/2fea43f5303e5e1d2373.png)

Proje Kümüle Rapor ekranı Ön Sorgulama sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Proje Kümüle Rapor Ekranı |  |
| --- | --- |
| Kümüle Rapor Kodu | "Kümüle Rapor Şablon Tanımlama" bölümünden tanımlaması yapılan şablona ait rapor alınması için şablon kodu girilen alandır. Rehber butonu ![](../../../../../_assets/088477bb321d1b20c939.jpg) ile, kodlar arasından seçim yapılır. |
| Tip | Proje kümüle raporu için tip kısıtı verilen alandır. Giriş, Çıkış ve Hepsi seçeneklerinden oluşur. **Giriş** seçeneği işaretlendiğinde raporda sadece giriş hareketleri, **Çıkış** seçeneği işaretlendiğinde raporda sadece çıkış hareketleri, **Hepsi** seçeneği işaretlendiğinde ise raporda giriş ve çıkış hareketleri bir arada listelenir. |
...
| ![](../../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | "Proje Kümüle Rapor" ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
...
![](../../../../../_assets/b272ec98f836c4246dd2.png)
...
**![](../../../../../_assets/7fda24eaa7f032553cbc.png)**

| Proje Kümüle Raporu Ekranı |  |
| --- | --- |
...
| Proje Kümüle Raporu Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| Proje Kümüle Raporu Ekranı | Yazıcı Seçenekleri |
...
| ![](../../../../../_assets/4ad6cc61ca2c42a19c85.jpg) | "Proje Kümüle Rapor" ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
