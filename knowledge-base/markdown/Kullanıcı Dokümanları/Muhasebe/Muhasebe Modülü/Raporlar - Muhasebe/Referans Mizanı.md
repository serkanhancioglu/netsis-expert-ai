...
breadcrumb:
  ...
  - "Raporlar / Muhasebe"
  - "Referans Mizanı"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Muhasebe / Muhasebe Modülü / Raporlar / Muhasebe / Referans Mizanı"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPTljZDAwN2M5LWQ1NzEtNDc2My1iMDg0LTZmMWVjNTAxYTc5MiZsaW5rPWQxNzlmN2U2LWY0MjAtNGExYi1iZTE1LTA3NmZmMDYxNzljNiZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=9cd007c9-d571-4763-b084-6f1ec501a792&link=d179f7e6-f420-4a1b-be15-076ff06179c6&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "referans-mizani_41161479_24740787.html"
source_version: "2022-10-17T09:57:56.233+03:00"
source_bytes: 298142
...
Referans Mizanı, Muhasebe Bölümünde, "Raporlar/Muhasebe Modülü" menüsünün altında yer alır. Referans Mizanı, Muhasebe → Kayıt → [Muhasebe Parametreleri](<../Ekler - Muhasebe/Ek-1 Enflasyon Muhasebesi/Muhasebe Modülü Tanımlamaları/Muhasebe Parametreleri - Muhasebe.md>) → “Fişlerde Referans Kodu Sorulsun” parametresi işaretlendiğinde ve referans kodu takibinin yapıldığı durumlarda; yevmiye fişlerinde girilen ya da entegre işlemlerde kaydedilen “Referans Kodlarının” ve bu kodlarla ilgili yapılan kayıtların dökümünün alınmasını sağlayan rapordur. Referans Mizanı; Ön Sorgulama-1, Ön Sorgulama-2, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

**Ön Sorgulama-1**

![](../../../../_assets/bd2f17bfcf9ad4f544e6.png)

Referans Mizanı ekranı Ön Sorgulama-1 sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Referans Mizanı Ekranı |  |
| --- | --- |
...
| Miktar Yazılsın | Mizanda, fişlere ait miktar bilgilerinin listelenmesi için kullanılan seçenektir. |
| Şubeler Dahil | Mizan raporuna şubelerin dahil edilmesi için kullanılan seçenektir. |
| Muhasebe Kodları Dökülsün | Referans mizanında, referans kodlarının kullanıldığı muhasebe hesap kodlarının listelenmesi için işaretlenen seçenektir. |
| Referans Değişiminde Toplam Al | Her referans kodu değişiminde toplam alınması için işaretlenen seçenektir. |
...
![](../../../../_assets/680baef263b6c7696d12.png)
...
**![](../../../../_assets/9ce81a3875bf21659719.png)**
...
| Referans Mizanı Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| Referans Mizanı Ekranı | Yazıcı Seçenekleri |
