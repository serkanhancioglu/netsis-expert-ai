...
breadcrumb:
  ...
  - "İşlemler / Muhasebe"
  - "Toplu Fiş Basımı"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Muhasebe / Muhasebe Modülü / İşlemler / Muhasebe / Toplu Fiş Basımı"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPTZjY2U1NzA2LWViMTYtNDQ4Ni1hODUxLThjN2QwNDU2NWZjOCZsaW5rPTc2ODBmNmFhLTkyZTYtNDEzZC04MjY4LTY4NmQzYzJlNDhmMSZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=6cce5706-eb16-4486-a851-8c7d04565fc8&link=7680f6aa-92e6-413d-8268-686d3c2e48f1&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "toplu-fis-basimi_24740654_24740652.html"
source_version: "2022-10-06T13:01:45.177+03:00"
source_bytes: 189591
fetched_at: "2026-09-13T04:13:36+00:00"
generator: "netsis-scraper 1.0.0"
---
# Toplu Fiş Basımı

Toplu Fiş Basımı, Muhasebe Bölümünde, "İşlemler/Muhasebe Modülü" menüsünün altında yer alır. Toplu Fiş Basımı, girilen kısıtlara uygun şekilde yevmiye fişlerinin toplu basılması için kullanılan bölümdür. Toplu Fiş Basımı işleminin yapılması için, dizayn hazırlanması gerekir. Toplu Fiş Basımı ekranı; Ön Sorgulama, Ölçekleme ve Yazıcı Seçenekleri sekmelerinden oluşur.

Dizayn basımı ile ilgili detaylı bilgi için; Dizayn → Kayıt → [Dizayn](<../../../Genel/Dizayn Modülü/Kayıt - Dizayn/Dizayn.md>) dokümanına bakılabilir.

**Ön Sorgulama**

**![](../../../../_assets/4ddeb23e7113e1d3c943.png)**

Toplu Fiş Basımı ekranı Ön Sorgulama sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Toplu Fiş Basımı Ekranı |  |
| --- | --- |
| Ay Kodu | Toplu fiş basımının yapılacağı ay kodunun girildiği alandır. |
| Fiş No Aralığı | Basımı yapılacak yevmiye fişleri için başlangıç ve bitiş numara aralığı girilen alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, fiş numaraları arasından seçim yapılır. |
| Tarih Aralığı | Basımı yapılacak yevmiye fişleri için tarih aralığı girilen alandır. |
| Kullanıcı No | Basımı yapılacak yevmiye fişleri için kullanıcı kısıtı verilen alandır. Girilen kullanıcı numarasına ait kayıtların listelenmesini sağlar. |
| Her Fiş Basımında Dizayn Sorulsun | Fiş basımı yapılırken kullanıcıya dizayn adının sorulması için kullanılan seçenektir. Farklı fişler için farklı dizayna göre basım yapılmasını sağlar. |
| Şubeler Dahil Mi? | "Toplu Fiş Basımı" işleminin, şubelerde bulunan fişler için de yapılması istendiğinde kullanılan seçenektir. |
| ![](../../../../_assets/7ba39f9046a578093326.png) Rapor | Yukarıdaki alanlara girilen bilgiler doğrultusunda, toplu fiş basımı yapılması için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
...
| ![](../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Ön Sorgulama sayfasında verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Toplu fiş basımı için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki toplu fiş basımı işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Toplu fiş basımı ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../_assets/973111d004995dca0113.jpg) İptal | Toplu fiş basımı için verilen kısıtların iptal edildiği butondur. |
...
![](../../../../_assets/f91fa70cec861aa52776.png)
...
**![](../../../../_assets/cb3fe97e36e475a7bd78.png)**
...
| Toplu Fiş Basımı Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| Toplu Fiş Basımı Ekranı | Yazıcı Seçenekleri |
...
| ![](../../../../_assets/7ba39f9046a578093326.png) | Yukarıdaki alanlara girilen bilgiler doğrultusunda, toplu fiş basımı yapılması için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
...
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) | Toplu fiş basımı ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../_assets/973111d004995dca0113.jpg) | Toplu fiş basımı için verilen kısıtların iptal edildiği butondur. |
