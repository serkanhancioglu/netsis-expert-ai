---
title: "Sipariş Dengeleme Sonuç Raporu"
page_id: "50671015"
...
breadcrumb:
  ...
  - "MRP"
  - "Raporlar/MRP"
  - "Sipariş Dengeleme Sonuç Raporu"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Üretim / MRP / Raporlar/MRP / Sipariş Dengeleme Sonuç Raporu"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPWU0ZWYxMjVkLTcyMTEtNDUzMC05ODYwLTIyZDg5Y2VkMmNmOCZsaW5rPTA1NDE1ZDllLTc0ZmUtNGQwMi04YzA5LTllN2U0Yzc0MzIxZiZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=e4ef125d-7211-4530-9860-22d89ced2cf8&link=05415d9e-74fe-4d02-8c09-9e7e4c74321f&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "siparis-dengeleme-sonuc-raporu_50671016_50671015.html"
source_version: "2022-11-09T17:56:38.203+03:00"
source_bytes: 184177
fetched_at: "2026-09-13T04:20:11+00:00"
generator: "netsis-scraper 1.0.0"
---
# Sipariş Dengeleme Sonuç Raporu

Sipariş Dengeleme Sonuç Raporu, Üretim Bölümü'nde, "Raporlar/MRP" menüsünün altında yer alır. Sipariş Dengeleme Sonuç Raporu, Malzeme Gereksiniminden Sipariş Oluşturma ekranındaki Sipariş Dengeleme Sonuç sekmesinden girilen bilgiler doğrultusunda rapor alınmasını sağlayan bölümdür.

Sipariş Dengeleme Sonuç Raporu ekranı; Ön Sorgulama, Genel Kısıtlar, Kısıt, Ölçekleme ve Yazıcı Seçenekleri sekmesinden oluşur.

**Ön Sorgulama**

Sipariş Dengeleme Sonuç Raporu ekranı Ön Sorgulama sekmesinde yer alan alanlar ve içerdiği bilgiler aşağıdaki şekildedir:

| Sipariş Dengeleme Sonuç Raporu Ekranı |  |
| --- | --- |
| Cari Kodu Aralığı | Cariye ait başlangıç ve bitiş kodlarının ![](../../../../_assets/088477bb321d1b20c939.jpg) rehber butonu yardımı ile seçilerek, Sipariş Dengeleme Sonuç Raporu için kısıt verilmesini sağlayan alandır. |
| Tip | Sipariş Dengeleme Sonuç Raporu için tip kısıdının verildiği alandır. Hepsi, Alıcı, Satıcı, Kefil, Toptancı, Müstahsil ve Diğer olmak üzere yedi tip seçenek bulunur. |
| Grup Kodu | Sipariş Dengeleme Sonuç Raporu için grup kodu kısıdının verildiği alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile grup kodları arasından seçim yapılabilir. |
| Kod-1/2/3/4/5 | Sipariş Dengeleme Sonuç Raporu için daha önceden tanımlaması yapılan Kod-1/2/3/4/5 kısıdının verildiği alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile kodlar arasından seçim yapılabilir. |
| İl | Sipariş Dengeleme Sonuç Raporu için il kısıdının verildiği alandır. |
| İlçe | Sipariş Dengeleme Sonuç Raporu için ilçe kısıdının verildiği alandır. |
| ![](../../../../_assets/21c20c78203acae9cce6.jpg) Rapor | Dövizli borç/alacak dökümü için verilen kısıtlara göre Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
...
| ![](../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Genel Kısıtlar ve Kısıt sayfalarında verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Sipariş Dengeleme Sonuç Raporu için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki Sipariş Dengeleme Sonuç Raporu işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Sipariş Dengeleme Sonuç Raporu hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../_assets/973111d004995dca0113.jpg) İptal | Sipariş Dengeleme Sonuç Raporu için verilen kısıtların iptal edildiği butondur. |

**Genel Kısıtlar**

Sipariş Dengeleme Sonuç Raporu ekranı Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler aşağıdaki şekildedir:

| Sipariş Dengeleme Sonuç Raporu Ekranı |  |
| --- | --- |
| Sipariş No Aralığı | Sipariş Dengeleme Sonuç Raporu almak için sipariş numarası aralığı kısıdı verilen alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, sipariş numaraları arasından seçim yapılır. |
| Stok Kodu Aralığı | Sipariş Dengeleme Sonuç Raporu almak için stok kodu aralığı kısıdı verilen alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, stok kodları arasından seçim yapılır. |
| Satıcı Kodu Boş Olan Siparişler Getirilsin | Sipariş Dengeleme Sonuç Raporu ekranına satıcı kodu boş olan siparişlerin getirilmesi için kullanılan seçenektir. |
| İhtiyaç Çıkarılmayan Belgeler | Sipariş Dengeleme Sonuç Raporu ekranına ihtiyaç çıkarılmayan belgelerin getirilmesi için kullanılan seçenektir. |
| Miktar Kümülasyonu Yapılsın | Sipariş Dengeleme Sonuç Raporu alırken miktar kümülasyonunun yapılması için kullanılan seçenektir. |
| Belge Tipi | Sipariş Dengeleme Sonuç Raporu almak için belge tipi kısıdı verilen alandır. Yeni Eklenecek Belgeler, Silinecek Bilgiler, Güncellenecek Bilgiler, Değişiklik Yapılmayacak Belge, Hepsi seçenekleri arasından seçim yapılır. |
| ![](../../../../_assets/21c20c78203acae9cce6.jpg) Rapor | Dövizli borç/alacak dökümü için verilen kısıtlara göre Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
| ![](../../../../_assets/e3223333470668512f5f.jpg) Oku | Daha önceden saklanan kısıtların aynısının ekrana getirilmesini sağlayan butondur. **Oku** butonu ile sadece "en son saklanan kısıtlar" ekrana getirilir. |
| ![](../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Genel Kısıtlar ve Kısıt sayfalarında verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Sipariş Dengeleme Sonuç Raporu için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki Sipariş Dengeleme Sonuç Raporu işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Sipariş Dengeleme Sonuç Raporu hakkında standart yardım bilgisi için kullanılan butondur. |
...
| Sipariş Dengeleme Sonuç Raporu Ekranı |  |
| --- | --- |
| Sahalar | Sipariş Dengeleme Sonuç Raporu almak için kısıt verilmesi istenen alanlar yer alır. ![](../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "kısıt verilecek sahalar" kısmına eklenir. |
| Kısıt Verilecek Sahalar | Sipariş Dengeleme Sonuç Raporu almak için kısıt verilen sahaların yer aldığı alandır. ![](../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| ![](../../../../_assets/21c20c78203acae9cce6.jpg) | Dövizli borç/alacak dökümü için verilen kısıtlara göre Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
...
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) | Sipariş Dengeleme Sonuç Raporu hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../_assets/973111d004995dca0113.jpg) | Sipariş Dengeleme Sonuç Raporu için verilen kısıtların iptal edildiği butondur. |
...
| Sipariş Dengeleme Sonuç Raporu Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| Sipariş Dengeleme Sonuç Raporu Ekranı | Yazıcı Seçenekleri |
