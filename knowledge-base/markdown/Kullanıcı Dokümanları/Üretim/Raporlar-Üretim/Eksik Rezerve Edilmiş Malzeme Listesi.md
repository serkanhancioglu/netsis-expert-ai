---
title: "Eksik Rezerve Edilmiş Malzeme Listesi"
page_id: "50664529"
...
breadcrumb:
  ...
  - "Üretim"
  - "Raporlar/Üretim"
  - "Eksik Rezerve Edilmiş Malzeme Listesi"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Üretim / Raporlar/Üretim / Eksik Rezerve Edilmiş Malzeme Listesi"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPTdmNTRmNWZjLWZlMTEtNDRmMy1hYTY0LTQwM2I1NDcyNWNlOSZsaW5rPWQ3ZjFiNWUwLWQ0MDktNDM0MS05ZTE3LTM1ODU4NjdkYTEwOCZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=7f54f5fc-fe11-44f3-aa64-403b54725ce9&link=d7f1b5e0-d409-4341-9e17-3585867da108&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "eksik-rezerve-edilmis-malzeme-listesi_50664530_50664529.html"
source_version: "2022-10-07T16:01:01.413+03:00"
source_bytes: 101821
...
Eksik Rezerve Edilmiş Malzeme Listesi, Üretim Bölümü'nde, "Raporlar/Üretim" menüsünün altında yer alır. Eksik rezerve edilen malzeme listesinin alınmasını sağlayan rapordur.

Eksik Rezerve Edilmiş Malzeme Listesi ekranı; İş Emri Kısıtları, Ölçekleme ve Yazıcı Seçenekleri sekmesinden oluşur.

**İş Emri Kısıtları**

Eksik Rezerve Edilmiş Malzeme Listesi İş Emri Kısıtları sekmesinde yer alan alanlar ve içerdiği bilgiler aşağıdaki şekildedir:

| Eksik Rezerve Edilmiş Malzeme Listesi Ekranı |  |
| --- | --- |
| İş Emri No Maskesi | Eksik rezerve edilmiş malzeme listesi almak için iş emri numarası maske kısıdı verilen alandır. Rehber butonu ![](../../../_assets/088477bb321d1b20c939.jpg) ile iş emri numaraları arasından seçim yapılır. |
| Teslim Tarihi | Eksik rezerve edilmiş malzeme listesi almak için teslim tarihi kısıdı verilen alandır. |
| Mamul Kodu Maskesi | Eksik rezerve edilmiş malzeme listesi almak için mamul kodu maske kısıdı verilen alandır. Rehber butonu ![](../../../_assets/088477bb321d1b20c939.jpg) ile, mamul kodları arasından seçim yapılır. |
| Hammadde Kodu Maskesi | Eksik rezerve edilmiş malzeme listesi almak için hammadde kodu maske kısıdı verilen alandır. Rehber butonu ![](../../../_assets/088477bb321d1b20c939.jpg) ile, hammadde kodları arasından seçim yapılır. |
...
| ![](../../../_assets/53859e19eb2737b88a17.jpg) Sakla | İş Emri Kısıtları sekmesinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Eksik rezerve edilmiş malzeme listesi almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki eksik rezerve edilmiş malzeme listesi alma işleminde kullanılmak üzere saklanır. |
| ![](../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Eksik Rezerve Edilmiş Malzeme Listesi ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../_assets/973111d004995dca0113.jpg) İptal | Eksik rezerve edilmiş malzeme listesi almak için verilen kısıtların iptal edildiği butondur. |
...
| Eksik Rezerve Edilmiş Malzeme Listesi Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| Eksik Rezerve Edilmiş Malzeme Listesi Ekranı | Yazıcı Seçenekleri |
...
| ![](../../../_assets/53859e19eb2737b88a17.jpg) | İş Emri Kısıtları sekmesinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Eksik rezerve edilmiş malzeme listesi almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki eksik rezerve edilmiş malzeme listesi alma işleminde kullanılmak üzere saklanır. |
| ![](../../../_assets/4ad6cc61ca2c42a19c85.jpg) | Eksik Rezerve Edilmiş Malzeme Listesi ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../_assets/973111d004995dca0113.jpg) | Eksik rezerve edilmiş malzeme listesi almak için verilen kısıtların iptal edildiği butondur. |
