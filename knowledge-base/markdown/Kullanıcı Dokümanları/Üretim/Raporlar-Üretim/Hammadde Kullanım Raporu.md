---
title: "Hammadde Kullanım Raporu"
page_id: "50664290"
...
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Üretim / Raporlar/Üretim / Hammadde Kullanım Raporu"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPWNiMmI4NDkyLTUxZWUtNDY5Mi05MGY2LTMwZWFlYTg2MzZmMiZsaW5rPWFjZjAxZDlmLThmZjctNDRiOC1hMGViLTIyY2M1ZTNlNGNhNCZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=cb2b8492-51ee-4692-90f6-30eaea8636f2&link=acf01d9f-8ff7-44b8-a0eb-22cc5e3e4ca4&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "hammadde-kullanim-raporu_50664292_50664290.html"
source_version: "2022-10-07T15:42:24.117+03:00"
source_bytes: 279565
fetched_at: "2026-09-13T04:19:18+00:00"
generator: "netsis-scraper 1.0.0"
---
# Hammadde Kullanım Raporu

Hammadde Kullanım Raporu, Üretim Bölümü'nde Raporlar/Üretim menüsünün altında yer alır. Hammadde bazında, hangi hammaddenin hangi mamul veya mamullerde kullanıldığını listeleyen bölümdür. Bir bileşenin hangi mamul reçetelerinde yer aldığı ve diğer bilgilerin listelenmesini sağlar.

Hammadde Kullanım Raporu ekranı; Ön Sorgulama, Genel Kısıtlar, Kısıt, Sıralama, Ölçekleme ve Yazıcı Seçenekleri sekmesinden oluşur.

**Ön Sorgulama**

| Hammadde Kullanım Raporu Ekranı |  |
| --- | --- |
| Stok Kodu | Hammadde kullanım raporu almak için stok kodu kısıdı verilen alandır. Rehber butonu ![](../../../_assets/088477bb321d1b20c939.jpg) ile, stok kodları arasından seçim yapılır. |
| Grup Kodu | Hammadde kullanım raporu almak için grup kodu kısıdı verilen alandır. Rehber butonu ![](../../../_assets/088477bb321d1b20c939.jpg) ile, grup kodları arasından seçim yapılır. |
| Kod-1,2,3,4 ve Kod-5 | Hammadde kullanım raporu almak için kod-1,2,3,4 ve kod-5 kısıdının verildiği alandır. Rehber butonu ![](../../../_assets/088477bb321d1b20c939.jpg) ile, kodlar arasından seçim yapılır. |
| Sadece Esnek Yapılandırılabilir Stoklar Dökülsün | Hammadde kullanım raporu almak için verilen kısıtların haricinde sadece esnek yapılandırılabilir stokların listelenmesi için kullanılan seçenektir. |
...
| ![](../../../_assets/53859e19eb2737b88a17.jpg) | Ön Sorgulama, Genel Kısıtlar ve Kısıt sekmelerinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Hammadde kullanım raporu almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki hammadde kullanım raporu almak için alma işleminde kullanılmak üzere saklanır. |
| ![](../../../_assets/4ad6cc61ca2c42a19c85.jpg) | Hammadde Kullanım Raporu ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../_assets/973111d004995dca0113.jpg) | Hammadde kullanım raporu almak için verilen kısıtların iptal edildiği butondur. |

**Genel Kısıtlar**

Hammadde Kullanım Raporu Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler aşağıdaki şekildedir:

| Hammadde Kullanım Raporu Ekranı |  |
| --- | --- |
| En Üst Seviyeye Kadar Mamuller Gösterilsin mi? | Hammadde kullanım raporunda en üst seviyeye kadar mamullerin gösterilmesi için kullanılan seçenektir. |
| Reçetedeki Ölçü Birimine Göre Miktar Getirilsin | Hammadde kullanım raporunda reçetedeki ölçü birimine göre miktar getirilmesi için kullanılan seçenektir. |
| Ölçü Birimi | Hammadde kullanım raporu alırken kullanılacak ölçü biriminin seçildiği alandır. |
...
| ![](../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Ön Sorgulama, Genel Kısıtlar ve Kısıt sekmelerinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Hammadde kullanım raporu almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki hammadde kullanım raporu almak için alma işleminde kullanılmak üzere saklanır. |
| ![](../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Hammadde Kullanım Raporu ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../_assets/973111d004995dca0113.jpg) İptal | Hammadde kullanım raporu almak için verilen kısıtların iptal edildiği butondur. |

**Kısıt**

| Hammadde Kullanım Raporu Ekranı |  |
| --- | --- |
| Sahalar | Hammadde kullanım raporu almak için kısıt verilmesi istenen alanlar yer alır. ![](../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "kısıt verilecek sahalar" kısmına eklenir. |
| Kısıt Verilecek Sahalar | Hammadde kullanım raporu almak için kısıt verilen sahaların yer aldığı alandır. ![](../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| Hammadde Kullanım Raporu Ekranı |  |
| --- | --- |
| Sahalar | Hammadde kullanım raporu almak için kısıt verilirken sıralanması istenen alanlar yer alır. ![](../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "sıralama sahaları" kısmına eklenir. |
| Sıralama Sahaları | Hammadde kullanım raporu almak için kısıt verilirken sıralama yapılacak sahaların yer aldığı alandır. ![](../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| Hammadde Kullanım Raporu Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| Hammadde Kullanım Raporu Ekranı | Yazıcı Seçenekleri |
