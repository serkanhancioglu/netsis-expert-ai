...
breadcrumb:
  ...
  - "Raporlar/Üretim"
  - "Maliyet Listesi"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Üretim / Raporlar/Üretim / Maliyet Listesi"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPWQ0MjdlYmM0LWJkYmMtNDQyOC05MDVkLTRmZWUwYzQ2NjJiMSZsaW5rPWU5ZjFlZjc0LTBlZjYtNGE3ZC04MzdhLTI3M2FjYmRmMWIzNCZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=d427ebc4-bdbc-4428-905d-4fee0c4662b1&link=e9f1ef74-0ef6-4a7d-837a-273acbdf1b34&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "maliyet-listesi_50664428_50664422.html"
source_version: "2022-10-07T15:56:18.367+03:00"
source_bytes: 283973
fetched_at: "2026-09-13T04:19:22+00:00"
generator: "netsis-scraper 1.0.0"
---
# Maliyet Listesi

Maliyet Listesi, Üretim Bölümü'nde Raporlar/Üretim menüsünün altında yer alır. İstenen mamuller için Üretim modülünde hesaplanan maliyetin her bir mamul için tek satırda listelenmesi amacıyla kullanılan rapordur. Tüm mamuller için veya bir grup mamul için birim maliyetlerini, üretim parametrelerinde belirlenen maliyet yöntemine göre hesaplayarak listeler.

Maliyet Listesi ekranı; Ön Sorgulama, Seçenekler, Kısıt, Sıralama, Ölçekleme ve Yazıcı Seçenekleri sekmesinden oluşur.

**Ön Sorgulama**

Maliyet Listesi, Ön Sorgulama sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Maliyet Listesi Ekranı |  |
| --- | --- |
| Stok Kodu | Maliyet listesi almak için stok kodu kısıdı verilen alandır. Rehber butonu ![](../../../_assets/088477bb321d1b20c939.jpg) ile, stok kodları arasından seçim yapılır. |
| Grup Kodu | Maliyet listesi almak için grup kodu kısıdı verilen alandır. Rehber butonu ![](../../../_assets/088477bb321d1b20c939.jpg) ile, grup kodları arasından seçim yapılır. |
| Kod-1,2,3,4 ve Kod-5 | Maliyet listesi almak için kod-1,2,3,4 ve kod-5 kısıdının verildiği alandır. Rehber butonu ![](../../../_assets/088477bb321d1b20c939.jpg) ile, kodlar arasından seçim yapılır. |
| Sadece Esnek Yapılandırılabilir Stoklar Dökülsün | Maliyet listesi oluşturmak için verilen kısıtların haricinde sadece esnek yapılandırılabilir stokların listelenmesi için kullanılan seçenektir. |
...
| ![](../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Ön Sorgulama, Seçenekler ve Kısıt sekmelerinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Maliyet listesi almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki maliyet listesi alma işleminde kullanılmak üzere saklanır. |
| ![](../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Maliyet Listesi ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../_assets/973111d004995dca0113.jpg) İptal | Maliyet listesi almak için verilen kısıtların iptal edildiği butondur. |

**Seçenekler**

Maliyet Listesi Seçenekler sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Maliyet Listesi Ekranı |  |
| --- | --- |
| Stok Alış Fiyatları Oluşturulsun | Maliyet listesi alırken stok alış fiyatlarının oluşturulması için kullanılan seçenektir. Hesaplanan mamul maliyetleri, Stok Sabit Kayıtlarının "Alış Fiyatı-1" alanına aktarılır. |
| Standart Maliyet Yöntemi ile Üretim Maliyeti Hesaplanıp Stok Ek Sahalar Sayısal 4 Sahasına Yazılsın mı? | "Stok Alış Fiyatları Oluşturulsun" seçeneğinin seçilmesi ile aktif hale gelen seçenektir. Maliyet Muhasebesi çalıştırıldığında, bulunan mamul ana grubunun standart maliyetinin mamul grubunun işçilik katsayısına oranı, stok kartının "Sayısal Ek Saha-4" alanına aktarılmasını sağlar. |
| 1 Birim İçin Reçete Dökülsün | Maliyet listesi alırken 1 birim için reçete dökümünün sağlanması için kullanılan seçenektir. |
| Öncelik | Reçete Kaydı" ekranında tanımlanan öncelik sırasına göre kısıt verilerek maliyet listesi alınmasını sağlayan alandır. |
| Maliyet Tarihi | Maliyet listesi almak için maliyet tarihi kısıdının verildiği alandır. |
| ![](../../../_assets/7ba39f9046a578093326.png) Rapor | Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
| ![](../../../_assets/e3223333470668512f5f.jpg) Oku | Daha önceden saklanan kısıtların aynısının ekrana getirilmesini sağlayan butondur. **Oku** butonu ile sadece "en son saklanan kısıtlar" ekrana getirilir. |
| ![](../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Ön Sorgulama, Seçenekler ve Kısıt sekmelerinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Maliyet listesi almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki maliyet listesi alma işleminde kullanılmak üzere saklanır. |
| ![](../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Maliyet Listesi ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
...
| Maliyet Listesi Ekranı |  |
| --- | --- |
| Sahalar | Maliyet listesi almak için kısıt verilmesi istenen alanlar yer alır. ![](../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "kısıt verilecek sahalar" kısmına eklenir. |
| Kısıt Verilecek Sahalar | Maliyet listesi almak için kısıt verilen sahaların yer aldığı alandır. ![](../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| ![](../../../_assets/4ad6cc61ca2c42a19c85.jpg) | Maliyet Listesi ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../_assets/973111d004995dca0113.jpg) | Maliyet listesi almak için verilen kısıtların iptal edildiği butondur. |

**Sıralama**

| Maliyet Listesi Ekranı |  |
| --- | --- |
| Sahalar | Maliyet listesi almak için kısıt verilirken sıralanması istenen alanlar yer alır. ![](../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "sıralama sahaları" kısmına eklenir. |
| Sıralama Sahaları | Maliyet listesi almak için kısıt verilirken sıralama yapılacak sahaların yer aldığı alandır. ![](../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| Maliyet Listesi Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| Maliyet Listesi Ekranı | Yazıcı Seçenekleri |
