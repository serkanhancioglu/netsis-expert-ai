...
breadcrumb:
  ...
  - "Raporlar/Üretim"
  - "Rota Raporu"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Üretim / Raporlar/Üretim / Rota Raporu"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPWQwMGJjZDUyLWMwYjktNDZkZS04YTFlLTBjZjdjMThjYzc1MiZsaW5rPTQwOWIwZTRiLTYwZGItNDM5YS1hYjcxLTI5ZTk3YWEwNzk2NiZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=d00bcd52-c0b9-46de-8a1e-0cf7c18cc752&link=409b0e4b-60db-439a-ab71-29e97aa07966&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "rota-raporu_50664472_50664470.html"
source_version: "2022-10-07T15:58:51.727+03:00"
source_bytes: 245255
...
Rota Raporu, Üretim Bölümü'nde Raporlar/Üretim menüsünün altında yer alır. Rota raporu almak için kısıt verilmesini sağlayan bölümdür.

Rota Raporu ekranı; Ön Sorgulama, Genel Kısıtlar, Kısıt, Ölçekleme ve Yazıcı Seçenekleri sekmesinden oluşur.

**Ön Sorgulama**

Rota Raporu Ön Sorgulama sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Rota Raporu Ekranı |  |
| --- | --- |
| Stok Kodu | Rota raporu almak için stok kodu kısıdı verilen alandır. Rehber butonu ![](../../../_assets/088477bb321d1b20c939.jpg) ile, stok kodları arasından seçim yapılır. |
| Grup Kodu | Rota raporu almak için grup kodu kısıdı verilen alandır. Rehber butonu ![](../../../_assets/088477bb321d1b20c939.jpg) ile, grup kodları arasından seçim yapılır. |
| Kod-1,2,3,4 ve Kod-5 | Rota raporu almak için kod-1,2,3,4 ve kod-5 kısıdının verildiği alandır. Rehber butonu ![](../../../_assets/088477bb321d1b20c939.jpg) ile, kodlar arasından seçim yapılır. |
| Sadece Esnek Yapılandırılabilir Stoklar Dökülsün | Rota raporu oluşturmak için verilen kısıtların haricinde sadece esnek yapılandırılabilir stokların listelenmesi için kullanılan seçenektir. |
...
| ![](../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Ön Sorgulama, Genel Kısıtlar ve Kısıt sekmelerinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Rota raporu almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki rota listesi alma işleminde kullanılmak üzere saklanır. |
| ![](../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Rota Raporu ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../_assets/973111d004995dca0113.jpg) İptal | Rota raporu almak için verilen kısıtların iptal edildiği butondur. |

**Genel Kısıtlar**

Rota Raporu Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Rota Raporu Ekranı |  |
| --- | --- |
| Miktar | Rota raporu almak için miktar girilen alandır. |
| Reçete Seviyesi | Rota raporu almak için reçete seviyesi kısıdı girilen alandır. Tek Seviyeli veya Bütün Seviyeler seçilerek rapor oluşturulması sağlanır. |
| Reçete Rapora Eklensin | Reçetenin rota raporuna eklenmesi için kullanılan seçenektir. |
| Maliyet Bilgileri Basılsın | Rota raporuna maliyet bilgilerinin basılması için kullanılan seçenektir. |
| Raporda Kullanılacak Süre Tipi | Rota raporunda kullanılacak süre tipinin seçildiği alandır. Dakika veya Saat olarak seçim yapılabilir. |
...
| Rota Raporu Ekranı |  |
| --- | --- |
| Sahalar | Rota raporu almak için kısıt verilmesi istenen alanlar yer alır. ![](../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "kısıt verilecek sahalar" kısmına eklenir. |
| Kısıt Verilecek Sahalar | Rota raporu almak için kısıt verilen sahaların yer aldığı alandır. ![](../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| ![](../../../_assets/4ad6cc61ca2c42a19c85.jpg) | Rota Raporu ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../_assets/973111d004995dca0113.jpg) | Rota raporu almak için verilen kısıtların iptal edildiği butondur. |
...
| Rota Raporu Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| Rota Raporu Ekranı | Yazıcı Seçenekleri |
