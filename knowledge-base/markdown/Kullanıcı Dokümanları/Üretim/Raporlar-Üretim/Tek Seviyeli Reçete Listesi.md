---
title: "Tek Seviyeli Reçete Listesi"
page_id: "50664310"
...
breadcrumb:
  ...
  - "Üretim"
  - "Raporlar/Üretim"
  - "Tek Seviyeli Reçete Listesi"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Üretim / Raporlar/Üretim / Tek Seviyeli Reçete Listesi"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPWY3NzllYWIxLWIzZjAtNDM2Yi1iYzM2LThkYzBmMTZiNmNlOCZsaW5rPTBiMzFmMDkyLThjNTAtNDk3Ny05ZmI3LTc1YTc2YzYwYWNhMyZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=f779eab1-b3f0-436b-bc36-8dc0f16b6ce8&link=0b31f092-8c50-4977-9fb7-75a76c60aca3&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "tek-seviyeli-recete-listesi_50664320_50664310.html"
source_version: "2022-10-07T15:44:28.257+03:00"
source_bytes: 279128
fetched_at: "2026-09-13T04:19:19+00:00"
generator: "netsis-scraper 1.0.0"
---
# Tek Seviyeli Reçete Listesi

Tek Seviyeli Reçete Listesi, Üretim Bölümü'nde Raporlar/Üretim menüsünün altında yer alır. Mamuller bazında seviyelerine inmeden tek seviyeli olarak, bileşenlerin kullanım miktarlarını ve maliyetleri hesaplayıp listeleyen bölümdür. Tek seviyeli reçete listesi verir.

Tek Seviyeli Reçete Listesi ekranı; Ön Sorgulama, Seçenekler, Kısıt, Sıralama, Ölçekleme ve Yazıcı Seçenekleri sekmesinden oluşur.

**Ön Sorgulama**

| Tek Seviyeli Reçete Listesi Ekranı |  |
| --- | --- |
| Stok Kodu | Tek seviyeli reçete listesi almak için stok kodu kısıdı verilen alandır. Rehber butonu ![](../../../_assets/088477bb321d1b20c939.jpg) ile, stok kodları arasından seçim yapılır. |
| Grup Kodu | Tek seviyeli reçete listesi almak için grup kodu kısıdı verilen alandır. Rehber butonu ![](../../../_assets/088477bb321d1b20c939.jpg) ile, grup kodları arasından seçim yapılır. |
| Kod-1,2,3,4 ve Kod-5 | Tek seviyeli reçete listesi almak için kod-1,2,3,4 ve kod-5 kısıdının verildiği alandır. Rehber butonu ![](../../../_assets/088477bb321d1b20c939.jpg) ile, kodlar arasından seçim yapılır. |
| Sadece Esnek Yapılandırılabilir Stoklar Dökülsün | Tek seviyeli reçete listesi almak için verilen kısıtların haricinde sadece esnek yapılandırılabilir stokların listelenmesi için kullanılan seçenektir. |
...
| ![](../../../_assets/53859e19eb2737b88a17.jpg) | Ön Sorgulama, Seçenekler ve Kısıt sekmelerinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Tek seviyeli reçete listesi almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki tek seviyeli reçete listesi alma işleminde kullanılmak üzere saklanır. |
| ![](../../../_assets/4ad6cc61ca2c42a19c85.jpg) | Tek Seviyeli Reçete Listesi ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../_assets/973111d004995dca0113.jpg) | Tek seviyeli reçete listesi almak için verilen kısıtların iptal edildiği butondur. |

**Seçenekler**

Tek Seviyeli Reçete Listesi Seçenekler sekmesinde yer alan alanlar ve içerdiği bilgiler aşağıdaki şekildedir:

| Tek Seviyeli Reçete Listesi Ekranı |  |
| --- | --- |
| 1 Birim İçin Reçete Dökülsün | Tek seviyeli reçetenin 1 birim için listelenmesini sağlayan seçenektir. |
| Maliyet Bilgileri Dökülsün | Reçetedeki bileşenler için Birim Maliyet ve Toplam Maliyet değerlerinin, üretim parametrelerindeki maliyet tipine göre hesaplanarak getirilmesi için kullanılan seçenektir. |
| Maliyet Tarihi | Maliyet hesaplatma yönteminin hesaplanması ve raporlanması için tarih girilen alandır. |
| Maliyet Muhasebesi Bilgileri Dökülsün | "Maliyet Bilgileri Dökülsün" seçeneğinin işaretlenmesi ile aktif hale gelen seçenektir. Maliyet Muhasebesi modülünü kullanarak mamul ve yarı mamul maliyetlerini hesaplayan firmaların, mamul ve bileşenler için bağlı oldukları mali ana kod ve mali grup kodu bilgilerinin getirilmesini sağlar. |
...
| ![](../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Tek Seviyeli Reçete Listesi ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../_assets/973111d004995dca0113.jpg) İptal | Tek seviyeli reçete listesi almak için verilen kısıtların iptal edildiği butondur. |

**Kısıt**

| Tek Seviyeli Reçete Listesi Ekranı |  |
| --- | --- |
| Sahalar | Tek seviyeli reçete listesi almak için kısıt verilmesi istenen alanlar yer alır. ![](../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "kısıt verilecek sahalar" kısmına eklenir. |
| Kısıt Verilecek Sahalar | Tek seviyeli reçete listesi almak için kısıt verilen sahaların yer aldığı alandır. ![](../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| Tek Seviyeli Reçete Listesi Ekranı |  |
| --- | --- |
| Sahalar | Tek seviyeli reçete listesi almak için kısıt verilirken sıralanması istenen alanlar yer alır. ![](../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "sıralama sahaları" kısmına eklenir. |
| Sıralama Sahaları | Tek seviyeli reçete listesi almak için kısıt verilirken sıralama yapılacak sahaların yer aldığı alandır. ![](../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| Tek Seviyeli Reçete Listesi Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| Tek Seviyeli Reçete Listesi Ekranı | Yazıcı Seçenekleri |
