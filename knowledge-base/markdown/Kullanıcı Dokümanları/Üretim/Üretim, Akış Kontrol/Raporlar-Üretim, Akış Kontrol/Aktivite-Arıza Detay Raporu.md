---
title: "Aktivite/Arıza Detay Raporu"
page_id: "50665805"
...
breadcrumb:
  ...
  - "Aktivite/Arıza Detay Raporu"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Üretim / Üretim, Akış Kontrol / Raporlar/Üretim, Akış Kontrol / Aktivite/Arıza Detay Raporu"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPTZjOTBlY2JjLWFhZDItNDY0ZS1iM2Y2LTJiMDMyMGQzOGQ5OCZsaW5rPTM2ODEzMzZlLTYxNDUtNDNkZC04MzgwLTE5OWQ4YzA0ZjRlOSZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=6c90ecbc-aad2-464e-b3f6-2b0320d38d98&link=3681336e-6145-43dd-8380-199d8c04f4e9&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "aktivite-ariza-detay-raporu_50665806_50665805.html"
source_version: "2022-11-08T09:54:39.903+03:00"
source_bytes: 288035
fetched_at: "2026-09-13T04:20:43+00:00"
generator: "netsis-scraper 1.0.0"
---
# Aktivite/Arıza Detay Raporu

Aktivite Arıza Detay Raporu, Üretim Bölümü'nde, "Raporlar/Üretim-Akış Kontrol" menüsünün altında yer alır. Aktivite Arıza Detay Raporu, Üretim Akış Kontrol Kayıtları bölümünden girilen bilgilerin, stok koduna veya aktivite/arıza koduna kümüle olarak, aktivite veya arıza detaylı listesinin alınmasını sağlayan rapordur.

Aktivite/Arıza Detay Raporu ekranı; Genel Kısıtlar, Üretim Akış Kısıtları, Kısıt, Sıralama, Ölçekleme ve Yazıcı Seçenekleri sekmesinden oluşur.

**Genel Kısıtlar**

Aktivite Arıza Detay Raporu ekranı Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Aktivite/Arıza Detay Raporu Ekranı |  |
| --- | --- |
| Stok Kodu | Aktivite arıza detay raporu almak için stok kodu kısıdı verilen alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, stok kodları arasından seçim yapılır. |
| Grup Kodu | Aktivite arıza detay raporu almak için grup kodu kısıdı verilen alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, grup kodları arasından seçim yapılır. |
| Kod-1,2,3,4 ve Kod-5 | Aktivite arıza detay raporu almak için kod-1,2,3,4 ve kod-5 kısıdının verildiği alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, kodlar arasından seçim yapılır. |
| Sadece Esnek Yapılandırılabilir Stoklar Dökülsün | Aktivite arıza detay raporu almak için verilen kısıtların haricinde sadece esnek yapılandırılabilir stokların listelenmesi için kullanılan seçenektir. |
| Özellikler | Stoka ait özellikler, ![](../../../../_assets/5098b020c5e814c92501.png) üç nokta butonu ile esnek yapılandırma özellik rehberinden belirlenerek, toplu basım için kısıt verilmesini sağlar. "İleri seviyede kısıt vermek için burayı kullanabilirsiniz." yazısının üzerine tıklandığında, aşağıdaki ekranda belirtilen alanlar doldurularak detaylı kısıt verilmesi sağlanır. ![](../../../../_assets/4b8fefa342af3e1d859b.png) |
...
| ![](../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Ön Sorgulama, Seçenekler ve Kısıt sekmelerinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Aktivite arıza detay raporu almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki aktivite arıza detay raporu alma işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Aktivite Arıza Detay Raporu ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../_assets/973111d004995dca0113.jpg) İptal | Aktivite arıza detay raporu almak için verilen kısıtların iptal edildiği butondur. |

**Üretim Akış Kısıtları**

| Aktivite/Arıza Detay Raporu Ekranı |  |
| --- | --- |
| İş Emri No Aralığı | Rapora dahil edilmesi istenen iş emirleri için kısıt verilen alandır. Boş bırakılması durumunda bütün iş emirleri dikkate alınır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, iş emirleri arasından seçim yapılır. |
| Üretim Akış Tarih Aralığı | Rapora dahil edilmesi istenen üretim akış kayıtları için tarih kısıdı verilen alandır. Bir tarih aralığı verildiğinde, sadece bu tarih aralığındaki kayıtlar rapora dahil edilir. |
| Üretim Akış Kayıt Aralığı | Rapora dahil edilmesi istenen üretim akış kayıtları için kayıt kısıdı verilen alandır. Bir kayır aralığı verildiğinde, sadece bu kayıt aralığındaki işlemler rapora dahil edilir. |
| Kümüle Bilgisi | Raporun, stok kodu bazında veya aktivite/arıza koduna göre kümüle alınması için seçim yapılan alandır. Hangisi için kümüle rapor alınacak ise o seçeneğin seçilmesi gerekir. |
| Rapor Türü | Raporun aktivite/arıza bazında listelenmesi için seçim yapılan alandır. |
| Aktivite Sınırlaması | "Rapor Türü" sahasında, "Aktivite" seçeneğinin seçilmesi ile aktif hale gelen alandır. Listelenecek aktiviteler için aktivite aralığı verilip, sadece bu aktivitelerin raporlanması sağlanır. |
| Hariç Tip | Raporda listelenmesi istenmeyen aktiviteler için kullanılan alandır. |
| Arıza Sınırlaması | "Rapor Türü" alanında "Arıza" seçilmesi halinde aktif hale gelen alandır. Listelenecek arızalar için arıza aralığı verilip sadece bu arızaların raporlanması sağlanır. |
| Detay Gösterilsin | Seçilen rapor türü ve kümüle bilgisine detay bilginin eklenmesi için kullanılan seçenektir. |
...
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) | Aktivite Arıza Detay Raporu ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../_assets/973111d004995dca0113.jpg) | Aktivite arıza detay raporu almak için verilen kısıtların iptal edildiği butondur. |

**Kısıt**

| Aktivite/Arıza Detay Raporu Ekranı |  |
| --- | --- |
| Sahalar | Reçete listesi almak için kısıt verilmesi istenen alanlar yer alır. ![](../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "kısıt verilecek sahalar" kısmına eklenir. |
| Kısıt Verilecek Sahalar | Reçete listesi almak için kısıt verilen sahaların yer aldığı alandır. ![](../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| Aktivite/Arıza Detay Raporu Ekranı |  |
| --- | --- |
| Sahalar | Aktivite arıza detay raporu almak için kısıt verilirken sıralanması istenen alanlar yer alır. ![](../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "sıralama sahaları" kısmına eklenir. |
| Sıralama Sahaları | Aktivite arıza detay raporu almak için kısıt verilirken sıralama yapılacak sahaların yer aldığı alandır. ![](../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| Aktivite/Arıza Detay Raporu Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| Aktivite/Arıza Detay Raporu Ekranı | Yazıcı Seçenekleri |
