---
title: "Genel Üretim Akış Raporu"
page_id: "50665620"
...
breadcrumb:
  ...
  - "Genel Üretim Akış Raporu"
breadcrumb_path: "Logo Netsis 3 Enterprise Bilgi Deposu / Kullanıcı Dokümanları / Üretim / Üretim, Akış Kontrol / Raporlar/Üretim, Akış Kontrol / Genel Üretim Akış Raporu"
source_url: "https://polaris.logo.cloud/docs/netsis-3-enterprise/detail/ZXh0ZXJuYWw_Y2lkPTE4MTVlNjMzLTgzMWMtNGU5Zi05MjJhLTcyZGFiYzY3YzVkMCZsaW5rPWUxYTE1NmY0LTA2YWMtNGE0ZC04Y2RmLTkxZmRiZTUxMzIxNyZ0ZW5hbnRJZD1jZGQ4N2UxMy0zMDA5LTRkZDEtYTViOC0yYTAwNWMwZTU4ZGEmaGlkZU5hbWU9VHJ1ZQ"
doc_url: "external?cid=1815e633-831c-4e9f-922a-72dabc67c5d0&link=e1a156f4-06ac-4a4d-8cdf-91fdbe513217&tenantId=cdd87e13-3009-4dd1-a5b8-2a005c0e58da&hideName=True"
slug: "genel-uretim-akis-raporu_50665719_50665620.html"
source_version: "2022-11-08T09:58:44.697+03:00"
source_bytes: 283176
...
Genel Üretim Akış Raporu, Üretim Bölümü'nde Raporlar/Üretim-Akış Kontrol menüsünün altında yer alır. Üretim Akış Kaydı bölümü kullanılarak kaydedilen bilgilerin detaylı raporlarının alınmasını sağlayan bölümdür.

Genel Üretim Akış Raporu ekranı; Genel Kısıtlar, UAK Kısıt, Kısıt, Sıralama, Ölçekleme ve Yazıcı Seçenekleri sekmesinden oluşur.

**Genel Kısıtlar**

Genel Üretim Akış Raporu Genel Kısıtlar sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Genel Üretim Akış Raporu Ekranı |  |
| --- | --- |
| Stok Kodu | Genel üretim akış raporu almak için stok kodu kısıdı verilen alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, stok kodları arasından seçim yapılır. |
| Grup Kodu | Genel üretim akış raporu almak için grup kodu kısıdı verilen alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, grup kodları arasından seçim yapılır. |
| Kod-1,2,3,4 ve Kod-5 | Genel üretim akış raporu almak için kod-1,2,3,4 ve kod-5 kısıdının verildiği alandır. Rehber butonu ![](../../../../_assets/088477bb321d1b20c939.jpg) ile, kodlar arasından seçim yapılır. |
| Sadece Esnek Yapılandırılabilir Stoklar Dökülsün | Genel üretim akış raporu almak için verilen kısıtların haricinde sadece esnek yapılandırılabilir stokların listelenmesi için kullanılan seçenektir. |
...
| ![](../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Ön Sorgulama, Seçenekler ve Kısıt sekmelerinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Genel üretim akış raporu almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki genel üretim akış raporu alma işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Genel Üretim Akış Raporu ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../_assets/973111d004995dca0113.jpg) İptal | Genel üretim akış raporu almak için verilen kısıtların iptal edildiği butondur. |

**UAK Kısıt**

Genel Üretim Akış Raporu UAK Kısıt sekmesinde yer alan alanlar ve içerdiği bilgiler şunlardır:

| Genel Üretim Akış Raporu Ekranı |  |
| --- | --- |
| Başlangıç/Bitiş Tarih/Saat Basılsın | Genel üretim akış raporuna başlangıç/bitiş tarih/saat bilgilerinin gelmesi için kullanılan seçenektir. |
| Aktivite Bilgileri Basılsın | Genel üretim akış raporuna aktivite bilgilerinin gelmesi için kullanılan seçenektir. |
| Miktar Bilgileri Basılsın | Genel üretim akış raporuna miktar bilgilerinin gelmesi için kullanılan seçenektir. |
| Arıza Bilgileri Basılsın | Genel üretim akış raporuna arıza bilgilerinin gelmesi için kullanılan seçenektir. |
| Süre Bilgileri Basılsın | Genel üretim akış raporuna süre bilgilerinin gelmesi için kullanılan seçenektir. |
| İstasyon Bilgileri Basılsın | Genel üretim akış raporuna istasyon bilgilerinin gelmesi için kullanılan seçenektir. |
| Makine Bilgileri Basılsın | Genel üretim akış raporuna makine bilgilerinin gelmesi için kullanılan seçenektir. |
| İşçi Bilgileri Basılsın | Genel üretim akış raporuna işçi bilgilerinin gelmesi için kullanılan seçenektir. |
| Açıklamalar Basılsın | Genel üretim akış raporuna açıklama bilgilerinin gelmesi için kullanılan seçenektir. |
| Kullanılan Kaynaklar Gösterilsin | Genel üretim akış raporunda kullanılan kaynakların gösterilmesi için kullanılan seçenektir. |
| ![](../../../../_assets/7ba39f9046a578093326.png) Rapor | Yukarıdaki alanlara girilen bilgiler doğrultusunda, rapor almak için kullanılan butondur. Butonun sağ tarafında yer alan aşağı ok tuşu, "Gelişmiş Rapor" seçeneğinin kullanılmasını sağlar. Kullanıcı, "Gelişmiş Rapor" seçeneği ile ekrana gelen tablo üzerinde hesaplama yapabilir. Bu seçenek sayesinde, 13684 satırın üstündeki raporlamaların da tek sayfa üzerinden raporlanması sağlanır. "Rapor" seçeneği Text Dosya, Excel Dosya, VTS Format, HTML kayıt türlerini desteklerken, "Gelişmiş Rapor" seçeneği Excel Workbook, Excel Template, Excel 97-2003 Workbook, Excel 97-2003 Template, Comma Delimited, Text Document, Web Page, XML Document, PDF Document kayıt türlerini destekler. |
| ![](../../../../_assets/e3223333470668512f5f.jpg) Oku | Daha önceden saklanan kısıtların aynısının ekrana getirilmesini sağlayan butondur. > [!NOTE]<br>> **Oku** butonu ile sadece "en son saklanan kısıtlar" ekrana getirilir. |
| ![](../../../../_assets/53859e19eb2737b88a17.jpg) Sakla | Ön Sorgulama, Seçenekler ve Kısıt sekmelerinde verilen kısıtlar ve işaretlenen tüm seçeneklerin saklanması için kullanılan butondur. Genel üretim akış raporu almak için kısıt verildikten sonra bu butona basıldığında, onaylama ekranı görüntülenir. Onaylama ekranında "Evet" butonuna basılması ile belirlenen kısıtlar bir sonraki genel üretim akış raporu alma işleminde kullanılmak üzere saklanır. |
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) Yardım | Genel Üretim Akış Raporu ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
...
| ![](../../../../_assets/4ad6cc61ca2c42a19c85.jpg) | Genel Üretim Akış Raporu ekranı hakkında standart yardım bilgisi için kullanılan butondur. |
| ![](../../../../_assets/973111d004995dca0113.jpg) | Genel üretim akış raporu almak için verilen kısıtların iptal edildiği butondur. |

**Sıralama**

| Genel Üretim Akış Raporu Ekranı |  |
| --- | --- |
| Sahalar | Genel üretim akış raporu almak için kısıt verilirken sıralanması istenen alanlar yer alır. ![](../../../../_assets/b050fee00ab65632b16d.jpg) butonu ile istenen alanlar "sıralama sahaları" kısmına eklenir. |
| Sıralama Sahaları | Genel üretim akış raporu almak için kısıt verilirken sıralama yapılacak sahaların yer aldığı alandır. ![](../../../../_assets/a19640feaa753a52d048.jpg) butonu ile istenmeyen alanlar çıkarılır. |
...
| Genel Üretim Akış Raporu Ekranı | Yazıcı Seçenekleri - Yönlendirme |
...
| Genel Üretim Akış Raporu Ekranı | Yazıcı Seçenekleri |
