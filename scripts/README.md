...
Aylık güncelleme için `--refresh`: her şeyi yeniden indirir ama diskte yalnızca
gerçekten değişmiş dosyaları yeniler, böylece `git diff` size tam olarak Logo'nun
neyi değiştirdiğini gösterir.
